package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         ...
         var_199 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_53,HabboWindowStyle.const_861,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         var_966 = String(_loc7_.relocate_by_drag.@state) == "true";
         if(var_966)
         {
            _window.addEventListener(WindowMouseEvent.const_54,onToolbarMouseDown);
         ...
         var_1178 = _loc7_.toolbar.@margin_bottom;
         var_1420 = _loc7_.toolbar.@min_group_margin;
         var_1419 = _loc7_.toolbar.@margin_to_extrabar;
         var_266 = new ToolbarBarMenuAnimator(param1,this);
         var _loc8_:XMLList = XMLList(_loc7_.toolbar).children();
         var _loc9_:XMLList = XMLList(_loc7_.extras).children();
         createGroupsFromXmlList(_loc8_,var_259,param1,param2,_window,var_266);
         createGroupsFromXmlList(_loc9_,var_546,param1,param2,var_199,var_266);
         alignWindows();
      }
      ...
      public function dispose() : void
      {
         ...
         while(false)
         {
            _loc1_ = var_259.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         while(false)
         {
            _loc1_ = var_546.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         if(_window != null)
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,var_138,var_464,param3);
         }
      }
      ...
      private function alignWindows() : void
      {
         ...
         else
         {
            ...
            if(false)
            {
               ...
               {
                  _loc7_ = Number(Math.max(var_1420,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1178) / -1));
               }
               else
               {
                  _loc7_ = Number(Math.max(var_1420,(0 - _loc6_ * _loc9_ - _toolbarMarginTop - var_1178) / -1));
         ...
         _loc2_ = 0;
         while(_loc2_ < var_546.length)
         {
            _loc3_ = var_546[_loc2_];
            if(_loc3_ != null)
            {
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,var_138,var_464);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         var _loc3_:int = 0;
         _loc3_ = 0;
         while(_loc3_ < var_259.length)
         {
            _loc2_ = var_259[_loc3_];
         ...
         _loc3_ = 0;
         while(_loc3_ < var_546.length)
         {
            _loc2_ = var_546[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,var_464);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,var_138,var_464);
         }
      }
