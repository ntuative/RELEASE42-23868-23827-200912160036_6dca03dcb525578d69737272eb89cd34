package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      private static const const_1076:int = 100;
      
      public static const const_324:String = "pets";
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboLocalizationManager, param8:IHabboConfigurationManager)
      {
         ...
         var_475 = new Timer(const_1076,1);
         var_475.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
      ...
      {
         return _controller.getSubCategoryViewId() == InventorySubCategory.const_234;
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_390.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_390.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_707)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_475 != null)
            {
               var_475.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_475.stop();
               var_475 = null;
            }
            if(var_142 != null)
            {
               var_142.removeEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
               var_142.stop();
               var_142 = null;
            }
            if(var_663 != null)
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Boolean = false) : GroupItem
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         if(param3 == FurniCategory.const_275)
         {
         ...
         if(var_663 == null)
         {
            var_663 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc10_:IWindowContainer = var_663.clone() as IWindowContainer;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_234:
               ...
               break;
            case InventorySubCategory.const_965:
               method_4();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            var_142 = new Timer(param1,1);
            var_142.addEventListener(TimerEvent.TIMER_COMPLETE,initTimeout);
            var_142.start();
         }
         else
         {
      ...
      {
         _controller.checkCategoryInitilization(InventoryCategory.const_444);
         ...
         if(param1 == InventoryCategory.const_68 && false)
         {
            switch(_view.visibleCategoryId)
            {
               ...
               case const_42:
                  ...
                  break;
               case const_324:
                  _controller.toggleInventoryPage(InventoryCategory.const_166);
            }
         }
      }
      ...
      {
         if(var_816 && param1.type == RoomEngineObjectEvent.const_196)
         {
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_314 || _loc3_.category == FurniCategory.const_275 || _loc3_.category == FurniCategory.const_309)
         {
            if(param1)
            {
               return false;
      ...
      {
         return var_390.getValue(param1);
      }
      
      public function clearFurniList() : void
      {
         var_390 = new Map();
         var_390.add(const_41,new Array());
         var_390.add(const_42,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
