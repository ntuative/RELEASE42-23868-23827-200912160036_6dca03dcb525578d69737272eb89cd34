package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView
   {
      ...
      private var var_283:PetsGridItem;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         var_442 = _view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         if(var_516 == null || false)
         {
            updatePreview();
            return;
         }
         setSelectedGridItem(var_516.getWithIndex(0));
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(var_283 != null)
         {
            var_283.setSelected(false);
         }
         var_283 = param1;
         if(var_283 != null)
         {
            var_283.setSelected(true);
         }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = var_283.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         var _loc2_:PetsGridItem = var_516.remove(param1) as PetsGridItem;
         if(_loc2_ == null)
         {
            return;
         }
         var_442.removeGridItem(_loc2_.window);
         if(var_283 == _loc2_)
         {
            var_283 = null;
            selectFirst();
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(var_516.getValue(param1.id) != null)
         {
            return;
         }
         ...
         if(_loc2_ != null)
         {
            var_442.addGridItem(_loc2_.window);
            var_516.add(param1.id,_loc2_);
            if(var_283 == null)
            {
               selectFirst();
            }
