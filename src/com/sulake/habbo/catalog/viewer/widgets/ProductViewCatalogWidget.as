package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1113:IScrollbarWindow;
      
      protected var var_1297:XML;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_1280.text = "${" + _loc3_.name + "}";
            var_1279.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1280.text = "${" + _loc2_.localizationId + "}";
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_436:
                  _loc4_ = var_1112.clone();
                  if(var_517 != null)
                  {
                     var_517.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_517,var_1113,var_1297);
                  }
                  break;
                     ...
                     case ProductTypeEnum.const_237:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_318,AvatarAction.const_585);
                              _loc13_.appendAction(AvatarAction.const_610,_loc6_.productClassId);
      ...
      {
         var_1280 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1279 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_87 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1364 = new Point(var_87.x,var_87.y);
         var_517 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         var_1113 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         if(var_517 == null)
         {
            Logger.log("[ProductViewCatalogWidget] Bundle Grid not initialized!");
         }
         var _loc1_:XmlAsset = page.viewer.catalog.assets.getAssetByName("gridItem") as XmlAsset;
         var_1297 = _loc1_.content as XML;
         var _loc2_:BitmapDataAsset = page.viewer.catalog.assets.getAssetByName("ctlg_dyndeal_background") as BitmapDataAsset;
         var_1112 = _loc2_.content as BitmapData;
