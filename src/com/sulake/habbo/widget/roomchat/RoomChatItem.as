package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_482:int = 6;
      
      private static const const_333:int = 10;
      
      private static const const_1061:Number = 18;
      
      private static const const_1370:Number = 10;
      
      private static const const_1371:Number = 8;
      ...
      {
         _widget.onItemMouseOut(var_956,var_955,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_956,var_955,_roomId,_roomCategory,param1);
      }
      ...
      {
         var_1173 = param1.chatType;
         var_956 = param1.userId;
         var_790 = param1.userName;
         var_955 = param1.userCategory;
         _message = param1.text;
         var_1175 = param1.userX;
         var_198 = param1.userImage;
         var_957 = param1.userColor;
      ...
      {
         var _loc5_:Rectangle = new Rectangle(var_89,_y,width,_height);
      ...
      public function renderView() : void
      {
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_957 != 0)
            {
               _loc31_ = uint(var_957 >> 16 & 255);
               _loc32_ = uint(var_957 >> 8 & 255);
               _loc33_ = uint(var_957 >> 0 & 255);
            }
         ...
         if(_loc19_ != null)
         {
            if(_loc2_)
            {
               _width += _loc19_.textWidth + const_333;
            }
            else
            {
               _loc19_.text = var_790 + ":";
               _loc19_.y += var_379;
               _loc19_.width = _loc19_.textWidth + const_333;
               _width += _loc19_.textWidth + const_333;
            }
         }
         if(_loc20_ != null)
         {
            if(var_1173 == RoomWidgetChatUpdateEvent.const_231)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_790);
            }
            else if(var_1173 == RoomWidgetChatUpdateEvent.const_268)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_790);
            }
            else
            {
            ...
            _loc20_.x = _width;
            _loc20_.y += var_379;
            _loc20_.width = _loc20_.textWidth + const_482;
            _width += _loc20_.textWidth + const_482;
         }
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_333 + _loc20_.textWidth + const_482;
            _loc38_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_956,var_955,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_956,var_955,_roomId,_roomCategory,param1);
      }
