package com.sulake.habbo.moderation
{
   ...
   public class StartPanelCtrl
   {
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_56.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(!!var_1051 ? 0 : 1,_roomId),var_56,WindowTracker.const_681,_roomId),var_58,false,false,true);
      }
