package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_754:Number = 0;
      
      private var var_443:Point = null;
      
      private var var_624:Map = null;
      
      private var var_444:Vector3d;
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = 0;
            while(_loc1_ < var_445.length)
            {
               _loc2_ = var_445.getWithIndex(_loc1_) as BitmapData;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
                  ...
                  if(_loc4_ != null)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           _loc13_ = var_445.getValue(_loc15_) as BitmapData;
                           _loc12_ = uint(var_624.getValue(_loc15_));
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_329:
                                 ...
                                 if(_loc13_ != null)
                                 {
                                    var_445.add(_loc15_,_loc13_);
                                 }
                                 if(_loc12_ != 0)
                                 {
                                    var_624.add(_loc15_,_loc12_);
                                 }
                                 if(_loc16_ != null)
                                 {
                                    _loc16_.dispose();
      ...
      {
         return [RoomWidgetChatMessage.const_694,RoomWidgetChatSelectAvatarMessage.const_574];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_694:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_149,_container.roomSession,0,"Version 23868-23827-200912160011");
                           ...
                           case ":chooser":
                              ...
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_304);
                           ...
                           case ":furni":
                              ...
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_387);
                                 _container.processWidgetMessage(_loc4_);
                              }
                              return null;
                           case ":pickall":
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_574:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_754 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_754);
            }
            if(var_443 == null)
            {
               var_444.x = 0;
               var_444.y = 0;
               var_444.z = 0;
               var_443 = _loc4_.getScreenPoint(var_444);
               var_754 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_444.x = 0;
            var_444.y = 0;
            var_444.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_444);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_443.x || _loc8_.y != var_443.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_443,_loc5_));
