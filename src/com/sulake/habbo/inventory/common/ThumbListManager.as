package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_950:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         var_97 = var_541.height;
         var_949 = param5;
         var_780 = param6;
         var_218 = Math.floor(var_949 / _thumbWidth);
         var_31 = new BitmapData(var_949,var_780);
      }
      
      public function resolveIndexFromImageLocation(param1:Point) : int
      {
         var _loc2_:Point = resolveGridLocationFromImage(param1);
         return int(_loc2_.y * var_218 + _loc2_.x);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         var _loc4_:int = var_218 - param1.x - 1;
         ...
         if(var_31.height < var_780)
         {
            _loc12_ = new BitmapData(var_31.width,var_780);
      ...
      private function getList() : Array
      {
         ...
         if(var_950 != null)
         {
            _loc1_ = var_950.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var_31 = new BitmapData(Math.max(var_218 * _thumbWidth,var_949),Math.max(var_457 * var_97,var_780),true,16777215);
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_218 && var_31.height < _loc3_.y * var_97)
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_218 - 1),var_97);
         _loc2_.copyPixels(var_31,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_218 - 1),0,_thumbWidth,var_31.height);
         _loc2_.copyPixels(var_31,_loc4_,new Point(0,var_97),null,null,true);
         _loc4_ = new Rectangle(0,var_97,_thumbWidth * (var_218 - 1),0 - var_97);
      ...
      {
         var _loc1_:Array = getList();
         return int(Math.ceil(_loc1_.length / var_218));
      }
      ...
      {
         var _loc2_:int = Math.floor(param1 / var_218);
         var _loc3_:int = param1 % var_218;
         return new Point(_loc3_,_loc2_);
      }
