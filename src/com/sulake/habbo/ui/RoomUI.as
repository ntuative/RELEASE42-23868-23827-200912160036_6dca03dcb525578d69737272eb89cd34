package com.sulake.habbo.ui
{
   ...
   public class RoomUI extends Component implements IRoomUI, ICoreUpdateReceiver
   {
      ...
      private var var_764:IRoomWidgetFactory;
      ...
      private var var_560:ISessionDataManager;
      ...
      private var var_1762:IHabboHelp;
      ...
      public function createDesktop(param1:IRoomSession) : IRoomDesktop
      {
         ...
         _loc3_.roomWidgetFactory = var_764;
         _loc3_.sessionDataManager = var_560;
         ...
         _loc3_.avatarEditor = var_1763;
         _loc3_.catalog = var_70;
         _loc3_.adManager = var_454;
         _loc3_.localization = _localization;
         _loc3_.habboHelp = var_1762;
         _loc3_.moderation = var_1390;
         _loc3_.config = _config;
         _loc3_.soundManager = var_763;
      ...
      private function onSoundManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_763 = param2 as IHabboSoundManager;
      }
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_91:
               if(param1.session != null)
               {
                  ...
                  var_205.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_172,HabboToolbarIconEnum.ZOOM));
                  var_205.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_172,HabboToolbarIconEnum.MEMENU));
                  var_205.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_172,HabboToolbarIconEnum.INVENTORY));
               }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_454 != null && false)
         {
            ...
            var_454.events.addEventListener(AdEvent.const_428,adEventHandler);
            var_454.events.addEventListener(AdEvent.const_381,adEventHandler);
         }
      }
      ...
      private function onRoomWidgetFactoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_764 = param2 as IRoomWidgetFactory;
      }
      ...
      override public function dispose() : void
      {
         ...
         if(var_764 != null)
         {
            var_764.release(new IIDHabboRoomWidget());
            var_764 = null;
         }
         if(var_25 != null)
         {
         ...
         if(var_763 != null)
         {
            var_763.release(new IIDHabboSoundManager());
            var_763 = null;
         }
         if(var_253)
         {
      ...
      public function disposeDesktop(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != RoomDesktop.const_622)
            {
               var_1391 = _loc3_;
            }
            _loc2_.dispose();
      ...
      private function onHabboModerationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1390 = param2 as IHabboModeration;
         Logger.log("XXXX GOT HABBO MODERATION: " + var_1390);
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_560 = param2 as ISessionDataManager;
      }
      ...
      private function roomEventHandler(param1:RoomEngineEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineEvent.const_683:
               ...
               if(var_1391 != RoomDesktop.const_622)
               {
                  _loc3_.initializeWidget(RoomWidgetEnum.const_267,var_1391);
               }
               if(var_454 != null)
               {
                  var_454.showRoomAd();
               ...
               break;
            case RoomEngineEvent.const_717:
               disposeDesktop(_loc2_);
               break;
            case RoomEngineRoomColorEvent.const_604:
      ...
      private function roomSessionDialogEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(event.type)
         {
            ...
            case RoomSessionErrorMessageEvent.const_687:
               ...
               break;
            case RoomSessionErrorMessageEvent.const_496:
      ...
      private function initializeRoomEngineEvents() : void
      {
         if(_roomEngine != null && false)
         {
            ...
            _roomEngine.events.addEventListener(RoomEngineEvent.const_683,roomEventHandler);
            _roomEngine.events.addEventListener(RoomEngineEvent.const_717,roomEventHandler);
            _roomEngine.events.addEventListener(RoomEngineDimmerStateEvent.DIMMER_STATE,roomEventHandler);
            _roomEngine.events.addEventListener(RoomEngineRoomColorEvent.const_604,roomEventHandler);
            _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_621,roomObjectEventHandler);
            ...
            _roomEngine.events.addEventListener(RoomEngineObjectEvent.const_495,roomObjectEventHandler);
      ...
      private function method_7() : void
      {
         if(var_33)
         {
            var_33.events.addEventListener(RoomSessionEvent.const_274,roomSessionStateEventHandler);
            var_33.events.addEventListener(RoomSessionEvent.const_83,roomSessionStateEventHandler);
            var_33.events.addEventListener(RoomSessionEvent.const_91,roomSessionStateEventHandler);
            var_33.events.addEventListener(RoomSessionChatEvent.const_149,roomSessionEventHandler);
            ...
            var_33.events.addEventListener(RoomSessionDoorbellEvent.const_105,roomSessionEventHandler);
            var_33.events.addEventListener(RoomSessionDoorbellEvent.const_127,roomSessionEventHandler);
            var_33.events.addEventListener(RoomSessionPresentEvent.const_251,roomSessionEventHandler);
            var_33.events.addEventListener(RoomSessionErrorMessageEvent.const_202,roomSessionDialogEventHandler);
            var_33.events.addEventListener(RoomSessionErrorMessageEvent.const_203,roomSessionDialogEventHandler);
            var_33.events.addEventListener(RoomSessionErrorMessageEvent.const_535,roomSessionDialogEventHandler);
            var_33.events.addEventListener(RoomSessionErrorMessageEvent.const_988,roomSessionDialogEventHandler);
            var_33.events.addEventListener(RoomSessionErrorMessageEvent.const_939,roomSessionDialogEventHandler);
            var_33.events.addEventListener(RoomSessionErrorMessageEvent.const_214,roomSessionDialogEventHandler);
            var_33.events.addEventListener(RoomSessionErrorMessageEvent.const_216,roomSessionDialogEventHandler);
            var_33.events.addEventListener(RoomSessionErrorMessageEvent.const_195,roomSessionDialogEventHandler);
            var_33.events.addEventListener(RoomSessionErrorMessageEvent.const_189,roomSessionDialogEventHandler);
            var_33.events.addEventListener(RoomSessionErrorMessageEvent.const_213,roomSessionDialogEventHandler);
            var_33.events.addEventListener(RoomSessionErrorMessageEvent.const_193,roomSessionDialogEventHandler);
            var_33.events.addEventListener(RoomSessionErrorMessageEvent.const_219,roomSessionDialogEventHandler);
            var_33.events.addEventListener(RoomSessionErrorMessageEvent.const_722,roomSessionDialogEventHandler);
            var_33.events.addEventListener(RoomSessionErrorMessageEvent.const_587,roomSessionDialogEventHandler);
            var_33.events.addEventListener(RoomSessionErrorMessageEvent.const_163,roomSessionDialogEventHandler);
            var_33.events.addEventListener(RoomSessionErrorMessageEvent.const_687,roomSessionDialogEventHandler);
            var_33.events.addEventListener(RoomSessionErrorMessageEvent.const_496,roomSessionDialogEventHandler);
            var_33.events.addEventListener(RoomSessionQueueEvent.const_413,roomSessionEventHandler);
            var_33.events.addEventListener(RoomSessionVoteEvent.const_104,roomSessionEventHandler);
            var_33.events.addEventListener(RoomSessionVoteEvent.const_117,roomSessionEventHandler);
            var_33.events.addEventListener(RoomSessionPollEvent.const_112,roomSessionEventHandler);
            var_33.events.addEventListener(RoomSessionPollEvent.const_59,roomSessionEventHandler);
            var_33.events.addEventListener(RoomSessionPollEvent.const_121,roomSessionEventHandler);
            var_33.events.addEventListener(RoomSessionDimmerPresetsEvent.const_454,roomSessionEventHandler);
         }
      }
      ...
      private function onAvatarEditorReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1763 = param2 as IHabboAvatarEditor;
      }
   }
}
