package com.sulake.core.window.components
{
   ...
   public class BitmapWrapperController extends WindowController implements IBitmapWrapperWindow, IBitmapDataContainer
   {
      ...
      protected var var_422:Boolean = true;
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_422 = var_422;
         _loc1_.var_1048 = var_1048;
         return _loc1_;
      }
      
      public function set bitmap(param1:BitmapData) : void
      {
         if(var_422 && _bitmapData && param1 != _bitmapData)
         {
            _bitmapData.dispose();
         }
         _bitmapData = param1;
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            switch(_loc3_.key)
            {
               case "handle_bitmap_disposing":
                  var_422 = _loc3_.value as Boolean;
                  break;
               case "bitmap_asset_name":
                  var_1048 = _loc3_.value as String;
                  break;
            }
            _loc4_++;
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("handle_bitmap_disposing",var_422,PropertyStruct.const_57,var_422 != true));
         _loc1_.push(new PropertyStruct("bitmap_asset_name",var_1048,PropertyStruct.const_191,var_1048 != null));
         return _loc1_;
      }
