package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_2014:BitmapData = null;
      
      private var var_592:IHabboCommunicationManager;
      
      private var var_672:int = 0;
      
      private var _config:IHabboConfigurationManager;
      
      private var var_2016:BitmapData = null;
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(isValidAdImage(_loc3_))
         {
            ...
            events.dispatchEvent(new AdEvent(AdEvent.const_381,0,0,_loc4_,var_1472,var_2016,var_2014));
         }
      }
      ...
      private function onConfigurationInit(param1:Event = null) : void
      {
         var _loc6_:* = null;
         var _loc7_:* = null;
         var_2013 = int(_config.getKey("interstitial.interval","30000"));
         var_2012 = int(_config.getKey("interstitial.show.time","5000"));
         var_1474 = int(_config.getKey("interstitial.max.displays.flash","-1"));
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         var_1233 = _loc2_.imageUrl;
         var_1472 = _loc2_.clickUrl;
         if(var_1233 != "" && var_1472 != "")
         {
            _loc3_ = var_1233;
            ...
            _loc4_ = new URLRequest(var_1233);
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         var_1232 = _loc2_.imageUrl;
         var_2015 = _loc2_.clickUrl;
         var_672 = getTimer();
         if(var_1232 != "")
         {
            _loc3_ = var_1232;
            ...
            var_234.start();
            _loc4_ = new URLRequest(var_1232);
            _loc5_ = _assets.loadAssetFromFile(_loc3_,_loc4_,"image/jpeg");
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_428,0,0,param1.bitmapData,var_2015));
            var_672 = getTimer();
         }
         else
         {
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_2014 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(var_1474 > 0 && var_1473 >= var_1474)
         {
            return false;
         }
         var _loc1_:int = getTimer() - var_672;
         if(_loc1_ > var_2013)
         {
            ++var_1473;
      ...
      {
         var_592 = param2 as IHabboCommunicationManager;
         if(var_592 == null)
         {
            return;
         }
         _connection = var_592.getHabboMainConnection(onConnectionReady);
         if(_connection != null)
         {
      ...
      private function stopInterstitial() : void
      {
         ...
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_477));
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            var_2016 = emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
