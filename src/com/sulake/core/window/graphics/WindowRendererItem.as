package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      private static const const_748:uint = 1;
      ...
      private var var_226:Rectangle;
      
      private var var_227:Boolean;
      
      private var var_99:BitmapData;
      
      private var var_865:Matrix;
      
      private var var_135:WindowRenderer;
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.RESIZE:
               ...
               _loc4_ = true;
               break;
            case WindowRedrawFlag.const_434:
               ...
               break;
            case WindowRedrawFlag.const_811:
               var_666 = var_667.getTheActualState(param1.type,param1.style,param1.state);
               if(var_666 != var_990)
               {
                  var_227 = true;
                  _loc4_ = true;
         ...
         if(_loc4_)
         {
            var_226.left = Math.min(var_226.left,param2.left);
            var_226.top = Math.min(var_226.top,param2.top);
            var_226.right = Math.max(var_226.right,param2.right);
            var_226.bottom = Math.max(var_226.bottom,param2.bottom);
         }
         return _loc4_;
      }
      ...
      {
         return var_667.getTheActualState(param1.type,param1.style,param1.state) != var_990;
      }
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         var _loc4_:* = null;
         var _loc10_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_749) : uint(const_486);
         var _loc6_:ISkinRenderer = resolveSkinRenderer(param1);
         if(_loc6_ != null)
         {
            _loc5_ = !!_loc6_.isStateDrawable(var_666) ? uint(const_748) : uint(_loc5_);
         }
         ...
         if(_loc5_ != const_486)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_748)
               {
                  ...
                  if(var_227)
                  {
                     ...
                     _loc6_.draw(param1,var_99,var_99.rect,var_666,false);
                  ...
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_33))
                  {
                     ...
                     _loc4_.draw(var_99,var_865,_colorTransform,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
            ...
            var_226.left = int.MAX_VALUE;
            var_226.top = int.MAX_VALUE;
            var_226.right = int.MIN_VALUE;
            var_226.bottom = int.MIN_VALUE;
         }
         return true;
      }
      ...
      {
         var _loc2_:ISkinRenderer = var_667.getSkinRendererByType(param1.type,param1.style);
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_834)
            {
               _loc2_ = var_667.getSkinRendererByType(param1.type,WindowStyle.const_834);
            }
         }
         return _loc2_;
      }
