   ...
   public class LoadingScreen extends Sprite implements ICoreConfigStatusListener
   {
      ...
      private function startFadingAnimation() : void
      {
         if(!var_12)
         {
            ...
            addEventListener(Event.ENTER_FRAME,method_1);
         }
      }
      ...
      private function onStageInit(param1:Event = null) : void
      {
         ...
         {
            var_13 = stage.loaderInfo.parameters[const_1];
         }
      ...
      {
         var _loc2_:Number = 1 - var_17 + param1 * var_17;
      ...
      private function method_1(param1:Event) : void
      {
         if(alpha == 0)
         {
            removeEventListener(Event.ENTER_FRAME,method_1);
            if(var_15 != null)
            {
               var_15.onFadingAnimationComplete();
            }
         }
         alpha -= 0.1;
         if(alpha < 0)
