package com.sulake.habbo.ui
{
   ...
   public class ChooserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private function handleUserChooserRequest() : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetChooserContentEvent(RoomWidgetChooserContentEvent.const_453,_loc3_));
      }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_304);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_387);
         _loc1_.push(RoomWidgetRoomObjectMessage.const_615);
         return _loc1_;
      }
      ...
      private function handleFurniChooserRequest() : void
      {
         ...
         while(_loc4_ < _loc9_)
         {
            ...
            if(_loc8_ != null)
            {
               _loc5_ = _loc8_.getModel().getNumber(RoomObjectVariableEnum.const_327);
         ...
         _loc3_.sort(compareItems);
         _container.events.dispatchEvent(new RoomWidgetChooserContentEvent(RoomWidgetChooserContentEvent.const_456,_loc3_,_container.sessionDataManager.isAnyRoomController));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_387:
               handleFurniChooserRequest();
               break;
            case RoomWidgetRequestWidgetMessage.const_304:
               handleUserChooserRequest();
               break;
            case RoomWidgetRoomObjectMessage.const_615:
      ...
      {
         return RoomWidgetEnum.const_267;
      }
   }
}
