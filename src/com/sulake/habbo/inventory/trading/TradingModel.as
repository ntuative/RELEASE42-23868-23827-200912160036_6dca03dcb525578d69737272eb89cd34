package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_1328:uint = 9;
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_53.updateItemList(var_1155);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            var_53.alertPopup(TradingView.const_867);
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            {
               var_53.alertPopup(TradingView.const_982);
            }
            close();
         }
      ...
      {
         Logger.log("OLD STATE: " + _state + " NEW STATE: " + param1 + " OWN: " + var_458 + " OTHER: " + var_639);
         ...
         {
            case const_169:
               if(param1 == const_168 || param1 == const_192)
               {
                  _state = param1;
                  _loc2_ = true;
               }
      ...
      {
         var_53.setMinimized(param1 != InventoryCategory.const_68);
      ...
      public function close() : void
      {
         if(var_557)
         {
            if(_state != const_169 && _state != const_192)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_169;
            var_25.toggleInventorySubPage(InventorySubCategory.const_965);
            var_557 = false;
         }
         var_53.setMinimized(false);
      }
