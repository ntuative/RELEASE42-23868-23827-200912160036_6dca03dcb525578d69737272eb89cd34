package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class SearchTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_1497:TextSearchInputs;
      ...
      private function method_13(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         _navigator.mainViewCtrl.startSearch(Tabs.const_184,Tabs.const_207,"-1",MainViewCtrl.const_617);
      }
      ...
      private function refreshSearchInfo(param1:IWindowContainer) : void
      {
         ...
         {
            _loc5_.visible = true;
            if(_navigator.data.guestRoomSearchResults.searchType == Tabs.const_319)
            {
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         if(var_1497 == null)
         {
            ...
            var_1497 = new TextSearchInputs(_navigator,false,_loc4_);
         ...
         {
            var_1497.searchStr.setText(_navigator.data.guestRoomSearchResults.searchParam);
         }
      ...
      {
         Util.setProc(param1,"clear_results",method_13);
      }
