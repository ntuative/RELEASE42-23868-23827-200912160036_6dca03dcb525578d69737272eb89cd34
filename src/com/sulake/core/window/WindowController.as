package com.sulake.core.window
{
   ...
   public class WindowController extends WindowModel implements IWindow, IChildEntity, IGraphicContextHost
   {
         ...
         if(_loc9_)
         {
            ...
            if(param2)
            {
               ...
               while(_loc3_ < _loc10_)
               {
                  ...
                  _loc13_ = param1.testParamFlag(WindowParam.const_74);
                  if(_loc13_)
                  {
                     param1.setParamFlag(WindowParam.const_74,false);
                  }
                  param1.offset(-_loc4_,-_loc5_);
                  if(_loc13_)
                  {
                     param1.setParamFlag(WindowParam.const_74,true);
                  }
                  _loc3_++;
               }
            }
      ...
      protected function updateScaleRelativeToParent() : void
      {
         ...
         var _loc1_:* = !testParamFlag(WindowParam.const_118,WindowParam.const_138);
         var _loc2_:* = !testParamFlag(WindowParam.const_123,WindowParam.const_129);
         if(_loc1_ || _loc2_)
         {
            _loc3_ = var_22.clone();
            if(_loc1_)
            ...
            if(_loc2_)
            {
               _loc4_ = 0 - 0;
               _loc5_ = uint(var_29 & 0);
               if(_loc5_ == WindowParam.const_229)
               {
         ...
         else if(testParamFlag(WindowParam.const_74))
         {
            _loc3_ = var_22.clone();
            if(var_23 != null)
            {
      ...
      {
         var_5 = param1;
         var_417 = !!var_5 ? uint(var_417 | _alphaColor) : uint(var_417 & 16777215);
         _context.invalidate(this,var_22,WindowRedrawFlag.const_71);
      }
      
      public function destroy() : Boolean
      {
         if(_state == WindowState.const_390)
         {
            return true;
         }
         _state = WindowState.const_390;
      ...
      {
         return "[Window " + getQualifiedClassName(this) + " " + var_2009 + "]";
      }
      ...
      protected function forwardWindowNotifyEvent(param1:WindowNotifyEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            case WindowNotifyEvent.const_516:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_1238:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_1124:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_888:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_362:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_838:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_721:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_786:
               ...
               _loc4_ = true;
               break;
            case WindowNotifyEvent.const_612:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_813:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_783:
               _loc2_ = "null";
               _loc4_ = true;
               break;
            ...
            case WindowNotifyEvent.const_596:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_212:
               _loc2_ = "null";
               break;
            ...
            case WindowNotifyEvent.const_904:
               _loc2_ = "null";
               break;
            case WindowNotifyEvent.const_619:
               _loc2_ = "null";
               break;
      ...
      public function setStyleFlag(param1:uint, param2:Boolean = true) : void
      {
         ...
         if(var_86 != _loc3_)
         {
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_398,this,null));
         }
      }
      ...
      public function addChildAt(param1:IWindow, param2:int) : IWindow
      {
         ...
         _loc3_.parent = this;
         if(var_1000 || _loc3_.hasGraphicsContext())
         {
         ...
         update(this,new WindowNotifyEvent(WindowNotifyEvent.const_277,this,param1));
         return param1;
      }
      ...
      public function set color(param1:uint) : void
      {
         ...
         var_417 = !!var_5 ? uint(param1) : uint(param1 & 16777215);
         _context.invalidate(this,var_22,WindowRedrawFlag.const_71);
      }
      ...
      public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         var _loc7_:* = 0;
         var _loc8_:* = 0;
         if(!testParamFlag(WindowParam.const_716))
         {
         ...
         if(param2 is MouseEvent)
         {
            switch(param2.type)
            {
               case MouseEvent.MOUSE_DOWN:
                  ...
                  _loc4_.areaLimit = MouseListenerType.const_923;
                  if(testParamFlag(WindowParam.const_291))
                  {
                     _loc5_ = {};
                     while(_loc5_ != null)
                     {
                        if(_loc5_.testParamFlag(WindowParam.const_183))
                        {
               ...
               case MouseEvent.MOUSE_UP:
                  ...
                  if(testParamFlag(WindowParam.const_183))
                  {
         ...
         if(param2 is WindowNotifyEvent)
         {
            switch(param2.type)
            {
               case WindowNotifyEvent.const_260:
                  ...
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_446,this,null));
                     if(testParamFlag(WindowParam.const_171,WindowParam.const_138))
                     {
                        updateScaleRelativeToParent();
                     }
                     else if(testParamFlag(WindowParam.const_159,WindowParam.const_129))
                     {
                        updateScaleRelativeToParent();
                     }
                     if(var_23 != null)
                     {
                        ...
                        if(testParamFlag(WindowParam.const_463))
                        {
                           var_23.height += 0 - 0;
                        }
                        var_29 = _loc8_;
                        var_23.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_223,var_23,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_418:
                  _context.invalidate(this,var_22.union(var_60),WindowRedrawFlag.const_434);
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_793,this,null));
                     if(var_23 != null)
                     {
                        var_23.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_235,var_23,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_311:
                  if(param1 == this)
                  {
                     notifyChildren(new WindowNotifyEvent(WindowNotifyEvent.const_596,this,null));
                     if(var_23 != null)
                     {
                        var_23.update(this,new WindowNotifyEvent(WindowNotifyEvent.const_212,var_23,this));
                     }
                  }
                  break;
               case WindowNotifyEvent.const_472:
                  _context.invalidate(this,var_22,WindowRedrawFlag.const_811);
                  break;
               case WindowNotifyEvent.const_398:
                  _loc6_ = new Array();
               ...
               case WindowNotifyEvent.const_438:
                  if(!(var_29 & 0))
                  {
                     ...
                     {
                        setupGraphicsContext();
                        _context.invalidate(this,var_22,WindowRedrawFlag.const_434);
                     }
                  }
                  else if(var_29 & 0)
                  {
               ...
               case WindowNotifyEvent.const_212:
                  ...
                  break;
               case WindowNotifyEvent.const_446:
                  var_23.getRegionProperties(null,var_296);
                  updateScaleRelativeToParent();
                  break;
               case WindowNotifyEvent.const_277:
      ...
      public function activate() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_311;
         update(this,_loc1_);
         return true;
      }
      ...
      public function removeChild(param1:IWindow) : IWindow
      {
         ...
         if(_children.removeChild(_loc2_) != null)
         {
            ...
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_619,this,param1));
            return param1;
         }
         return null;
      }
      ...
      public function disable() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_786,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
         ...
         _loc1_.type = WindowNotifyEvent.const_612;
         update(this,_loc1_);
         return true;
      }
      ...
      public function addChild(param1:IWindow) : IWindow
      {
         ...
         _loc2_.parent = this;
         if(var_1000 || _loc2_.hasGraphicsContext())
         {
            setupGraphicsContext();
      ...
      public function setRectangle(param1:int, param2:int, param3:int, param4:int) : void
      {
         ...
         if(_loc6_ && !_loc5_)
         {
            ...
            if(_loc7_ == WindowParam.const_369)
            {
               param1 -= (param3 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_343)
            {
               param1 -= param3 - 0;
               _loc5_ = true;
            }
            _loc7_ = uint(var_29 & 0);
            if(_loc7_ == WindowParam.const_367)
            {
               param2 -= (param4 - 0) / 2;
               _loc5_ = true;
            }
            else if(_loc7_ == WindowParam.const_377)
            {
               param2 -= param4 - 0;
               _loc5_ = true;
            }
         }
         if(testParamFlag(WindowParam.const_74))
         {
            if(var_23 != null)
            {
         ...
         if(_loc5_ || _loc6_)
         {
            if(_loc5_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_878,this,null,true);
               update(this,_loc10_);
            ...
            if(_loc6_)
            {
               _loc10_ = new WindowNotifyEvent(WindowNotifyEvent.const_516,this,null,true);
               update(this,_loc10_);
               if(_loc10_.isWindowOperationPrevented())
               {
                  _loc6_ = false;
            ...
            if(_loc6_)
            {
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_260,this,null));
            }
         }
      }
      ...
      public function set state(param1:uint) : void
      {
         ...
         {
            _state = param1;
            update(this,new WindowNotifyEvent(WindowNotifyEvent.const_472,this,null));
         }
      }
         ...
         if(var_306 && var_499 > 0)
         {
            if(!testParamFlag(WindowParam.const_33))
            {
               if(param1.x <= var_22.width && param1.y <= var_22.height)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     _loc4_ = _loc5_.hitTest(var_1463,param3,param1);
                  }
               }
            }
            else
            {
               _loc4_ = param2 != null ? Boolean(param2.hitTest(var_1463,param3,param1)) : false;
            }
         }
      ...
      public function set parent(param1:IWindow) : void
      {
         ...
         if(var_23 != param1)
         {
            ...
            if(var_23 != null)
            {
               var_296 = var_23.rectangle.clone();
               var_60.x = var_22.x;
               var_60.y = var_22.y;
               var_60.width = var_22.width;
               var_60.height = var_22.height;
               update(this,new WindowNotifyEvent(WindowNotifyEvent.const_429,this,var_23));
            }
            else
            {
               var_296.x = 0;
      ...
      public function clone() : IWindow
      {
         ...
         var _loc2_:WindowController = new _loc1_(_name,var_240,_type,var_86,var_29,_context,var_22,null,var_583,properties,var_581.concat(),_id) as WindowController;
         _loc2_.var_499 = var_499;
         _loc2_.var_306 = var_306;
         _loc2_.var_867 = var_867;
      ...
      public function enable() : Boolean
      {
         ...
         _loc1_.type = WindowNotifyEvent.const_721;
         update(this,_loc1_);
         return true;
      }
      ...
      protected function forwardMouseEvent(param1:MouseEvent) : WindowEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_DOWN:
               ...
               break;
            case MouseEvent.MOUSE_UP:
               _loc2_ = !!_loc6_ ? "null" : WindowMouseEvent.const_498;
               break;
            case MouseEvent.MOUSE_WHEEL:
               _loc2_ = "null";
         }
      ...
      public function close() : Boolean
      {
         ...
         var _loc1_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_815,this,null);
         update(this,_loc1_);
         if(_loc1_.isDefaultPrevented())
         {
            return false;
