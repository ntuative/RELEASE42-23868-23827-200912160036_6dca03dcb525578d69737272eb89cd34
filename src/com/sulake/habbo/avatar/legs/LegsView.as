package com.sulake.habbo.avatar.legs
{
   ...
   public class LegsView implements IAvatarEditorCategoryView
   {
      ...
      public function LegsView(param1:LegsModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_679["null"] = new AvatarEditorGridView(param1,FigureData.const_131,param2,param3);
         var_679["null"] = new AvatarEditorGridView(param1,FigureData.const_151,param2,param3);
         var_679["null"] = new AvatarEditorGridView(param1,FigureData.const_133,param2,param3);
         attachImages();
