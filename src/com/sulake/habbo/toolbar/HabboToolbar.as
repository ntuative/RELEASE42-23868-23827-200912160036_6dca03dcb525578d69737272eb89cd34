package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_592.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_125,onSetToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_866,onSetToolbarIconBitmapEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_172,onRemoveToolbarIconEvent);
         events.addEventListener(HabboToolbarSetIconEvent.const_153,onSetToolbarIconStateEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_46,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_458,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_631,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_851,onHideWindowEvent);
         _state = true;
         events.dispatchEvent(new HabboToolbarEvent(HabboToolbarEvent.const_81));
      }
