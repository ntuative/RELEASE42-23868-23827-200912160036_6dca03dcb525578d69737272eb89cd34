package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      private var var_1532:Boolean = true;
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1481,var_1479,var_1480,_alphaMultiplier);
         var_879 = generatePaletteMapForGrayscale(var_1531,var_1530);
      }
      
      public function get reds() : Array
      {
         return var_879.getValue("reds") as Array;
      }
      ...
      {
         return var_879.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_879.getValue("greens") as Array;
      }
      ...
      {
         return var_879.getValue("alphas") as Array;
      }
