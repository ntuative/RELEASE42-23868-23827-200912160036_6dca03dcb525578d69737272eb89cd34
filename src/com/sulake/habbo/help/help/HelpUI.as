package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_1780:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","23868-23827-200912160011");
         var_205 = param5;
         var_108 = new Map();
         var_108.add(HabboHelpViewEnum.const_1161,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_108.add(HabboHelpViewEnum.const_144,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_108.add(HabboHelpViewEnum.const_474,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_108.add(HabboHelpViewEnum.const_248,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_108.add(HabboHelpViewEnum.const_198,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_108.add(HabboHelpViewEnum.const_693,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_108.add(HabboHelpViewEnum.const_293,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_108.add(HabboHelpViewEnum.const_529,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_108.add(HabboHelpViewEnum.const_185,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary,"help_cfh_thanks")));
         ...
         var_108.add(HabboHelpViewEnum.const_817,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_108.add(HabboHelpViewEnum.const_562,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function createWindow() : void
      {
         ...
         var_1399 = 0 - _loc3_.width;
         var_1400 = _window.height;
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_257 == HabboHelpViewEnum.const_144 || false)
         {
            return;
         }
         if(var_378 == null)
         {
            ...
            var_378 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
         }
         var _loc1_:IItemListWindow = _window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || var_378 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(var_378 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(var_378 as IWindow);
      ...
      {
         return var_108.getValue(var_257);
      }
      ...
      {
         var_1782 = param1;
         var _loc2_:IHelpViewController = var_108.getValue(HabboHelpViewEnum.const_144) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_185:
               showUI(HabboHelpViewEnum.const_185);
               break;
            case CallForHelpResultEnum.const_968:
               showUI(HabboHelpViewEnum.const_817);
               break;
            case CallForHelpResultEnum.const_836:
      ...
      {
         var _loc3_:* = null;
         if(var_257 == HabboHelpViewEnum.const_144)
         {
            return;
         }
         if(true)
         {
            ...
            var_536.push(_loc3_.content as BitmapData);
            _loc3_ = _assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            var_536.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = var_378.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(var_536[1],var_536[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(var_536[0],var_536[0].rect,new Point(0,0));
         }
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1400;
         _window.width = _loc1_.width + var_1399;
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + var_257);
            return;
         }
         ...
         if(_loc3_)
         {
            if(var_205 != null)
            {
               var_205.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_46,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_43.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_723));
      }
