package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      private static var var_992:Array = new Array();
      
      private static var _sharedListOfTypesByMime:Dictionary;
      
      private static var var_558:uint = 0;
      
      public static const const_830:String = "AssetLibraryReady";
      
      public static const const_1249:String = "AssetLibraryUnloaded";
      
      public static const const_382:String = "AssetLibraryLoaded";
      
      public static const const_1262:String = "AssetLibraryLoadError";
       
      
      private var var_477:XML;
      ...
      private var var_393:Dictionary;
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_558;
         var_392 = new Dictionary(false);
         var_393 = new Dictionary(false);
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in var_392)
         {
            _loc4_ = AssetTypeDeclaration(var_392[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      public function unload() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for(_loc1_ in var_393)
         {
            _loc2_ = var_393[_loc1_];
            _loc2_.assetLoader.dispose();
            delete var_393[_loc1_];
         }
         ...
         var_294 = false;
         _file = null;
         dispatchEvent(new Event(AssetLibrary.const_1249));
      }
      ...
      private function libraryLoadedHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         var_477 = _loc2_.manifest.copy();
         var_341 = _loc2_.resource;
         if(var_476)
         {
            AssetLibrary.fetchLibraryContents(this,var_477,var_341);
         }
         var_294 = true;
         dispatchEvent(new Event(AssetLibrary.const_382));
         dispatchEvent(new Event(AssetLibrary.const_830));
         if(var_476)
         {
            var_1.dispose();
            var_1 = null;
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = var_393[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_969,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_966,assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_885,assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         var_393[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(var_392.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            var_392[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            unload();
            super.dispose();
            var_992.splice(var_992.indexOf(this),1);
            --var_558;
            var_393 = null;
            var_668 = null;
            _loadedAssets = null;
      ...
      private function loadErrorHandler(param1:Event) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1262));
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in var_392)
         {
            _loc3_ = AssetTypeDeclaration(var_392[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      {
         var _loc2_:Class = var_668[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = true, param3:LoaderContext = null) : LibraryLoader
      {
         ...
         else
         {
            if(var_1 == null)
            {
               var_1 = new LibraryLoader(var_867);
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = var_477.child("library");
         if(_loc2_ == null)
         {
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = var_393[loader.url];
         if(struct == null)
         {
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         _loc3_ = AssetTypeDeclaration(var_392[param1]);
         if(_loc3_ != null)
         {
            return _loc3_;
         }
