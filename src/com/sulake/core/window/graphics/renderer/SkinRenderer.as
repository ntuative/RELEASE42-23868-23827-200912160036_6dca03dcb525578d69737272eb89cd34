package com.sulake.core.window.graphics.renderer
{
   ...
   public class SkinRenderer implements ISkinRenderer
   {
      ...
      protected var var_421:Dictionary;
      ...
      public function removeTemplate(param1:ISkinTemplate) : ISkinTemplate
      {
         ...
         if(param1 != null)
         {
            for(_loc2_ in var_309)
            {
               _loc3_ = uint(_loc2_ as uint);
               if(var_309[_loc3_] == param1)
               {
                  removeTemplateFromRenderState(_loc3_);
               }
            }
            delete var_308[param1.name];
         }
         return param1;
      }
      ...
      {
         var _loc3_:ISkinLayout = var_421[param2];
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:ISkinTemplate = var_308[param2];
         if(_loc3_ == null)
         {
            throw new Error("Template \"" + param2 + "\" not found in renderer!");
         }
         var_309[param1] = _loc3_;
      }
      ...
      {
         var _loc1_:* = null;
         for(_loc1_ in var_421)
         {
            ISkinLayout(var_421[_loc1_]).dispose();
            delete var_421[_loc1_];
         }
         var_421 = null;
         _layoutsByState = null;
         for(_loc1_ in var_308)
         {
            ISkinTemplate(var_308[_loc1_]).dispose();
