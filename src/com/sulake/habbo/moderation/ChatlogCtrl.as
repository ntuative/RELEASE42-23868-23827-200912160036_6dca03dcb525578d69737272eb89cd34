package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1406:IMessageComposer;
      ...
      {
         var_722 = IWindowContainer(var_56.getXmlWindow("chatlog_roomheader"));
         var_721 = IWindowContainer(var_56.getXmlWindow("chatlog_chatline"));
         var_430 = new Timer(300,1);
         var_430.addEventListener(TimerEvent.TIMER,onResizeTimer);
         var_58 = IFrameWindow(var_56.getXmlWindow("chatlog_frame"));
         ...
         var_56.connection.send(var_1406);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_722.clone());
         var _loc3_:ITextWindow = ITextWindow(_loc2_.findChildByName("room_name_txt"));
         if(param1.roomId > 0)
         {
            _loc3_.caption = param1.roomName;
            new OpenRoomTool(var_58,var_56,_loc3_,param1.isPublic,param1.roomId);
         }
         else
         {
      ...
      {
         var _loc4_:IWindowContainer = IWindowContainer(var_721.clone());
         _loc4_.color = var_1066[param2.chatterId] != null ? (!!param3 ? 4294623571 : uint(4294959680)) : (!!param3 ? 4288861930 : uint(4294967295));
         ...
         if(param2.chatterId > 0)
         {
            ...
            new OpenUserInfo(var_58,var_56,_loc6_,param2.chatterId);
         }
