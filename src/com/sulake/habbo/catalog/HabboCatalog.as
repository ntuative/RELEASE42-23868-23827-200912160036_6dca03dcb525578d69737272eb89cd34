package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_214:IMarketPlace;
      
      private var _localization:ICoreLocalizationManager;
      
      private var var_620:PurchaseConfirmationDialog;
      
      private var var_763:IHabboSoundManager;
      
      private var var_326:ICatalogViewer;
      
      private var var_1701:Boolean = true;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_371:ICatalogNavigator;
      ...
      {
         return var_560.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         var_190.credits = _loc3_.balance;
         method_3();
         if(!var_1702 && var_763 != null)
         {
            var_763.playSound(HabboSoundTypesEnum.const_796);
         }
         var_1702 = false;
      }
      ...
      public function getFurnitureData(param1:int, param2:String) : IFurnitureData
      {
         ...
         {
            _loc3_ = var_560.getFloorItemData(param1);
         }
         if(param2 == ProductTypeEnum.const_75)
         {
            _loc3_ = var_560.getWallItemData(param1);
         }
         return _loc3_;
      }
      ...
      private function onRoomSessionEvent(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            case RoomSessionEvent.const_83:
               var_1121 = param1.session.isPrivateRoom;
               if(var_88 != null)
               {
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         if(var_205 != null && _loc2_)
         {
            var_205.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_46,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         {
            if(false && "true" == var_173.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = var_173.getKey("link.format.credits");
               if(_loc3_ != "")
               {
      ...
      private function createMainWindow() : void
      {
         ...
         _loc3_.setParamFlag(WindowParam.const_183,false);
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_371 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         var_190.clubDays = Math.max(0,_loc2_.daysToPeriodEnd);
         var_190.clubPeriods = Math.max(0,_loc2_.periodsSubscribedAhead);
         method_3();
      ...
      public function showPurchaseConfirmation(param1:Offer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         else
         {
            if(var_620 == null)
            {
               var_620 = new PurchaseConfirmationDialog(_localization);
            }
            _loc7_ = [];
            if(_friendList != null)
            {
            ...
            var_620.showOffer(this,param1,param2,param3,_loc7_);
         }
      }
      ...
      private function createMarketPlace() : void
      {
         if(var_214 == null)
         {
            var_214 = new MarketPlaceLogic(this,_windowManager);
         }
      }
      ...
      {
         var_205.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_125,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_371.buildCatalogIndex(_loc2_);
         if(var_923 != "")
         {
            var_371.openPage(var_923);
            var_923 = "";
         }
         else
         {
            var_371.openFrontPage();
         }
      }
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:Event) : void
      {
         ...
         if(param2.type == WindowEvent.const_170)
         {
            _loc3_ = var_173.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               _windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         var_190.pixels = _loc2_.amount;
         method_3();
         if(!var_1701 && var_763 != null)
         {
            var_763.playSound(HabboSoundTypesEnum.const_803);
         }
         var_1701 = false;
      }
      ...
      private function method_3() : void
      {
         ...
         _localization.registerParameter("catalog.purse.creditbalance","balance",String(var_190.credits));
         _localization.registerParameter("catalog.purse.pixelbalance","balance",String(var_190.pixels));
         _localization.registerParameter("catalog.purse.clubdays","days",String(var_190.clubDays));
         _localization.registerParameter("catalog.purse.clubdays","months",String(var_190.clubPeriods));
         if(false)
         {
            return;
         }
      ...
      private function createCatalogViewer() : void
      {
         ...
         var_326 = new CatalogViewer(this,_loc1_,_roomEngine) as ICatalogViewer;
      }
      
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var _loc3_:IRoomSessionManager = IRoomSessionManager(param2);
         _loc3_.events.addEventListener(RoomSessionEvent.const_83,onRoomSessionEvent);
