package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1526:String = "_INCLUDE";
      
      public static const const_814:String = "_EXCLUDE";
      
      public static const const_1396:String = "_TEMP";
      
      private static const const_1088:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1089:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1044:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_871:Dictionary;
      
      protected var var_1304:Map;
      
      protected var _context:IWindowContext;
      
      protected var var_1305:Dictionary;
      
      protected var var_1045:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(var_1045,var_1044);
         var_871 = new Dictionary();
         var_1305 = new Dictionary();
         ParamCodeTable.fillTables(var_871,var_1305);
         var_1304 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1089,"");
         return param1.replace(const_1088,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_1045)
            {
               delete var_1045[_loc1_];
            }
            for(_loc1_ in var_1044)
            {
               delete var_1044[_loc1_];
            }
            for(_loc1_ in var_871)
            {
               delete var_871[_loc1_];
            }
            for(_loc1_ in var_1305)
            {
               delete var_1305[_loc1_];
            }
            var_1304.dispose();
            var_1304 = null;
            _context = null;
            ...
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  if(window.x != rect.x || window.y != rect.y || window.width != rect.width || window.height != rect.height)
                  {
                     ...
                     if((params & 0) == WindowParam.const_159)
                     {
                        window.y = rect.y;
                     }
                  }
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_814) == -1)
                  {
