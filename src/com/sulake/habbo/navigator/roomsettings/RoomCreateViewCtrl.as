package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_1166 = new Timer(100);
         var_1166.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_67 = new Array();
         var_67.push(new RoomLayout(false,104,"a"));
         var_67.push(new RoomLayout(false,94,"b"));
         var_67.push(new RoomLayout(false,36,"c"));
         var_67.push(new RoomLayout(false,84,"d"));
         var_67.push(new RoomLayout(false,80,"e"));
         var_67.push(new RoomLayout(false,80,"f"));
         var_67.push(new RoomLayout(true,80,"g"));
         var_67.push(new RoomLayout(true,74,"h"));
         var_67.push(new RoomLayout(false,416,"i"));
         var_67.push(new RoomLayout(false,320,"j"));
         var_67.push(new RoomLayout(false,448,"k"));
         var_67.push(new RoomLayout(false,352,"l"));
         var_67.push(new RoomLayout(false,384,"m"));
         var_67.push(new RoomLayout(false,372,"n"));
         var_67.push(new RoomLayout(true,416,"o"));
         var_67.push(new RoomLayout(true,352,"p"));
         var_67.push(new RoomLayout(true,304,"q"));
         var_67.push(new RoomLayout(true,336,"r"));
      }
      ...
      private function prepare() : void
      {
         ...
         var_951 = new TextFieldManager(_navigator,ITextFieldWindow(var_34.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         _loc2_ = 0;
         _loc4_ = 0;
         while(_loc4_ < var_67.length)
         {
            _loc6_ = var_67[_loc4_];
            if(isAllowed(_loc6_))
            {
               if(_loc2_ == 0)
               {
               ...
               addThumbnail(_loc3_,var_67[_loc4_],_loc2_ % 2 == 0);
               _loc2_ = _loc2_ == 0 ? 1 : 0;
            }
            _loc4_++;
         }
         ...
         var_1828 = _navigator.data.hcMember;
      }
      ...
      private function refresh() : void
      {
         ...
         var_786 = var_67[0];
         if(var_1828 != _navigator.data.hcMember)
         {
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_53,HabboWindowStyle.const_39,HabboWindowParam.const_67,new Rectangle(0,0,100,300)));
      }
