package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected var var_2165:Number = NaN;
      ...
      private function updateSprites(param1:int, param2:Number) : void
      {
         ...
         if(_loc5_ != null)
         {
            ...
            if(_loc7_ != null)
            {
               _loc8_ = _loc7_.getString(RoomObjectVariableEnum.const_289);
            ...
            if(_loc10_ != null)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  else
                  {
                     ...
                     {
                        _loc13_ *= object.getModel().getNumber(RoomObjectVariableEnum.const_155);
                     }
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            var_2179 = _loc3_.getNumber(RoomObjectVariableEnum.const_218);
      ...
      protected function getSpriteAlpha(param1:int, param2:int, param3:int) : int
      {
         ...
         if(_loc5_ != null)
         {
            _loc6_ = Number(_loc5_.getNumber(RoomObjectVariableEnum.const_155));
            if(isNaN(_loc6_))
            {
               _loc6_ = 1;
            }
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_277 != _loc3_.getUpdateID() || param1 != var_206 || param2 != var_2165)
         {
            _loc4_ = _loc3_.getDirection().x - (param2 + 135);
            _loc4_ = (_loc4_ % 360 + 360) % 360;
            _loc5_ = _data.getDirectionValue(_loc4_,param1);
            _direction = _loc5_;
            var_277 = _loc3_.getUpdateID();
            var_2165 = param2;
            return true;
         }
         return false;
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         if(_loc2_ || var_206 != param1.scale)
         {
