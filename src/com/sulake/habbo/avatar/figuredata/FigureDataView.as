package com.sulake.habbo.avatar.figuredata
{
   ...
   public class FigureDataView
   {
      ...
      private var var_439:IBitmapWrapperWindow;
      ...
      public function FigureDataView(param1:IHabboWindowManager, param2:IAssetLibrary)
      {
         ...
         var_1268 = _loc4_.content as BitmapData;
         if(_window != null)
         {
            var_439 = _window.findChildByName("bitmap") as IBitmapWrapperWindow;
         }
      }
      ...
      {
         var_439.bitmap = new BitmapData(var_439.width,var_439.height,true,16777215);
         var_439.bitmap.copyPixels(var_1268,var_1268.rect,new Point(0,0 - 0 - 8));
         var_439.bitmap.copyPixels(param1,param1.rect,new Point(4,0),null,null,true);
      }
   }
}
