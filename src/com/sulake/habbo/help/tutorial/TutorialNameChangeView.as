package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialNameChangeView implements ITutorialUIView
   {
      ...
      private static var var_1502:uint = 13232628;
      
      private static var var_2095:uint = 11129827;
      ...
      private var var_843:NameSuggestionListRenderer;
      ...
      public function setNameAvailableView() : void
      {
         ...
         var_56.localization.registerParameter("help.tutorial.name.available","name",var_407);
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "button_usecurrent":
                  var_407 = var_56.help.ownUserName;
                  showConfirmationView(true);
                  break;
               case "button_name_check":
                  if(_loc3_.text.length < 1)
      ...
      private function showConfirmationView(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            var_56.localization.registerParameter("help.tutorial.name.confirmation","name",var_407);
         }
         if(var_273 == null)
         {
            var_273 = var_56.buildXmlWindow("tutorial_change_name_confirmation") as IBorderWindow;
            if(var_273 == null)
            {
               return;
            }
      ...
      public function setNameNotAvailableView(param1:int, param2:String, param3:Array) : void
      {
         ...
         switch(param1)
         {
            case ChangeUserNameResultMessageEvent.var_1035:
         ...
         _loc5_.visible = true;
         var_843 = new NameSuggestionListRenderer(var_56);
         var _loc6_:int = var_843.render(param3,_loc5_);
         var _loc7_:int = 0;
         while(_loc7_ < _loc5_.numChildren)
         {
            _loc8_ = _loc5_.getChildAt(_loc7_);
            _loc8_.color = var_1502;
