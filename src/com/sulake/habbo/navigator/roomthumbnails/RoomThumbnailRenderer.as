package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailRenderer
   {
      ...
      private static const const_1030:int = -16;
      
      private static const const_736:int = 32;
      
      private static const const_1029:int = 8;
      
      public static const const_388:int = 10;
      ...
      private var var_918:Dictionary;
      
      private var var_1689:Dictionary;
      
      private var var_752:ThumbnailImageConfigurations;
      
      private var var_1117:BitmapData;
      
      public function RoomThumbnailRenderer(param1:HabboNavigator)
      {
         var_918 = new Dictionary();
         super();
         _navigator = param1;
         var_752 = new ThumbnailImageConfigurations(_navigator);
      ...
      public function refreshThumbnail(param1:IWindowContainer, param2:RoomThumbnailData, param3:Boolean) : void
      {
         ...
         if(_loc5_ == null)
         {
            ...
            _loc5_ = IBitmapWrapperWindow(_navigator.windowManager.createWindow("bitmap","",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_40,0 | (!!param3 ? HabboWindowParam.const_37 : HabboWindowParam.const_40),new Rectangle(0,0,_loc7_.width,_loc7_.height)));
      ...
      {
         var _loc3_:ThumbnailImageConfiguration = this.var_752.getImage(ThumbnailEditorModel.const_31,param2.imgId);
         if(_loc3_ == null)
         {
         ...
         param1.copyPixels(_loc5_,_loc5_.rect,new Point(_loc4_.x + const_1030,_loc4_.y + const_1031 - _loc5_.height),null,null,true);
      }
      ...
      {
         return Point(this.var_1689[param1]);
      }
      ...
      private function refreshBg(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_752.getImage(ThumbnailEditorModel.const_35,param2);
         if(_loc3_ == null)
         {
            Logger.log("Unknown bg image id: " + param2);
            _loc3_ = this.var_752.getImage(ThumbnailEditorModel.const_35,1);
         }
      ...
      private function refreshFront(param1:BitmapData, param2:int) : void
      {
         ...
         var _loc3_:ThumbnailImageConfiguration = this.var_752.getImage(ThumbnailEditorModel.const_51,param2);
         if(_loc3_ == null)
         {
      ...
      {
         var _loc3_:int = param2 % 2 == 0 ? 0 : int(const_736 / 2);
         return new Point(param1 * const_736 + _loc3_,param2 * const_1029);
      }
      ...
      private function refreshObjects(param1:BitmapData, param2:Array) : void
      {
         ...
         while(_loc3_ <= const_388)
         {
            if(false)
            {
               refreshObj(param1,var_918[_loc3_]);
            }
            _loc3_++;
         }
      }
      ...
      private function refreshCover(param1:BitmapData) : void
      {
         if(var_1117 == null)
         {
            var_1117 = _navigator.getButtonImage("rico_rnd");
         }
         param1.copyPixels(var_1117,var_1117.rect,new Point(0,0),null,null,true);
      }
   }
}
