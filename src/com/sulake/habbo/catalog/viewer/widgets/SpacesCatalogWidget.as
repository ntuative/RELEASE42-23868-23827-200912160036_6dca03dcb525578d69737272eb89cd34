package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_180:String = "floor";
      
      private static const const_179:String = "wallpaper";
       
      
      private var var_1087:String = "HabboHelpCom_help_faq_category_xml";
      
      private var var_1182:Array;
      
      private var var_970:BitmapData = null;
      
      private var var_222:int = 0;
      
      private var var_650:int = 0;
      
      private var var_1089:String = "1.1";
      ...
      private var var_969:BitmapData = null;
      ...
      private var _floorType:String = "HabboHelpCom_help_faq_category_xml";
      ...
      override public function init() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            for each(_loc2_ in page.offers)
            {
               ...
               {
                  case "floor":
                     for each(_loc9_ in var_173.floors.pattern)
                     {
                        var_796.push(String(_loc9_.@id));
                        var_1182.push(_loc2_);
                     }
                     break;
                  case "wallpaper":
                     for each(_loc10_ in var_173.walls.pattern)
                     {
                     ...
                     break;
                  case "landscape":
                     for each(_loc11_ in var_173.landscapes.pattern)
                     {
      ...
      public function imageReady(param1:int, param2:BitmapData) : void
      {
         ...
         if(var_970 != null && var_969 != null)
         {
            setRoomImage(var_970,var_969);
         }
      }
      ...
      private function updateConfiguration() : void
      {
         ...
         for each(_loc1_ in var_173.walls.pattern)
         {
            if(_loc1_.@id == _loc2_)
            {
               if(var_222 >= 0)
         ...
         for each(_loc1_ in var_173.floors.pattern)
         {
            if(_loc1_.@id == _loc5_)
            {
               _loc11_ = _loc1_.children()[var_260];
               if(_loc11_ != null)
               {
         ...
         for each(_loc1_ in var_173.landscapes.pattern)
         {
            if(_loc1_.@id == _loc7_)
            {
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_179:
               ...
               if(var_286 == _activeWallpaperPatterns.length)
               {
                  var_286 = 0;
               }
               var_222 = 0;
               var_648 = 0;
               _loc5_ = "null";
               for each(_loc8_ in var_173.walls.pattern)
               {
                  if(_loc8_.@id == _loc5_)
                  {
                     var_648 = _loc8_.children().length();
                  }
               }
            ...
            case const_180:
               ...
               for each(_loc9_ in var_173.floors.pattern)
               {
                  if(_loc9_.@id == _loc6_)
                  {
                     var_649 = _loc9_.children().length();
                  }
               }
            ...
            case const_181:
               ...
               var_650 = 0;
               _loc7_ = "null";
               for each(_loc10_ in var_173.landscapes.pattern)
               {
                  if(_loc10_.@id == _loc7_)
                  {
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_buy_wall":
               ...
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1087);
               }
               break;
            ...
            case "ctlg_buy_landscape":
               _loc3_ = var_1183[var_287];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page,var_1089);
               }
               break;
            default:
      ...
      private function retrieveSpacesPreview() : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:ImageResult = page.viewer.roomEngine.getRoomImage(_floorType,var_1087,var_1089,64,this,"window_romantic_wide");
