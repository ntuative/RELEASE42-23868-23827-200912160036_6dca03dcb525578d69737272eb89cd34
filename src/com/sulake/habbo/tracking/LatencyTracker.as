package com.sulake.habbo.tracking
{
   ...
   public class LatencyTracker
   {
      ...
      {
         var_1358 = getTimer();
         var_440.add(var_1108,var_1358);
         _connection.send(new LatencyPingRequestMessageComposer(var_1108));
         ++var_1108;
      }
      ...
      public function init() : void
      {
         ...
         var_1360 = int(var_173.getKey("latencytest.interval"));
         var_1359 = int(var_173.getKey("latencytest.report.index"));
         var_1669 = int(var_173.getKey("latencytest.report.delta"));
      ...
      private function onPingResponse(param1:IMessageEvent) : void
      {
         ...
         var_151.push(_loc4_);
         if(var_151.length == var_1359 && var_1359 > 0)
         {
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            ...
            if(Math.abs(_loc9_ - var_1361) > var_1669 || var_1361 == 0)
            {
               var_1361 = _loc9_;
