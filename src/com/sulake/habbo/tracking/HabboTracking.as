package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, ICoreUpdateReceiver
   {
      ...
      private var var_399:IHabboHelp;
      
      private var _coreComponent:CoreComponent;
      
      private var var_993:int = -1;
      
      private var var_1227:LagWarningLogger = null;
      
      private var var_822:IHabboWindowManager;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_1227 = new LagWarningLogger();
         var_1228 = new Array(const_753);
         var _loc4_:int = 0;
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1167,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1233,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_639,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_916,String(0));
         }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               ...
               break;
            case HabboCommunicationEvent.const_720:
               trackLoginStep(HabboLoginTrackingStep.const_21,String(_communication.port));
               break;
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_316:
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(var_173)
         {
            Component(var_173).events.addEventListener(HabboConfigurationEvent.const_12,onConfigurationLoaded);
            if(var_230 != null)
            {
               var_230.configuration = var_173;
            }
            if(var_229 != null)
            {
               var_229.configuration = var_173;
            }
         }
      }
      ...
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_454.events.addEventListener(AdEvent.const_381,onRoomAdLoad);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_916,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_639,String(true));
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_720,onConnectionEvent);
         ...
         Component(context).events.addEventListener(HabboHotelViewEvent.const_601,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_59,onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_405,onHotelViewEvent);
      }
      ...
      private function onLagWarningEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case AvatarWalkWarpingWarningEvent.const_476:
               var_1227.registerWarning(LagWarningLogger.const_930);
         }
      }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(var_822)
            {
               var_822.release(new IIDHabboWindowManager());
               var_822 = null;
            }
            if(var_454)
            {
            ...
            if(var_174)
            {
               if(true)
               {
                  ...
                  Component(var_174).events.removeEventListener(HabboFriendListTrackingEvent.const_316,onFriendlistTrackingEvent);
               }
            ...
            if(var_399)
            {
               if(true)
               {
                  var_399.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
                  var_399.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
               }
               var_399.release(new IIDHabboHelp());
               var_399 = null;
            }
            if(_roomEngine)
            {
               if(true)
               {
                  Component(_roomEngine).events.removeEventListener(AvatarWalkWarpingWarningEvent.const_476,onLagWarningEvent);
               }
            }
      ...
      private function onConfigurationLoaded(param1:Event) : void
      {
         ...
         if(var_173)
         {
            Component(var_173).events.removeEventListener(HabboConfigurationEvent.const_12,onConfigurationLoaded);
         }
      }
      ...
      private function onLocalizationLoaded(param1:Event) : void
      {
         ...
         if(_localization)
         {
            Component(_localization).events.removeEventListener(LocalizationEvent.const_17,onLocalizationLoaded);
         }
      }
      
      private function onHelpReady(param1:IID, param2:IUnknown) : void
      {
         var_399 = param2 as IHabboHelp;
         var_399.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,onHelpTrackingEvent);
         var_399.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,onHelpTrackingEvent);
      }
      ...
      {
         var_822 = IHabboWindowManager(param2);
         if(var_822)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         if(var_993 > -1 && _loc2_ < var_993)
         {
            ++var_1458;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + var_1458);
         }
         if(var_993 > -1 && _loc2_ - var_993 > 15000)
         {
            ++var_1457;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + var_1457);
         }
         var_993 = _loc2_;
         if(var_229 != null)
         {
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(_roomEngine).events.addEventListener(AvatarWalkWarpingWarningEvent.const_476,onLagWarningEvent);
         Component(_roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_238,onRoomAdClick);
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(var_174).events.addEventListener(HabboFriendListTrackingEvent.const_316,onFriendlistTrackingEvent);
      }
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         var _loc8_:* = null;
         var _loc9_:int = 0;
         if(param1.critical && !var_1990)
         {
            var_1990 = true;
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1235,new Date().getTime().toString());
            if(var_173)
            {
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(_localization)
         {
            Component(_localization).events.addEventListener(LocalizationEvent.const_17,onLocalizationLoaded);
         }
      }
