package com.sulake.habbo.avatar.cache
{
   ...
   public class AvatarImageCache
   {
      ...
      private static const const_1391:int = 60000;
      ...
      private var var_818:IAvatarImage;
      ...
      public function getBodyPartCache(param1:String) : AvatarImageBodyPartCache
      {
         ...
         var _loc2_:AvatarImageBodyPartCache = var_147.getValue(param1) as AvatarImageBodyPartCache;
         if(_loc2_ == null)
         {
            _loc2_ = new AvatarImageBodyPartCache();
            var_147.add(param1,_loc2_);
         }
         return _loc2_;
      }
      ...
      public function getImageContainer(param1:String, param2:int) : AvatarImageBodyPartContainer
      {
         ...
         else if(_loc5_.definition.isAnimation)
         {
            ...
            if(_loc15_ != null)
            {
               ...
               if(_loc15_.type == AnimationLayerData.const_728)
               {
                  _loc6_ = _loc15_.action;
                  _loc4_ = _loc8_;
               }
               else if(_loc15_.type == AnimationLayerData.const_435)
               {
                  _loc4_ = _loc8_;
               }
               _loc7_ = true;
         ...
         if(_loc14_ == null)
         {
            ...
            _loc10_ = var_75.getParts(param1,(var_818 as AvatarImage).getFigure(),_loc6_,var_1289,_loc4_);
      ...
      private function renderBodyPart(param1:int, param2:Array, param3:int, param4:IActiveActionData) : AvatarImageBodyPartContainer
      {
         ...
         var _loc5_:AvatarCanvas = var_75.getCanvas(var_193,var_1289);
         if(_loc5_ == null)
         {
            return null;
         }
         ...
         while(_loc28_ >= 0)
         {
            ...
            if(AvatarDirectionAngle.const_1148[param1])
            {
            ...
            _loc10_ = var_193 + "_" + _loc18_.assetPartDefinition + "_" + _loc11_ + "_" + _loc12_ + "_" + _loc23_ + "_" + _loc13_;
            _loc16_ = _assets.getAssetByName(_loc10_) as BitmapDataAsset;
            if(_loc16_ == null)
            {
               _loc10_ = var_193 + "_std_" + _loc11_ + "_" + _loc12_ + "_" + _loc23_ + "_0";
               _loc16_ = _assets.getAssetByName(_loc10_) as BitmapDataAsset;
            }
            if(_loc16_ == null)
            {
            ...
            else
            {
               ...
               if((_loc32_ == AvatarAction.const_910 || _loc32_ == AvatarAction.const_620) && (_loc6_ == AvatarBodyPartType.const_322 || _loc6_ == AvatarBodyPartType.const_1109 || _loc6_ == AvatarBodyPartType.const_1281) && _loc7_.color != null)
               {
         ...
         if(_loc20_)
         {
            if(var_193 == AvatarScaleType.const_50)
            {
               _loc30_.x += 67;
            }
            else
      ...
      public function disposeInactiveActions(param1:int = 60000) : void
      {
         ...
         if(var_147 != null)
         {
            _loc2_ = var_147.getKeys();
            for each(_loc3_ in _loc2_)
            {
               _loc4_ = var_147.getValue(_loc3_) as AvatarImageBodyPartCache;
               if(_loc4_ != null)
               {
