package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1359:String = "ctlg_";
       
      
      private var _localization:IPageLocalization;
      
      protected var var_1307:XML;
      
      protected var _window:IWindowContainer;
      
      private var var_852:String;
      
      private var var_1274:EventDispatcher;
      
      private var _widgets:Array;
      
      private var _pageId:int;
      
      private var var_758:ICatalogViewer;
      ...
      {
         return _localization.hasLinks(var_852);
      }
      ...
      {
         var _loc2_:String = const_1359 + param1;
         ...
         var_1307 = _loc3_.content as XML;
         _window = viewer.catalog.windowManager.buildFromXML(var_1307) as IWindowContainer;
         if(_window == null)
         {
      ...
      private function createWidgets() : void
      {
         ...
         _loc1_ = _window.findChildByName(CatalogWidgetEnum.const_1163) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = var_1274;
            _loc2_.init();
         }
         var_1274.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      {
         return var_1274.dispatchEvent(param1);
      }
      ...
      {
         return _localization.getLinks(var_852);
      }
