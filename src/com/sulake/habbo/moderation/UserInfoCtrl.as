package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_756:int = 31536000;
      
      private static const const_757:int = 86400;
      
      private static const const_759:int = 3600;
      
      private static const const_758:int = 60;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         {
            return Math.round(param1 / const_758) + " mins ago";
         }
         ...
         {
            return Math.round(param1 / const_757) + " days ago";
         }
         return Math.round(param1 / const_756) + " years ago";
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_56.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(_data.userId),var_56,WindowTracker.const_886,_data.userId),_callerFrame,var_999,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_56.windowTracker.show(new ModActionCtrl(var_56,_data.userId,_data.userName,var_1109),_callerFrame,var_999,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_56.windowTracker.show(new RoomVisitsCtrl(var_56,_data.userId),_callerFrame,var_999,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_56.windowTracker.show(new SendMsgsCtrl(var_56,_data.userId,_data.userName,var_1109),_callerFrame,var_999,false,true);
      }
