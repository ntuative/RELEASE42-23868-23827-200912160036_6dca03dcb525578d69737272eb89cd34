package com.sulake.habbo.widget.chooser
{
   ...
   public class ChooserWidget extends RoomWidgetBase
   {
      ...
      private const const_1381:int = 1;
      
      private const const_1584:int = 0;
      ...
      private function onChooserContent(param1:RoomWidgetChooserContentEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChooserContentEvent.const_456:
               if(var_405 == null)
               {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetChooserContentEvent.const_456,onChooserContent);
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_642,onUpdateFurniChooser);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_225,onUpdateUserChooser);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_521,onUpdateUserChooser);
      ...
      private function onUpdateFurniChooser(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         var _loc2_:RoomWidgetRequestWidgetMessage = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_387);
      ...
      private function onUpdateUserChooser(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         var _loc2_:RoomWidgetRequestWidgetMessage = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_304);
         messageListener.processWidgetMessage(_loc2_);
      }
      ...
      override public function initialize(param1:int) : void
      {
         ...
         if(param1 == const_1381)
         {
            _loc2_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_304);
            messageListener.processWidgetMessage(_loc2_);
         }
      }
      ...
      {
         var _loc3_:RoomWidgetRoomObjectMessage = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_615,param1,param2);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetChooserContentEvent.const_456,onChooserContent);
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_642,onUpdateFurniChooser);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_225,onUpdateUserChooser);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_521,onUpdateUserChooser);
      }
   }
}
