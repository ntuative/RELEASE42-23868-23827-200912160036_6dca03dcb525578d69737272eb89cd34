package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      public function AchievementNotification(param1:String, param2:int, param3:IAssetLibrary, param4:IHabboWindowManager, param5:IHabboLocalizationManager, param6:IHabboConfigurationManager, param7:ISessionDataManager)
      {
         ...
         var_1583 = param2;
         var_560 = param7;
         param7.events.addEventListener(BadgeImageReadyEvent.const_102,onBadgeImageReady);
         ...
         var_1650 = param5.getKey("notifications.text.achievement_facebook");
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               if(false)
               {
                  ExternalInterface.call("FlashExternalInterface.postAchievement",var_607,var_1650);
               }
               dispose();
               break;
      ...
      private function registerBadgeParameters(param1:String) : void
      {
         ...
         _localizations.registerParameter(param1,"level",var_1583.toString());
         _localizations.registerParameter(param1,"name",var_560.userName);
         _localizations.registerParameter(param1,"realname",var_560.realName);
      }
   }
}
