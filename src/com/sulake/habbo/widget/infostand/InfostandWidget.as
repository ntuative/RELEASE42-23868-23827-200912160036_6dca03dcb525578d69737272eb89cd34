package com.sulake.habbo.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_1375:String = "infostand_user_view";
      
      private var var_289:InfoStandPetView;
      
      private var var_1265:InfoStandPetData;
      
      private var var_141:Timer;
      
      private var var_805:InfoStandFurniView;
      
      private var var_390:InfostandFurniData;
      
      private var var_338:InfoStandBotView;
      
      private var _mainContainer:IWindowContainer;
      
      private const const_1377:String = "infostand_bot_view";
      
      private var _config:IHabboConfigurationManager;
      
      private const const_1378:String = "infostand_pet_view";
      
      private const const_1376:String = "infostand_furni_view";
      
      private const const_1580:int = 3000;
      
      private var var_201:InfoStandUserView;
      
      private var var_380:InfostandUserData;
      ...
      public function InfostandWidget(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboLocalizationManager, param4:IHabboConfigurationManager)
      {
         ...
         _config = param4;
         var_805 = new InfoStandFurniView(this,const_1376);
         var_201 = new InfoStandUserView(this,const_1375);
         var_289 = new InfoStandPetView(this,const_1378);
         var_338 = new InfoStandBotView(this,const_1377);
         var_380 = new InfostandUserData();
         var_390 = new InfostandFurniData();
         var_1265 = new InfoStandPetData();
         var_141 = new Timer(const_1580);
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            var_201.setTags(param1.tags,var_1890);
         }
      }
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetFurniInfoUpdateEvent.const_511,onFurniInfo);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_468,var_289.getCurrentPetId()));
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetFurniInfoUpdateEvent.const_511,onFurniInfo);
      ...
      private function onFurniInfo(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         var_805.update(param1);
         selectView(const_1376);
         if(var_141)
         {
            var_141.stop();
         }
