package com.sulake.habbo.ui
{
   ...
   public class DesktopLayoutManager
   {
      ...
      private const const_1594:String = "room_widget";
      
      private const const_1598:String = "room_desktop_layout_container";
      
      private const const_1095:String = "room_view";
      
      private var var_693:int = 50;
      
      private var var_2241:XML = null;
      ...
      public function addRoomView(param1:IWindow) : Boolean
      {
         ...
         var _loc2_:IWindowContainer = var_68.getChildByTag(const_1095) as IWindowContainer;
         if(_loc2_ == null)
         {
            return false;
         }
      ...
      public function get roomViewRect() : Rectangle
      {
         ...
         var _loc1_:IWindowContainer = var_68.findChildByTag(const_1095) as IWindowContainer;
         if(_loc1_ != null)
         {
      ...
      public function set toolbarOrientation(param1:String) : void
      {
         ...
         switch(param1)
         {
            case "LEFT":
               _loc2_.x = var_693;
               _loc2_.width = var_68.desktop.width - var_693;
               _loc2_.y = 0;
            ...
            case "TOP":
               ...
               _loc2_.y = var_693;
               _loc2_.height = var_68.desktop.height - var_693;
               break;
            case "BOTTOM":
               _loc2_.x = 0;
               _loc2_.width = var_68.desktop.width;
      ...
      public function setLayout(param1:XML, param2:IHabboWindowManager) : void
      {
         ...
         while(_loc5_ < var_68.numChildren)
         {
            ...
            {
               _loc4_.addEventListener(WindowEvent.const_313,trimContainer);
            }
            _loc5_++;
         }
      }
      ...
      public function addWidgetWindow(param1:IWindow) : Boolean
      {
         ...
         {
            if(String(_loc2_[_loc4_]).indexOf(const_1594) == 0)
            {
