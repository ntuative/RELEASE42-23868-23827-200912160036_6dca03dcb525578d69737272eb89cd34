package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_1575:int = 500;
      ...
      private var var_1402:IncomingMessages;
      ...
      {
         return method_2.getEffects(1);
      }
      
      public function setEffectDeselected(param1:int) : void
      {
         var _loc2_:EffectsModel = method_2;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      override public function dispose() : void
      {
         ...
         var _loc4_:* = null;
         super.dispose();
         var _loc1_:Array = var_52.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = var_52.getValue(_loc3_) as IInventoryModel;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
         ...
         if(var_33 != null)
         {
            var_33.events.removeEventListener(RoomSessionEvent.const_83,roomSessionEventHandler);
            var_33.events.removeEventListener(RoomSessionEvent.const_91,roomSessionEventHandler);
            var_33.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_464,roomSessionEventHandler);
      ...
      {
         return RecyclerModel(var_52.getValue(InventorySubCategory.RECYCLER));
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_91:
               _roomSession = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_464:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      public function get method_2() : EffectsModel
      {
         return EffectsModel(var_52.getValue(InventoryCategory.const_544));
      }
      
      public function get furniModel() : FurniModel
      {
         return FurniModel(var_52.getValue(InventoryCategory.const_68));
      }
      ...
      {
         var_190.clubPeriods = param1;
         var_190.clubDays = param2;
         var_190.clubHasEverBeenMember = param3;
      ...
      {
         return PetsModel(var_52.getValue(InventoryCategory.const_166));
      }
      
      public function getCategoryWindowContainer(param1:String) : IWindowContainer
      {
         var _loc2_:IInventoryModel = IInventoryModel(var_52.getValue(param1));
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      {
         var _loc2_:IInventoryModel = var_52.getValue(param1) as IInventoryModel;
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1575);
         }
      }
      
      public function get achievementsModel() : AchievementsModel
      {
         return AchievementsModel(var_52.getValue(InventoryCategory.const_279));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_774.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_774.splice(_loc3_,1);
            }
         }
      }
      ...
      public function closingInventoryView() : void
      {
         ...
         {
            _loc2_ = var_52.getWithIndex(_loc1_) as IInventoryModel;
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < var_52.length)
         {
            _loc3_ = var_52.getWithIndex(_loc2_) as IInventoryModel;
            _loc3_.subCategorySwitch(param1);
            _loc2_++;
         }
         switch(param1)
         {
            case InventorySubCategory.const_234:
      ...
      {
         return TradingModel(var_52.getValue(InventorySubCategory.const_234));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_560 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_774.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      {
         return var_190.creditBalance;
      }
      
      public function get marketplaceModel() : MarketplaceModel
      {
         return var_52.getValue(InventoryCategory.const_444) as MarketplaceModel;
      }
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1402 = new IncomingMessages(this);
         queueInterface(new IIDHabboWindowManager(),onWindowManagerReady);
      }
      
      public function deselectAllEffects() : void
      {
         var _loc1_:EffectsModel = method_2;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      {
         return var_190.clubHasEverBeenMember;
      }
      
      public function get clubPastPeriods() : int
      {
         return var_190.clubPastPeriods;
      }
      
      public function getAvatarEffects() : Array
      {
         return method_2.getEffects();
      }
      ...
      {
         return BadgesModel(var_52.getValue(InventoryCategory.const_269));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_33.events.addEventListener(RoomSessionEvent.const_83,roomSessionEventHandler);
         var_33.events.addEventListener(RoomSessionEvent.const_91,roomSessionEventHandler);
         var_33.events.addEventListener(RoomSessionPropertyUpdateEvent.const_464,roomSessionEventHandler);
         ...
         var_52.add(InventoryCategory.const_444,_loc3_);
         ...
         var_52.add(InventoryCategory.const_68,_loc4_);
         var _loc5_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_560);
         var_52.add(InventoryCategory.const_269,_loc5_);
         var _loc6_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_52.add(InventoryCategory.const_544,_loc6_);
         var _loc7_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_560);
         var_52.add(InventoryCategory.const_279,_loc7_);
         var _loc8_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_52.add(InventorySubCategory.const_234,_loc8_);
         var _loc9_:RecyclerModel = new RecyclerModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_52.add(InventorySubCategory.RECYCLER,_loc9_);
         ...
         var_52.add(InventoryCategory.const_166,_loc10_);
