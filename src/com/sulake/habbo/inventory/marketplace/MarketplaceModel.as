package com.sulake.habbo.inventory.marketplace
{
   ...
   public class MarketplaceModel implements IInventoryModel
   {
      ...
      public function makeOffer(param1:int) : void
      {
         ...
         var _loc3_:int = var_224 is FloorItem ? 1 : 2;
         _loc2_.send(new MakeOfferMessageComposer(param1,_loc3_,var_224.ref));
         releaseItem();
      }
      ...
      public function proceedOfferMaking(param1:int, param2:int) : void
      {
         switch(param1)
         {
            ...
            case 3:
               ...
               break;
            case 4:
               _view.showBuyTokens(var_958,var_1413);
         }
      }
      ...
      {
         if(_controller != null && false && var_224 != null)
         {
            _controller.furniModel.removeLockFrom(var_224.id);
            var_224 = null;
         }
      }
      ...
      public function startOfferMaking(param1:IItem) : void
      {
         ...
         if(_controller.creditBalance < var_958)
         {
            _view.showNoCredits(var_958);
            return;
         }
         var _loc2_:IConnection = _communication.getHabboMainConnection(null);
         if(_loc2_ == null)
