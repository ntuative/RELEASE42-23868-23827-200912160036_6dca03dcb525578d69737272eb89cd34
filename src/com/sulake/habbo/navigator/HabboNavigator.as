package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2288:Dictionary;
      ...
      private var var_2070:ISessionDataManager;
      
      private var var_2069:RoomCreateViewCtrl;
      
      private var var_1684:RoomThumbnailRenderer;
      
      private var var_205:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_1258:RoomInfoViewCtrl;
      
      private var var_70:IHabboCatalog;
      
      private var var_415:Tabs;
      
      private var var_481:MainViewCtrl;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_481 = new MainViewCtrl(this);
         var_1258 = new RoomInfoViewCtrl(this);
         var_2069 = new RoomCreateViewCtrl(this);
         var_1684 = new RoomThumbnailRenderer(this);
         var_1003 = new GuestRoomPasswordInput(this);
         var_325 = new GuestRoomDoorbell(this);
         var_415 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_481.startSearch(Tabs.const_184,Tabs.const_319,param1);
         var_481.mainWindow.activate();
      }
      ...
      {
         if(param1 != null && var_205 != null)
         {
            var_205.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_46,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var _loc3_:String = var_173.getKey("navigator.default_tab");
         switch(_loc3_)
         {
            case "popular":
               _loc4_ = 0;
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_205 != null)
         {
            var_205.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_125,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_205.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_125,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_2070 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_481.startSearch(Tabs.const_244,Tabs.const_201);
         var_415.getTab(Tabs.const_244).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_481.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
