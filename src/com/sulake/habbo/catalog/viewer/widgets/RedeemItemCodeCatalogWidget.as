package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_978:IButtonWindow;
      
      private var var_977:ITextFieldWindow;
      ...
      override public function dispose() : void
      {
         ...
         if(var_978 != null)
         {
            var_978.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_977 != null)
         {
            var_977.removeEventListener(WindowKeyboardEvent.const_128,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_978 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_978 != null)
         {
            var_978.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_977 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_977 != null)
         {
            var_977.addEventListener(WindowKeyboardEvent.const_128,windowKeyEventProcessor);
         }
      }
