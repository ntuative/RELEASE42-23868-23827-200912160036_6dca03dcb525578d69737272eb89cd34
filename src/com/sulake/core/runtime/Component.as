package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_1466:uint = 1;
      
      public static const COMPONENT_EVENT_DEBUG:String = "COMPONENT_EVENT_DEBUG";
      
      public static const const_926:uint = 4;
      ...
      protected var var_385:uint = 0;
      
      protected var _context:IContext = null;
      
      protected var var_1843:Boolean = false;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            var_866 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_866);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1040 & const_926)
         {
            if(_loc3_ == 0)
            {
      ...
      {
         return "[component " + getQualifiedClassName(this) + " refs: " + var_385 + "]";
      }
   }
}
