package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_344:IScrollbarWindow;
      
      private var var_1469:Boolean = true;
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_344)
         {
            var_344 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(var_344)
            {
               var_344.addEventListener(WindowEvent.const_242,scrollBarEventProc);
               var_344.addEventListener(WindowEvent.const_194,scrollBarEventProc);
            }
         }
         return var_344;
      }
      ...
      override public function dispose() : void
      {
         if(var_344)
         {
            var_344.removeEventListener(WindowEvent.const_242,scrollBarEventProc);
            var_344.removeEventListener(WindowEvent.const_194,scrollBarEventProc);
            var_344 = null;
         }
         if(_cachedItemList)
         {
      ...
      {
         if(param1.type == WindowEvent.const_242)
         {
            showScrollBar();
         }
