   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_130,onUserTags);
               _container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_102,onBadgeImage);
            }
            if(false)
            {
         ...
         if(false)
         {
            _container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_130,onUserTags);
            _container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_102,onBadgeImage);
         }
         if(false)
         {
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_511);
               _loc6_.id = param1.id;
               ...
               {
                  _loc20_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_327);
            ...
            case RoomObjectCategoryEnum.const_36:
               ...
               if(_loc9_.type == RoomObjectTypeEnum.const_329)
               {
                  _container.roomSession.userDataManager.requestPetInfo(_loc9_.webID);
                  return null;
               }
               if(_loc9_.type == RoomObjectTypeEnum.const_419)
               {
                  _loc10_ = "null";
               ...
               {
                  if(_loc9_.type != RoomObjectTypeEnum.const_942)
                  {
                     return null;
                  }
                  _loc10_ = "null";
               ...
               if(_loc14_ != null)
               {
                  _loc11_.carryItem = _loc14_.getModel().getNumber(RoomObjectVariableEnum.const_623);
               }
               if(_loc10_ == RoomWidgetUserInfoUpdateEvent.const_188)
               {
               ...
               if(_loc10_ == RoomWidgetUserInfoUpdateEvent.const_199)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     _loc28_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_666);
                  ...
                  _loc11_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1113;
                  if(!_loc23_)
                  {
                  ...
                  if(!_loc24_)
                  {
                     _loc11_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_891;
                  }
                  if(!_loc25_)
                  {
                     _loc11_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_980;
                  }
               ...
               if(_loc10_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc12_.push(RoomWidgetUserInfoUpdateEvent.const_1135);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_501.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImage(_loc4_,AvatarScaleType.const_50);
            var_501.add(_loc2_.petId,_loc5_);
         }
         ...
         if(_container != null && false)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_666);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_299);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_641);
         _loc1_.push(RoomWidgetUserActionMessage.const_551);
         _loc1_.push(RoomWidgetFurniActionMessage.const_254);
         _loc1_.push(RoomWidgetFurniActionMessage.const_664);
         _loc1_.push(RoomWidgetFurniActionMessage.const_575);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_555);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_680);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1107);
         _loc1_.push(RoomWidgetPetCommandMessage.const_548);
         _loc1_.push(RoomWidgetPetCommandMessage.const_724);
         _loc1_.push(RoomWidgetUserActionMessage.const_569);
      ...
      public function dispose() : void
      {
         ...
         if(var_501 != null)
         {
            _loc1_ = var_501.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_501.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.type == RoomWidgetUserActionMessage.const_368)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_299:
            ...
            case RoomWidgetUserActionMessage.const_679:
               ...
               break;
            case RoomWidgetUserActionMessage.const_569:
            ...
            case RoomWidgetUserActionMessage.const_499:
               ...
               break;
            case RoomWidgetUserActionMessage.const_641:
            ...
            case RoomWidgetUserActionMessage.const_613:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_664:
            ...
            case RoomWidgetFurniActionMessage.const_254:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_575:
            ...
            case RoomWidgetUserActionMessage.const_468:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_555:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_680:
