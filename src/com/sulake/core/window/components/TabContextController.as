package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1094:String = "content";
      
      private static const const_1093:String = "selector";
      ...
      public function get container() : IWindowContainer
      {
         if(var_1525 == null)
         {
            var_1525 = findChildByTag(TabContextController.const_1094) as IWindowContainer;
         }
         return var_1525;
      }
      ...
      public function get selector() : ITabSelectorWindow
      {
         if(var_875 == null)
         {
            var_875 = findChildByTag(TabContextController.const_1093) as ITabSelectorWindow;
            if(var_875 != null)
            {
      ...
      public function method_14(param1:uint) : ITabButtonWindow
      {
