package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private var var_1265:PetData;
      
      private var _window:IWindowContainer;
      
      private var var_931:PetsView;
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_54:
               var_931.setSelectedGridItem(this);
               var_760 = true;
               break;
            ...
            case WindowMouseEvent.const_28:
               ...
               {
                  var_760 = false;
                  var_931.placePetToRoom(var_1265.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         _window.color = !!_isSelected ? uint(const_1573) : uint(const_1574);
      }
