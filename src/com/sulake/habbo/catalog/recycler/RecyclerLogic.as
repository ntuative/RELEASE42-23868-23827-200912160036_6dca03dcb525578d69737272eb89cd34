package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_745:int = 0;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1444)
         {
            case RecyclerStatusMessageEvent.const_1149:
               var_264 = const_335;
               if(_view == null)
               {
                  return;
               ...
               break;
            case RecyclerStatusMessageEvent.const_994:
               if(_view == null)
               {
                  return;
               }
               ...
               break;
            case RecyclerStatusMessageEvent.const_1114:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1444 != RecyclerStatusMessageEvent.const_994;
      }
      
      private function get statusActive() : Boolean
      {
         return var_264 != const_745;
      }
      ...
      {
         return active && var_264 == const_335;
      }
      ...
      public function placeObjectAtSlot(param1:int, param2:int, param3:int, param4:int, param5:String) : void
      {
         ...
         var itemId:int = var_70.requestInventoryFurniToRecycler();
         if(itemId == 0)
         {
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_856:
               if(_view != null)
               {
                  _view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1258:
      ...
      public function releaseSlot(param1:int) : void
      {
         ...
         if(!var_70.returnInventoryFurniFromRecycler(var_101[param1].id))
         {
            return;
         }
         var_101[param1] = null;
