package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_182:HabboHotelView;
      ...
      private var var_2153:PseudoRandom;
      
      private var _windowManager:IHabboWindowManager;
      
      private var _habboConfiguration:IHabboConfigurationManager;
      
      private var var_1511:ILogger;
      
      private var var_1286:String;
      
      private var var_2154:String;
      
      private const const_1382:String = "fuselogin";
      
      private var var_592:ICoreCommunicationManager;
      
      private var var_491:IKeyExchange;
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_286:
               ...
               break;
            case DisconnectReasonEvent.const_902:
               _loc3_ = _habboConfiguration.getKey("logout.concurrent.url");
               break;
            case DisconnectReasonEvent.const_887:
               _loc3_ = _habboConfiguration.getKey("logout.url");
               break;
            case DisconnectReasonEvent.const_881:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_2155)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_699 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_699);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1286,var_2154));
         var _loc2_:String = "";
         var _loc3_:SharedObject = SharedObject.getLocal(const_1382,"/");
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var_491.generateSharedKey(_loc4_,10);
         var _loc5_:String = var_491.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,var_2153);
      ...
      private function onUniqueMachineId(param1:UniqueMachineIDEvent) : void
      {
         ...
         var _loc2_:SharedObject = SharedObject.getLocal(const_1382,"/");
      ...
      {
         var_699 = _habboConfiguration.getKey("sso.ticket",null);
         var_1286 = _habboConfiguration.getKey("flash.client.url","");
         var_2154 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_182 == null)
         {
            var_182 = new HabboHotelView(_windowManager,assets,Component(context).events);
         }
         if(var_699 != null)
         {
            var_80.mode = HabboConnectionType.const_469;
            var_80.initConnection(HabboConnectionType.const_228);
         }
      }
      
      private function receiveLoggerInterface(param1:IID, param2:IUnknown) : void
      {
         var_1511 = param2 as ILogger;
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_720);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         var_2153 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(var_80.mode)
         {
            case HabboConnectionType.const_469:
               _loc6_ = "";
               ...
               var_1028 = _loc4_;
               var_182.loadBannerImage(_loc7_ + "?token=" + var_1028,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1287:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1230:
               var_1027 = generateRandomHexString(30);
               var_491 = new DiffieHellman(new BigInteger(_habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(_habboConfiguration.getKey("connection.development.generator"),16));
               var_491.init(var_1027);
               _loc8_ = var_491.getPublicKey(10);
      ...
      private function onConfigurationLoaded(param1:Event = null) : void
      {
         ...
         {
            var_182.loadHotelViewImage(_loc3_ + _loc2_);
         }
      }
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_1028);
         ...
         var_491 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 100;
         while(_loc12_.length < 64)
         {
            var_1027 = generateRandomHexString(30);
            var_491.init(var_1027);
            _loc12_ = var_491.getPublicKey(10);
            _loc13_--;
            if(_loc13_ == 0)
            {
            }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            Component(_habboConfiguration).events.addEventListener(HabboConfigurationEvent.const_12,onConfigurationLoaded);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_33.events.addEventListener(RoomSessionEvent.const_91,onRoomSessionEnded);
      }
