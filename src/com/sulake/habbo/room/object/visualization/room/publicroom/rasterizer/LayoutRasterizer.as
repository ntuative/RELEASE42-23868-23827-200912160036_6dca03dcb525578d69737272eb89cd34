package com.sulake.habbo.room.object.visualization.room.publicroom.rasterizer
{
   ...
   public class LayoutRasterizer
   {
      ...
      private var var_1025:Point = null;
      
      private var var_485:Array;
      
      private var var_1023:LayoutRasterizerData = null;
      ...
      {
         var_487 = true;
         var _loc3_:int = var_350.indexOf(param1);
         if(_loc3_ < 0)
         {
            var_350.push(param1);
            var_486.push(param2);
      ...
      public function initializeAds(param1:int, param2:IRoomObjectSpriteVisualization) : void
      {
         ...
         var _loc11_:* = null;
         var_1024 = param1;
         var _loc3_:LayoutRasterizerData = var_67.getValue(var_696);
         if(_loc3_ == null)
         {
            return;
         }
                  ...
                  if(_loc9_ != null)
                  {
                     if(_loc7_.@id.toString().length > 0)
                     {
                        ...
                        if(_loc10_ == "billboard_bg")
                        {
                           ...
                           {
                              var_1283 = RoomObjectVariableEnum.const_824;
                           }
                           if(_loc11_.indexOf("right") > -1)
                           {
                              var_1283 = RoomObjectVariableEnum.const_807;
                           }
                           if(param2 != null)
                           {
      ...
      public function showAd(param1:IRoomObjectSpriteVisualization, param2:String = "", param3:Boolean = false) : void
      {
         ...
         {
            exchangeElementGraphics("billboard_img",var_1283);
         }
         ...
         if(param3)
         {
            ...
            _loc5_.tag = RoomObjectVariableEnum.const_347;
         }
         if(param2 != "")
         {
            _loc4_.visible = true;
      ...
      public function initializeGeometry(param1:IRoomGeometry) : void
      {
         ...
         var _loc3_:Point = param1.getScreenPoint(var_2141);
         _loc3_.x -= _loc2_.x;
         _loc3_.y -= _loc2_.y;
      ...
      public function set layout(param1:String) : void
      {
         if(param1 != var_696)
         {
            ...
            _adBgIndex = -1;
            _adImgIndex = -1;
            var_1023 = var_67.getValue(var_696);
         }
      }
      ...
      {
         var _loc1_:LayoutRasterizerData = var_67.getValue(var_696);
         if(_loc1_ == null)
         {
            return 0;
         }
      ...
      public function setElementToSprite(param1:int, param2:IRoomObjectSprite, param3:String = "", param4:Boolean = false) : void
      {
         ...
         var _loc5_:XMLList = var_1023.elementList;
         if(_loc5_ == null)
         {
            return;
         }
         ...
         param2.offsetX = int(_loc8_.@x) + _loc9_.offsetX + var_1025.x;
         param2.offsetY = int(_loc8_.@y) + _loc9_.offsetY + var_1025.y;
         ...
         if(_loc6_.@id.toString().length > 0)
         {
            ...
            if(var_350.indexOf(_loc10_) >= 0 && var_487)
            {
               param1 = var_350.indexOf(_loc10_);
               if(true)
               {
                  _loc9_ = _assetCollection.getAsset(var_486[param1]);
                  if(_loc9_ != null)
                  {
                     param2.asset = _loc9_.asset;
                  }
