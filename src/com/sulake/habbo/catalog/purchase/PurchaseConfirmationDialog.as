package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog
   {
      ...
      private var var_145:IItemListWindow;
      ...
      private var var_570:ITextWindow;
         ...
         switch(_loc2_)
         {
            case "button_ok":
               if(var_569)
               {
                  ...
                  HabboCatalog(var_70).purchaseProduct(var_680,var_176,var_1017,true,_loc5_,_loc6_);
               }
               else
               {
                  HabboCatalog(var_70).purchaseProduct(var_680,var_176,var_1017);
               }
               dispose();
               break;
            case "button_cancel":
      ...
      private function showDialog() : void
      {
         ...
         if(_window == null)
         {
            _window = var_70.windowManager.createWindow("OrderInfo","${catalog.purchase.confirmation.dialog.title}",HabboWindowType.const_300,HabboWindowStyle.const_40,0 | 0 | 0,new Rectangle(10,10,300,180),null) as IFrameWindow;
         }
         else
         {
         ...
         if(_loc4_)
         {
            ...
            _loc17_.addEventListener(WindowEvent.const_670,onDeActivateGift);
            _loc17_.addEventListener(WindowEvent.const_540,onActivateGift);
         ...
         var _loc11_:IProductData = var_70.getProductData(var_176.localizationId);
      ...
      private function updateSuggestions(param1:Array, param2:IWindow) : void
      {
         ...
         if(var_145 == null)
         {
            ...
            var_145 = var_70.windowManager.buildFromXML(_loc5_.content as XML) as IItemListWindow;
            if(var_145 != null)
            {
               var_570 = var_145.getListItemAt(0) as ITextWindow;
               var_570.procedure = suggestionsEventHandler;
            }
         }
         if(var_145 == null || var_570 == null)
         {
            return;
         }
         var_145.removeListItems();
         ...
         {
            _loc6_ = var_570.clone() as ITextWindow;
            if(_loc6_ != null)
            {
               _loc6_.text = _loc3_;
               var_145.addListItem(_loc6_);
            }
         }
         _loc4_ = new Rectangle();
         param2.getGlobalRectangle(_loc4_);
         var_145.setGlobalPosition(new Point(_loc4_.left,_loc4_.bottom + 10));
      }
   }
}
