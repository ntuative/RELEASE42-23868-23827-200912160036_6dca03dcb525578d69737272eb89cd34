package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCellMatrix
   {
      ...
      public static const const_1319:int = const_328;
      
      public static const const_190:int = 2;
      
      public static const const_210:int = 3;
      ...
      public static const const_200:int = 4;
      
      public static const const_671:int = 6;
      
      public static const const_241:int = const_97;
      ...
      private var var_1271:Boolean = true;
      
      private var var_39:BitmapData;
      
      private var var_1808:Number = -1;
      
      private var var_1807:Number = -1;
      ...
      public function PlaneMaterialCellMatrix(param1:int, param2:int = 1, param3:int = 1, param4:Number = -1, param5:Number = 1, param6:Number = -1, param7:Number = 1)
      {
         ...
         var_1807 = param6;
         var_1809 = param7;
         var_730 = new Vector3d();
         if(var_1332 == const_671)
         {
            var_1271 = false;
         }
      }
      ...
      private function copyCachedBitmapOnCanvas(param1:BitmapData, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         var _loc5_:* = null;
         if(var_1503 == const_97)
         {
            _loc5_ = new Rectangle(0,0,var_39.width,var_482);
         }
         else
         {
            _loc5_ = new Rectangle(0,0 - var_482,var_39.width,var_482);
         }
      ...
      public function render(param1:BitmapData, param2:int, param3:int, param4:IVector3d, param5:Boolean, param6:int, param7:Boolean) : BitmapData
      {
         ...
         if(isStatic)
         {
            if(var_39 != null)
            {
               if(var_39.width == param2 && var_39.height == param3 && Vector3d.isEqual(var_730,param4))
               {
                  if(param1 != null)
                  {
                     copyCachedBitmapOnCanvas(param1,var_482,param6,param7);
                     return param1;
                  }
                  return var_39;
               }
