   ...
   public class HabboNotificationViewManager implements ICoreUpdateReceiver
   {
      ...
      private function getNextAvailableVerticalPosition() : int
      {
         ...
         while(_loc2_ < var_233.length)
         {
            ...
            if(_loc1_ + HabboNotificationItemView.const_636 < _loc3_.verticalPosition)
            {
               return _loc1_;
            }
            _loc1_ = _loc3_.verticalPosition + HabboNotificationItemView.const_636 + const_488;
            _loc2_++;
         }
         return _loc1_;
      }
      ...
      public function showItem(param1:HabboNotificationItem) : void
      {
         ...
         var _loc2_:HabboNotificationItemView = new HabboNotificationItemView(_assetLibrary.getAssetByName("layout_notification_xml"),_windowManager,var_2008,var_404,var_205);
      ...
      {
         return getNextAvailableVerticalPosition() + HabboNotificationItemView.const_636 < 540;
      }
   }
}
