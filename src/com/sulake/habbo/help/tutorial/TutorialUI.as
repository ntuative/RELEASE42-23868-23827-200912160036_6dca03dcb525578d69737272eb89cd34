package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI
   {
      ...
      public static const const_250:String = "TUI_NAME_VIEW";
      
      public static const const_78:String = "TUI_MAIN_VIEW";
      
      public static const const_306:String = "TUI_CLOTHES_VIEW";
      
      public static const const_417:String = "TUI_GUIDEBOT_VIEW";
      ...
      public function TutorialUI(param1:HabboHelp)
      {
         super();
         var_56 = param1;
         var_56.events.addEventListener(HabboHelpTutorialEvent.const_723,onTaskDoneEvent);
         var_56.events.addEventListener(HabboHelpTutorialEvent.const_673,onTaskDoneEvent);
         var_56.events.addEventListener(HabboHelpTutorialEvent.const_513,onTaskDoneEvent);
      }
      ...
      public function prepareForTutorial() : void
      {
         ...
         var_56.hideUI();
         var_56.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_101));
      }
      ...
      public function update(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         ...
         var_903 = param2;
         var_904 = param3;
         if(var_41 == null || var_41.id == const_78)
         {
            prepareForTutorial();
            showView(const_78);
         }
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         var_903 = true;
         if(var_41 != null && (var_41.id == const_250 || var_41.id == const_78))
         {
            showView(const_78);
         }
      ...
      public function showView(param1:String) : void
      {
         ...
         _window.height = _loc2_.height + var_1400;
         _window.width = _loc2_.width + var_1399;
         if(_loc3_)
         {
            if(_window == null)
            {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_723:
               var_904 = true;
               if(var_41 != null && var_41.id == const_417)
               {
                  showView(const_78);
               }
               break;
            case HabboHelpTutorialEvent.const_673:
               if(var_41 != null && var_41.id == const_306)
               {
                  var_1098 = true;
                  disposeWindow();
               }
               break;
            case HabboHelpTutorialEvent.const_513:
               if(var_1098)
               {
                  var_1098 = false;
                  showView(const_78);
      ...
      {
         var_905 = true;
         if(var_41 != null && (var_41.id == const_306 || var_41.id == const_78))
         {
            showView(const_78);
         }
      }
      ...
      {
         return var_905 && var_903 && var_904;
      }
   }
}
