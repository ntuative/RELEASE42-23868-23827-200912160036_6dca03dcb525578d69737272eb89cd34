package com.sulake.habbo.avatar.common
{
   public class CategoryData
   {
      ...
      public function get currentColour() : AvatarEditorColorItem
      {
         if(var_670 > -1)
         {
            return var_342[var_670] as AvatarEditorColorItem;
         }
         return null;
      }
      ...
      public function selectColour(param1:int) : AvatarEditorColorItem
      {
         ...
         if(var_670 >= 0)
         {
            _loc3_ = var_342[var_670];
            _loc3_.isSelected = false;
         }
         if(var_342.length > param1)
         {
            _loc2_ = var_342[param1] as AvatarEditorColorItem;
            _loc2_.isSelected = true;
         }
         var_670 = param1;
