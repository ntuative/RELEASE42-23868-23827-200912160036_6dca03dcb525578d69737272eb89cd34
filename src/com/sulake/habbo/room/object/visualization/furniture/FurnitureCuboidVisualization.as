package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureCuboidVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected function updatePlanes(param1:IRoomGeometry) : void
      {
         ...
         while(_loc4_ < var_110.length)
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc5_)
               {
                  _loc9_.assetName = _loc6_ + "_" + _loc2_.getInstanceId() + "_" + var_1422;
               }
      ...
      protected function initializePlanes() : void
      {
         ...
         var _loc3_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_310);
         var _loc4_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_411);
         var _loc5_:Number = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_668);
