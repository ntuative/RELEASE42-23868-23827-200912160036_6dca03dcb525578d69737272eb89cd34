package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      private var var_1853:IWindowContainer;
      ...
      {
         setEnabled(_bgTabButton,this.var_91.mode != ThumbnailEditorModel.const_35);
         setEnabled(var_1414,this.var_91.mode != ThumbnailEditorModel.const_51);
         setEnabled(var_1415,this.var_91.mode != ThumbnailEditorModel.const_31);
      }
      ...
      private function onBgTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_91.mode = ThumbnailEditorModel.const_35;
         this.reload();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1414 = IButtonWindow(find("top_tab"));
         var_1415 = IButtonWindow(find("obj_tab"));
         var_1853 = IWindowContainer(find("tile_grid"));
         var_1854 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1414,onTopTabButton);
         Util.setProcDirectly(var_1415,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_1853;
         _loc1_.visible = true;
         if(_loc1_.numChildren == 0)
         {
            while(_loc3_ <= RoomThumbnailRenderer.const_388)
            {
      ...
      {
         var _loc1_:IWindowContainer = var_1854;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_53,HabboWindowStyle.const_39,HabboWindowParam.const_67,new Rectangle(0,0,param1.width,66)));
