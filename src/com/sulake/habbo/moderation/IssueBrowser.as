package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private var var_1344:IIssueBrowserView;
      
      private const const_1570:String = "open_issues";
      
      private var _window:IFrameWindow;
      
      private const const_1571:String = "picked_issues";
      
      private var _assets:IAssetLibrary;
      
      private var var_1345:IIssueBrowserView;
      
      private const const_1596:String = "closed_issues";
      
      private var _issueManager:IssueManager;
      
      private const const_1569:String = "my_issues";
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_211:ITabContextWindow;
      
      private var var_1343:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         var_324.view.width = var_211.container.width;
         var_324.view.height = var_211.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case const_1569:
               if(var_1345 == null)
               {
                  var_1345 = new MyIssuesView(issueManager,this,var_211.container);
               }
               return var_1345;
            case const_1570:
               if(var_1344 == null)
               {
                  var_1344 = new OpenIssuesView(issueManager,this,var_211.container);
               }
               return var_1344;
            case const_1571:
               if(var_1343 == null)
               {
                  var_1343 = new PickedIssuesView(issueManager,this,var_211.container);
               }
               return var_1343;
            default:
               return null;
