package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow
   {
      ...
      private static const const_1092:String = "increment";
      
      private static const const_489:String = "slider_bar";
      
      private static const const_1091:String = "decrement";
      
      private static const const_765:String = "slider_track";
      ...
      protected var var_1524:Number = 0.1;
      ...
      public function ScrollbarController(param1:String, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:IWindow, param9:Function, param10:Array = null, param11:Array = null, param12:uint = 0, param13:IScrollableWindow = null)
      {
         ...
         var_35 = param13;
         _horizontal = param3 == WindowType.const_356;
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.name)
            {
               case ScrollbarController.const_489:
                  if(param2.type == WindowNotifyEvent.const_235)
                  {
                     if(!var_573)
                     {
                        if(_horizontal)
      ...
      {
         return getChildByName(ScrollbarController.const_765) as WindowController;
      }
      ...
      {
         return track.getChildByName(ScrollbarController.const_489) as WindowController;
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               var_851 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         if(var_851 != null)
         {
            _loc1_ = findParentByName(var_851) as IScrollableWindow;
            if(_loc1_ == null && var_23 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_23).findChildByName(var_851) as IScrollableWindow;
               if(_loc1_)
               {
                  scrollable = _loc1_;
                  return true;
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(param2.name == ScrollbarController.const_1092)
            {
               if(var_35)
               {
                  var_573 = true;
            ...
            else if(param2.name == ScrollbarController.const_1091)
            {
               if(var_35)
               {
                  var_573 = true;
            ...
            else if(param2.name == ScrollbarController.const_765)
            {
               _loc4_ = new Point();
               ...
               _loc5_ = WindowController(param2).getChildByName(ScrollbarController.const_489).rectangle;
               if(_horizontal)
               {
         ...
         if(param1.type == WindowMouseEvent.const_967)
         {
