package com.sulake.habbo.room.object.visualization.furniture.data
{
   ...
   public class SizeData
   {
      ...
      public static const const_282:int = 1000;
      ...
      private var var_1189:int = 360;
      
      private var var_1895:int = 0;
      
      private var var_654:DirectionData = null;
      ...
      public function getDirectionValue(param1:int) : int
      {
         var _loc6_:int = 0;
         var _loc7_:int = 0;
         var _loc2_:int = (param1 % 360 + 360 + var_1189 / 2) % 360 / var_1189;
         ...
         {
            _loc6_ = int(var_223.getKey(_loc5_)) * var_1189;
      ...
      private function defineDirection(param1:DirectionData, param2:XMLList) : Boolean
      {
         ...
         {
            param1.method_16(_loc7_,int(_loc4_));
         ...
         },_loc5_++)
         {
            ...
            {
               case "ADD":
                  param1.setInk(_loc7_,LayerData.const_992);
                  break;
               case "SUBTRACT":
                  param1.setInk(_loc7_,LayerData.const_812);
                  break;
               case "DARKEN":
