package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendRequests
   {
      ...
      public function acceptFailed(param1:String) : void
      {
         ...
         _loc2_.state = FriendRequest.const_806;
         var_360.view.refreshRequestEntry(_loc2_);
      }
      ...
      public function refreshShading() : void
      {
         ...
         {
            _loc1_ = !_loc1_;
            var_360.view.refreshShading(_loc2_,_loc1_);
         }
      }
      ...
      {
         var_468.push(param1);
         var_360.view.addRequest(param1);
      }
      ...
      public function clearAndUpdateView(param1:Boolean) : void
      {
         ...
         for each(_loc4_ in _loc2_)
         {
            ...
            if(false)
            {
               var_360.view.removeRequest(_loc4_);
            }
            _loc4_.dispose();
         }
         refreshShading();
