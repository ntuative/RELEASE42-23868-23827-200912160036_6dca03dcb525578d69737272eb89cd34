   ...
   public class FurniturePlane
   {
      ...
      public function setRotation(param1:Boolean) : void
      {
         if(param1 != var_1790)
         {
            if(!param1)
            {
               var_255.assign(var_538);
               var_256.assign(var_537);
            }
            else
            {
               var_255.assign(var_538);
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc9_:* = null;
         if(param1 == null || var_76 == null && var_632 != null || var_255 == null || var_256 == null || var_376 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != var_1147)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != var_942 || _loc4_.y != var_1771 || _loc4_.z != var_1773 || param1.scale != var_1768))
            {
               ...
               _loc6_ = param1.getScreenPosition(var_632);
               _loc7_ = _loc6_.z;
