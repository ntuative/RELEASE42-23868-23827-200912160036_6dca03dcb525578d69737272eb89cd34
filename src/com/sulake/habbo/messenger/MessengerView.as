package com.sulake.habbo.messenger
{
   ...
   public class MessengerView
   {
      ...
      private var var_1068:ConversationView;
      
      private var var_28:IFrameWindow;
      
      private var var_723:ConversationsTabView;
      
      private var var_430:Timer;
      
      private var var_130:HabboMessenger;
      
      private var var_598:ITextFieldWindow;
      ...
      public function addMsgToView(param1:Conversation, param2:Message) : void
      {
         ...
         var_1068.addMessage(param2);
      }
      
      private function onResizeTimer(param1:TimerEvent) : void
      {
         Logger.log("XXX RESIZE XXX");
         this.var_1068.afterResize();
         this.var_723.refresh();
      }
      ...
      private function onMessageInput(param1:Event) : void
      {
         ...
         else
         {
            ...
            {
               var_598.text = _loc5_.substring(0,_loc4_);
            }
         }
      }
      ...
      {
         return this.var_723 == null ? 7 : int(this.var_723.getTabCount());
      }
      ...
      private function sendMsg() : void
      {
         ...
         var_598.text = "";
         var_130.conversations.addMessageAndUpdateView(new Message(Message.const_629,_loc2_.id,_loc1_,Util.getFormattedNow()));
      }
      ...
      private function prepareContent() : void
      {
         ...
         var_723 = new ConversationsTabView(var_130,var_28);
         var_723.refresh();
         var_598 = ITextFieldWindow(var_28.findChildByName("message_input"));
         var_598.addEventListener(WindowKeyboardEvent.const_128,onMessageInput);
         var_1068 = new ConversationView(var_130,var_28);
         var_28.scaler.setParamFlag(HabboWindowParam.const_503,false);
         var_28.scaler.setParamFlag(HabboWindowParam.const_905,true);
      }
