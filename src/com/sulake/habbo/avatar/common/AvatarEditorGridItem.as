package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridItem
   {
      ...
      private const const_1574:int = 16777215;
      
      private var _isSelected:Boolean = false;
      
      private var var_1365:BitmapData;
      
      private const const_1573:int = 13421772;
      
      private var var_839:Rectangle;
      
      private var _window:IWindowContainer;
      
      private var var_1012:Boolean;
      
      private var var_357:BitmapData;
      ...
      public function AvatarEditorGridItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:IPartColor = null, param5:Boolean = true)
      {
         ...
         if(param3 == null)
         {
            var_357 = new BitmapData(1,1,true,16777215);
         }
         else
         {
            var_1012 = param3.isColorable;
         }
         var_1012 = param5;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            if(var_357 != null)
            {
               _loc2_ = var_357.clone();
               if(_color != null && var_1012)
               {
         ...
         if(isSelected)
         {
            _window.color = const_1573;
         }
         else
         {
            _window.color = const_1574;
         }
         _window.invalidate();
      }
      ...
      private function renderThumb() : BitmapData
      {
         ...
         _loc1_ = new BitmapData(var_839.width,var_839.height,true,16777215);
         for each(_loc2_ in partSet.parts.concat().sort(sortByDrawOrder))
         {
            _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + FigureData.const_894 + "_" + FigureData.const_259;
            ...
            if(_loc4_ != null)
            {
               ...
               if(_color != null && var_1012 && _loc2_.isColorable)
               {
      ...
      private function analyzeLayers() : void
      {
         ...
         {
            _loc2_ = "undefined_undefined_" + _loc1_.type + "_" + _loc1_.id + "_" + FigureData.const_894 + "_" + FigureData.const_259;
