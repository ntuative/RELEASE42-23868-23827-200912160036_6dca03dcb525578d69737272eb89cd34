package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1545:int = 16777216;
      
      public static const const_1528:int = 1;
       
      
      private var var_2254:int = 69069;
      
      private var var_1184:int = 1;
      
      private var var_2255:int = 5;
      
      private var var_1425:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1425 * param2);
      }
      ...
      {
         var _loc1_:int = var_2254 * var_1184 + var_2255;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
