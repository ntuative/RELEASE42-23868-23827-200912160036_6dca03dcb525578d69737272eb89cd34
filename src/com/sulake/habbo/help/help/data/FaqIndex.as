package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_618:FaqCategory;
      
      private var var_617:FaqCategory;
      ...
      {
         super();
         var_617 = new FaqCategory(-999,"${help.faq.title.urgent}");
         _frontPageNormal = new FaqCategory(-9999,"${help.faq.title.normal}");
         var_618 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
         var_132 = new Map();
      }
      ...
      {
         var _loc4_:* = null;
         if(var_617.hasItem(param1))
         {
            var_617.getItem(param1).answerText = param2;
         }
         if(_frontPageNormal.hasItem(param1))
         {
            _frontPageNormal.getItem(param1).answerText = param2;
         }
         if(var_618.hasItem(param1))
         {
            var_618.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
