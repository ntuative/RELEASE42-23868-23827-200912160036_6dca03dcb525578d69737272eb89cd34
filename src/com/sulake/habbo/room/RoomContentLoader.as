package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_767:String = "selection_arrow";
      
      private static const const_766:String = "tile_cursor";
      ...
      private static const const_1096:String = const_342;
      ...
      public static const const_605:String = "RCL_LOADER_READY";
      ...
      private var var_1026:IEventDispatcher = null;
      ...
      public function RoomContentLoader()
      {
         var_698 = [];
         var_697 = [];
         var_2147 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_2149 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_412 = new Map();
         _events = new Map();
      ...
      {
         var _loc2_:String = var_575.getValue(param1) as String;
      ...
      {
         if(var_181 != null && var_181.hasWorldType(const_271 + param1))
         {
            return var_181.type;
         }
         return param1;
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           if(_loc9_[0] as String == "s")
                           {
                              ...
                              if(var_698.indexOf(_loc14_) < 0)
                              {
                                 var_698.push(_loc14_);
                              }
                           }
                           else if(_loc9_[0] as String == "i")
                           {
                              ...
                              var_575.add(_loc10_,_loc11_);
                              if(var_697.indexOf(_loc14_) < 0)
                              {
                                 var_697.push(_loc14_);
                              }
                           }
                           _loc16_ = var_490.getValue(_loc14_);
                           if(_loc12_ > _loc16_)
                           {
                              var_490.remove(_loc14_);
                              var_490.add(_loc14_,_loc12_);
                           }
                        }
                     }
                  }
      ...
      public function dispose() : void
      {
         ...
         if(var_412 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = var_412.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
         ...
         if(var_351 != null)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc4_ = var_351.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      {
         return [const_342,const_490,ROOM_CONTENT,const_766,const_767];
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = var_412.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = var_576.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = getContentType(_loc4_);
               _loc3_ = var_412.getValue(getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.const_32 || _loc2_ == RoomObjectCategoryEnum.const_29)
         {
            ...
            return int(var_490.getValue(param1));
         }
         return 0;
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_2147.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_156 && _loc5_ != RoomObjectLogicEnum.const_126)
         {
            _loc6_ = "@shadow";
      ...
      {
         if(var_698.indexOf(param1) >= 0)
         {
            return const_342;
         }
         if(var_697.indexOf(param1) >= 0)
         {
            return const_490;
         }
         if(var_181 != null && (var_181.type == param1 || var_181.hasWorldType(param1)))
         {
            return ROOM_CONTENT;
         }
         return const_1096;
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,CoreComponent.const_1211);
               return;
            }
         }
      }
      ...
      {
         var _loc3_:String = var_575.getValue(param1) as String;
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_2149.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
            ...
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_395,_loc5_);
         }
         else
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_452,_loc5_);
         }
      ...
      private function continueInitilization() : void
      {
         if(var_2143)
         {
            ...
            if(var_1026 != null)
            {
               var_1026.dispatchEvent(new Event(const_605));
            }
         }
      }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         if(var_181 != null)
         {
            return var_181.getWorldHeightScale(const_271 + param1);
         }
         return 1;
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_1026 = param1;
            var_2144 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_2145 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_2148 = param2.getKey("public.room.dynamic.download.url","");
            var_2146 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         _state = const_768;
      }
      ...
      {
         var _loc2_:String = getContentType(param1);
         return var_351.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         ...
         if(var_414 != null)
         {
            var_414.remove(param2);
            var_414.add(param2,param1);
         }
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_156 && _loc5_ != RoomObjectVisualizationEnum.const_126)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      {
         if(getObjectCategory(const_271 + param1) == RoomObjectCategoryEnum.const_62)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            var_181 = _publicRooms.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_382,onContentLoaded);
            _loc6_ = 0;
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(var_181 != null)
         {
            return var_181.getWorldScale(const_271 + param1);
         }
         return 32;
      }
