package com.sulake.habbo.room.events
{
   ...
   public class RoomObjectSoundMachineStateUpdateEvent extends RoomObjectEvent
   {
      ...
      public static const const_865:String = "ROSM_SOUND_MACHINE_SWITCHED_ON";
      
      public static const const_1276:String = "ROSM_JUKEBOX_INIT";
      
      public static const const_1184:String = "ROSM_SOUND_MACHINE_SWITCHED_OFF";
      
      public static const const_784:String = "ROSM_DISPOSE";
