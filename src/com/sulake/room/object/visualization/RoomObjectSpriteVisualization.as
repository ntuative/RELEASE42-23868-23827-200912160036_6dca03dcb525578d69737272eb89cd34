package com.sulake.room.object.visualization
{
   ...
   public class RoomObjectSpriteVisualization implements IRoomObjectSpriteVisualization
   {
      ...
      protected var var_277:uint = 4.294967295E9;
      
      private var var_262:IRoomObject;
      
      protected var var_184:uint = 4.294967295E9;
      ...
      {
         if(param1 < var_166.length)
         {
            return var_166[param1];
         }
         return null;
      }
      ...
      public function dispose() : void
      {
         ...
         if(var_166 != null)
         {
            while(false)
            {
               _loc1_ = var_166[0] as RoomObjectSprite;
               if(_loc1_ != null)
               {
                  _loc1_.dispose();
               }
      ...
      {
         var _loc2_:* = null;
         while(var_166.length > param1)
         {
            _loc2_ = var_166["-1"] as RoomObjectSprite;
            if(_loc2_ != null)
            {
               _loc2_.dispose();
            }
