package com.sulake.habbo.avatar.geometry
{
   ...
   public class AvatarModelGeometry
   {
      ...
      private var var_1421:AvatarSet;
      ...
      public function AvatarModelGeometry(param1:XML)
      {
         ...
         var_645 = new Dictionary();
         var_1421 = new AvatarSet(param1.avatarset[0]);
         var_170 = new Dictionary();
         ...
         for each(_loc4_ in param1.type)
         {
            ...
            var_645[String(_loc4_.@id)] = _loc12_;
         }
      }
      ...
      public function getParts(param1:String, param2:String, param3:uint, param4:Array) : Array
      {
         ...
         if(hasBodyPart(param1,param2))
         {
            ...
            return _loc5_.getParts(var_465,var_793,param4);
         }
         return [];
      }
      ...
      {
         var _loc2_:AvatarSet = var_1421.findAvatarSet(param1);
         if(_loc2_ != null)
         {
      ...
      private function hasBodyPart(param1:String, param2:String) : Boolean
      {
         ...
         {
            _loc3_ = var_645[param1] as Dictionary;
      ...
      {
         var _loc4_:* = null;
         var _loc3_:Dictionary = var_170[param1];
         if(_loc3_ != null)
         {
      ...
      private function getBodyPartsOfType(param1:String) : Dictionary
      {
         if(typeExists(param1))
         {
            return var_645[param1] as Dictionary;
         }
      ...
      {
         var _loc2_:* = [];
         var _loc3_:AvatarSet = var_1421.findAvatarSet(param1);
         if(_loc3_ != null)
         {
