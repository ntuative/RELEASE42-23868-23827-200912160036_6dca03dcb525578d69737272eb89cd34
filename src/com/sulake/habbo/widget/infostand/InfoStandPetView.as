package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1592:uint = 6710886;
      
      private var _window:IItemListWindow;
      
      private const const_1588:String = "level";
      
      private var var_107:IItemListWindow;
      
      private const const_1593:String = "energy";
      
      private var var_1265:Map;
      
      private const const_1587:String = "nutrition";
      
      private var var_65:IItemListWindow;
      
      private const const_1591:uint = 3355443;
      
      private var var_216:IBorderWindow;
      
      private const const_1590:int = 158;
      
      private const const_1585:int = 16;
      
      private var _widget:InfostandWidget;
      
      private var var_272:PetCommandTool;
      
      private const const_1586:uint = 11184810;
      
      private const const_1589:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_216 != null)
         {
            var_107 = var_216.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
      ...
      {
         if(var_107 == null || var_216 == null || var_65 == null)
         {
            return;
         }
         ...
         var_216.height = NaN;
         _window.width = Math.max(var_216.width,var_65.width);
      ...
      private function openTrainView() : void
      {
         if(var_272 == null)
         {
            var_272 = new PetCommandTool(_widget);
         }
         var _loc1_:InfoStandPetData = var_1265.getValue(var_593) as InfoStandPetData;
         if(_loc1_ != null)
         {
            var_272.showWindow(true);
            var_272.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         ageText = param1.age;
         updateStateElement(const_1588,param1.level,param1.levelMax);
         updateStateElement(const_1589,param1.experience,param1.experienceMax);
         updateStateElement(const_1593,param1.energy,param1.energyMax);
         updateStateElement(const_1587,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_593 = param1.id;
         var_1265.remove(param1.id);
         var_1265.add(param1.id,param1);
         if(var_272 && var_272.isVisible() && param1.isOwnPet)
         {
            var_272.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         var_272.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1590,const_1585,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),const_1586);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,const_1591);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,const_1592);
         return _loc5_;
      }
