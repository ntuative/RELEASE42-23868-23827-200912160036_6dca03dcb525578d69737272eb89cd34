package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1548:IAvatarRenderManager;
      
      private var var_1311:AvatarSearchResults;
      
      private var var_130:IHabboMessenger;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_710:FriendRequests;
      
      private var var_1547:int;
      
      var var_321:FriendCategories;
      
      private var var_205:IHabboToolbar;
      
      private var var_1546:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_415:FriendListTabs;
      
      private var var_1549:IHabboNotifications;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_1310:OpenedToWebPopup;
      ...
      {
         var_1546 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_321 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1311 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1310 == null)
         {
            var_1310 = new OpenedToWebPopup(this);
         }
         var_1310.show(x,y);
      }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         var_710.clearAndUpdateView(false);
         for each(_loc3_ in _loc2_.reqs)
         {
            var_710.addRequest(new FriendRequest(_loc3_));
         }
         if(_loc2_.reqs.length > 0)
         {
            var_415.findTab(FriendListTab.const_94).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      {
         var _loc1_:HabboToolbarSetIconEvent = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_153,HabboToolbarIconEnum.FRIENDLIST);
         _loc1_.iconState = String(var_710.getCountOfOpenRequests() > 0 ? "2" : "0");
         var_205.events.dispatchEvent(_loc1_);
      }
      ...
      private function onMessengerComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_130 = param2 as IHabboMessenger;
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return var_321.findFriend(param1);
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         var_710 = new FriendRequests(new FriendRequestsDeps(this),_loc2_.userFriendLimit,_loc2_.extendedFriendLimit);
         for each(_loc3_ in _loc2_.categories)
         {
            var_321.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_321.addCategory(new FriendCategory(FriendCategory.const_805,getText("friendlist.friends")));
         var_321.addCategory(new FriendCategory(FriendCategory.const_440,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_321.addFriend(new Friend(_loc4_));
         }
         var_415 = new FriendListTabs(new FriendListTabsDeps(this));
         _loc5_ = new Timer(120000);
         _loc5_.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
         _loc5_.start();
         getBuddyRequests();
         registerListeners();
         var_205.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_125,HabboToolbarIconEnum.FRIENDLIST));
      ...
      {
         var_321.onFriendListUpdate(param1);
      ...
      {
         var _loc2_:IAvatarImage = var_1548.createAvatarImage(param1,AvatarScaleType.const_99);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1548 = param2 as IAvatarRenderManager;
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var_710.addRequestAndUpdateView(_loc3_);
         var _loc4_:FriendListTab = var_415.findTab(FriendListTab.const_94);
      ...
      {
         var_1549 = param2 as IHabboNotifications;
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_321.getFriendCount(param1,param2);
      }
      ...
      {
         var _loc1_:String = var_173.getKey("client.minimail.embed.enabled");
         return _loc1_ == "true";
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_415.findSelectedTab();
            if(_loc1_ == null)
            {
               events.dispatchEvent(new Event(HabboFriendListTrackingEvent.const_316));
            }
            else
            {
               switch(_loc1_.id)
      ...
      {
         var_205 = IHabboToolbar(param2) as IHabboToolbar;
      ...
      {
         return var_173.getKey(param1,param1,param2);
      }
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1311.searchReceived(_loc2_.friends,_loc2_.others);
