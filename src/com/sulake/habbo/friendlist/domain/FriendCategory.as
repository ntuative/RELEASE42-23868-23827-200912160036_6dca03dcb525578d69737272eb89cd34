package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_805:int = 0;
      
      public static const const_440:int = -1;
      
      public static const const_325:int = 100;
      ...
      {
         return Math.ceil(this.var_238.length / const_325);
      }
      ...
      {
         if(this.var_845 >= this.getPageCount())
         {
            this.var_845 = Math.max(0,this.getPageCount() - 1);
         }
      }
      ...
      public function addFriend(param1:Friend) : void
      {
         ...
         {
            _loc4_ = var_238[_loc3_];
            if(_loc2_ < _loc4_.name.toLowerCase())
            {
               var_238.splice(_loc3_,0,param1);
               return;
            }
            _loc3_++;
         }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_845 + 1) * const_325,this.var_238.length);
      }
