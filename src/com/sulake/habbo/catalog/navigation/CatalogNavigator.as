package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNavigator implements ICatalogNavigator
   {
      ...
      private var var_2246:String = "magic.pixels";
      
      private var var_2247:String = "catalog.page.club";
      
      private var var_2261:String = "magic.credits";
      ...
      public function CatalogNavigator(param1:IHabboCatalog, param2:IWindowContainer)
      {
         ...
         if(_scrollBar != null)
         {
            ...
            _scrollBar.addEventListener(WindowEvent.const_556,activateScrollbar);
            _scrollBar.addEventListener(WindowEvent.const_242,activateScrollbar);
      ...
      private function openCreditsPage() : void
      {
         ...
         var _loc1_:* = var_70.configuration.getKey("client.credits.embed.enabled","false") == "true";
         if(false && _loc1_)
         {
      ...
      {
         var_70.openCatalogPage(var_2247,true);
      }
      ...
      public function activateNode(param1:ICatalogNode) : void
      {
         ...
         var _loc6_:* = null;
         var _loc7_:int = 0;
         var _loc2_:* = var_250.indexOf(param1) > -1;
         var _loc3_:Boolean = param1.isOpen;
         var _loc4_:* = [];
         for each(_loc5_ in var_250)
         {
            _loc5_.deActivate();
         ...
         {
            _loc6_.close();
            _loc7_ = var_250.indexOf(_loc6_);
            var_250.splice(_loc7_,1);
         }
         param1.activate();
         if(_loc2_ && _loc3_)
         {
