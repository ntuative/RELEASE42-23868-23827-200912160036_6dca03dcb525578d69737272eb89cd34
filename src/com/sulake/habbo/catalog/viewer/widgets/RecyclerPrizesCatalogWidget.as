package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RecyclerPrizesCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private var var_1748:XML;
      
      private var var_283:IGridItem;
      
      private var var_1297:XML;
      
      private var _itemList:IItemListWindow;
      
      private var var_758:PrizeViewer;
      ...
      override public function init() : void
      {
         ...
         var_1748 = _loc1_.content as XML;
         populateItemGrid();
      ...
      {
         var _loc6_:* = null;
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1748) as IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1297) as IWindowContainer;
      ...
      public function select(param1:IGridItem) : void
      {
         ...
         var_758.viewProduct(page.viewer.roomEngine,_loc3_,_loc2_.productItemType,_loc2_.productItemTypeId,_loc2_.title,_loc4_);
      }
