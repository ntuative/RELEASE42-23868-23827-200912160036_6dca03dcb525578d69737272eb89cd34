package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_1055:XML;
      
      private var var_367:int;
      
      private var var_423:DimmerViewColorGrid;
      
      private var _window:IWindowContainer;
      
      private var var_1537:int;
      
      private var var_312:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_53,HabboWindowStyle.const_39,0 | 0,new Rectangle(const_1001,const_1002,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               var_423 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,_widget.windowManager,_widget.assets);
            }
         }
         _loc1_ = _window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            var_312 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,_widget.assets);
         }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(var_423 != null)
         {
            var_423.setSelectedColorIndex(param1);
         }
         _widget.previewCurrentSetting();
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(var_312 != null)
         {
            var_312.min = _widget.minLights[param1 - 1];
         }
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_880 = _loc2_.light;
         if(var_312 != null)
         {
            var_312.setValue(var_880);
         }
         var_367 = colors.indexOf(_loc2_.color);
         if(var_423 != null)
         {
            var_423.setSelectedColorIndex(var_367);
         }
