package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1380:String = "no_reqs_info";
       
      
      private var var_1485:IContainerButtonWindow;
      
      private var _friendList:HabboFriendList;
      
      private var var_1484:IContainerButtonWindow;
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_315 && _loc4_.state != FriendRequest.const_288)
            {
      ...
      {
         var_1485 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1484 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1484.procedure = onDismissAllButtonClick;
         var_1485.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      public function refreshShading(param1:FriendRequest, param2:Boolean) : void
      {
         ...
         param1.view.color = _friendList.laf.getRowShadingColor(FriendListTab.const_94,param2);
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         if(param1.state == FriendRequest.const_140)
         {
         ...
         else if(param1.state == FriendRequest.const_806)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1485,_loc1_);
         setEnabled(var_1484,_loc1_);
      }
