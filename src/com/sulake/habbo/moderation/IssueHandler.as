package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_61.issueManager.releaseBundle(var_113.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         var _loc3_:IssueMessageData = var_113.getHighestPriorityIssue();
         var_362 = new UserInfoCtrl(_window,var_61,_loc3_.message);
         var_881 = new UserInfoCtrl(_window,var_61,_loc3_.message);
         var_362.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_113.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_881.load(_loc4_,var_113.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_61.issueManager.closeBundle(var_113.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc4_:Array = var_113.issues;
         var _loc5_:int = 0;
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = var_113.getHighestPriorityIssue().issueId;
         var_61.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_61,WindowTracker.const_831,_loc2_),_window,false,false,true);
      }
      ...
      {
         if(var_61 != null && false && var_113 != null)
         {
            var_61.issueManager.removeHandler(var_113.id);
         }
         this.dispose();
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            _loc3_ = var_113.getHighestPriorityIssue();
            var_362 = new UserInfoCtrl(_window,var_61,_loc3_.message);
            var_362.load(IWindowContainer(_window.findChildByName("caller_user_info")),_loc2_);
         }
      }
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_61.issueManager.closeBundle(var_113.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_61.issueManager.closeBundle(var_113.id,3);
         checkAutoHandling();
         dispose();
      }
      ...
      {
         return WindowTracker.const_1333;
      }
   }
}
