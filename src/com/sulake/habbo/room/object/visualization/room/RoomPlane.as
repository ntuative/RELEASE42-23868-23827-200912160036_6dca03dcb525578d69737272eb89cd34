package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      public static const const_181:int = 3;
      ...
      private var var_633:IPlaneRasterizer = null;
      ...
      private var var_533:PlaneMaskManager = null;
      ...
      private var var_1394:Boolean = true;
      ...
      public function RoomPlane(param1:IVector3d, param2:IVector3d, param3:IVector3d, param4:IVector3d, param5:int, param6:Boolean, param7:Array, param8:int, param9:Number = 0, param10:Number = 0, param11:Number = 0, param12:Number = 0)
      {
         ...
         var_376 = Vector3d.crossProduct(var_255,var_256);
         if(false)
         {
            var_376.mul(Infinity);
         }
         if(param7 != null)
         {
            _loc13_ = 0;
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(_bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (_type == const_222 || _type == const_181))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!var_768 || false && false && !var_153 || var_533 == null)
         {
            return;
         }
         ...
         if(var_153)
         {
            ...
            _loc9_ = param2.getCoordinatePosition(var_376);
            _loc10_ = 0;
            _loc11_ = 0;
            _loc5_ = 0;
            while(_loc5_ < var_196.length)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  _loc12_ = _loc3_.type;
                  var_533.updateMask(var_62,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  var_631.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < var_254.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  var_938.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            var_153 = false;
      ...
      private function getTextureIdentifier(param1:IRoomGeometry) : String
      {
         ...
         if(var_633 != null)
         {
            _loc2_ = var_633.getTextureIdentifier(param1.scale,normal);
         }
         return _loc2_;
      }
      ...
      {
         if(var_134 == null || var_105 == null || var_82 == null || var_106 == null || param2 == null || _bitmapData == null)
         {
            return;
         }
         ...
         if(_type == const_222 || _type == const_181)
         {
      ...
      private function updateMaskChangeStatus() : void
      {
         ...
         if(true)
         {
            while(_loc1_ < var_196.length)
            {
               ...
               {
                  _loc6_ = false;
                  while(_loc2_ < var_631.length)
                  {
                     _loc7_ = var_631[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
      ...
      {
         var_134.assign(param1.getScreenPosition(var_76));
         var_105.assign(param1.getScreenPosition(Vector3d.sum(var_76,var_256)));
         var_82.assign(param1.getScreenPosition(Vector3d.sum(Vector3d.sum(var_76,var_255),var_256)));
         var_106.assign(param1.getScreenPosition(Vector3d.sum(var_76,var_255)));
         _offset = param1.getScreenPoint(var_632);
         ...
         var _loc2_:Number = Math.min(var_134.x,var_105.x,var_82.x,var_106.x);
         var _loc3_:Number = Math.max(var_134.x,var_105.x,var_82.x,var_106.x);
         var _loc4_:Number = Math.min(var_134.y,var_105.y,var_82.y,var_106.y);
         var _loc5_:Number = Math.max(var_134.y,var_105.y,var_82.y,var_106.y);
         _loc3_ -= _loc2_;
         _offset.x = 0 - _loc2_;
         var_134.x = 0 - _loc2_;
         var_105.x = 0 - _loc2_;
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc10_:* = null;
         if(param1 == null || var_632 == null || var_76 == null || var_255 == null || var_256 == null || var_376 == null)
         {
            return false;
         }
         var _loc3_:Boolean = false;
         if(param1.updateId != var_1147)
         {
            var_1147 = param1.updateId;
            _loc4_ = param1.direction;
            if(_loc4_ != null && (_loc4_.x != var_942 || _loc4_.y != var_1771 || _loc4_.z != var_1773 || param1.scale != var_1768))
            {
               var_942 = _loc4_.x;
               var_1771 = _loc4_.y;
               var_1773 = _loc4_.z;
               var_1768 = param1.scale;
               _loc3_ = true;
               _loc5_ = 0;
               ...
               _loc7_ = param1.getScreenPosition(var_632);
               _loc8_ = _loc7_.z;
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc4_:PlaneBitmapData = var_172.getValue(_loc3_) as PlaneBitmapData;
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(needsNewTexture(param1,param2))
         {
            ...
            _loc7_ = param1.getCoordinatePosition(var_376);
            _loc4_ = var_172.getValue(_loc3_) as PlaneBitmapData;
            _loc8_ = null;
            if(_loc4_ != null)
            {
            ...
            if(var_633 != null)
            {
               _loc4_ = var_633.render(_loc8_,_id,_loc5_,_loc6_,param1.scale,_loc7_,var_1394,var_1769,var_1775,var_1774,var_1767,param2);
               if(_loc4_ != null)
               {
