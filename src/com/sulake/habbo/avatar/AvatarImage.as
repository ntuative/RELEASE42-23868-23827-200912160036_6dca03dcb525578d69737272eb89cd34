package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1046:String = AvatarSetType.const_38;
      
      private static const const_1049:String = "Default";
      
      private static const const_1048:int = 125;
       
      
      private var _avatarSubType:int = 0;
      
      private var var_531:AvatarFigureContainer;
      ...
      private var var_452:IAvatarDataContainer;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:String, param4:String, param5:String)
      {
         ...
         if(var_193 == null)
         {
            var_193 = AvatarScaleType.const_50;
         }
         ...
         var_531 = new AvatarFigureContainer(param3);
         if(param5 == AvatarType.PET)
         {
            _loc6_ = var_531.getPartSetId("pbd");
            solvePetAvatarTypeAndRace(_loc6_);
            _avatarSubType = var_935;
         }
         var_147 = new AvatarImageCache(var_75,this,_assets,var_193);
         setDirection(const_1046,const_1047);
         var_194 = new Array();
         resetActions();
      }
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         var _loc3_:* = null;
         param2 += var_1138;
         if(param2 < AvatarDirectionAngle.const_1290)
         {
            param2 = AvatarDirectionAngle.const_638 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_638)
         {
            param2 -= NaN;
         }
         if(var_634 == AvatarType.PET && param1 == AvatarSetType.const_45)
         {
      ...
      private function sortActions() : void
      {
         ...
         resetActions();
         _isAnimating = false;
         var _loc1_:Array = var_75.sortActions(var_194);
         if(_loc1_ == null)
         {
            var_530 = new Array(0,0,0);
         }
         else
         {
            var_530 = var_75.getCanvasOffsets(_loc1_,var_193,var_96);
         }
         for each(_loc2_ in _loc1_)
         {
            ...
            if(_loc2_.definition.isAnimation)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     var_452 = _loc3_.avatarData;
                  }
               }
            }
            if(_loc2_.actionType == AvatarAction.const_620)
            {
               _isAnimating = true;
            }
            ...
            if(_loc2_.actionType == AvatarAction.const_375)
            {
               _isAnimating = true;
            }
         }
      ...
      {
         return var_75.getPartColor(var_531,param1);
      }
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         var _loc3_:AvatarCanvas = var_75.getCanvas(var_193,var_169.definition.geometryType);
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:BitmapData = new BitmapData(_loc3_.width,_loc3_.height,true,16777215);
         var _loc5_:Array = var_75.getBodyParts(param1,var_169.definition,var_96);
         var _loc7_:int = _loc5_.length - 1;
         while(_loc7_ >= 0)
         {
            _loc9_ = _loc5_[_loc7_];
            _loc10_ = _loc2_.getImageContainer(_loc9_,var_453);
            if(_loc10_ != null)
            {
               ...
               if(var_634 == AvatarType.PET)
               {
                  _loc14_ = getCache().getBodyPartCache(_loc9_);
                  _loc15_ = _loc14_.getAction();
                  _loc16_ = _loc15_.definition.assetPartDefinition;
                  _loc17_ = var_75.getParts(_loc9_,var_531,_loc15_,"pet",_loc14_.getDirection());
                  _loc18_ = 32;
                  if(var_193 == AvatarScaleType.const_99)
                  {
                     _loc18_ = 6;
                  }
                  if(_loc17_.length > 0)
                  {
                     _loc19_ = _loc17_[0];
                     _loc20_ = _loc19_.getFrameIndex(var_453);
                     _loc21_ = var_96;
                     _loc22_ = 1;
                     switch(var_96)
                     {
                     ...
                     _loc23_ = var_75.getPartActionOffset(getSubType(),var_193,_loc9_,_loc16_,_loc20_,_loc21_);
                     if(_loc23_ != null)
                     {
      ...
      public function getImage(param1:String) : BitmapData
      {
         ...
         {
            _loc3_ = var_75.getCanvas(var_193,var_169.definition.geometryType);
            if(_loc3_ == null)
            {
               return null;
            }
         ...
         var _loc4_:Array = var_75.getBodyParts(param1,var_169.definition,var_96);
         _image.lock();
         ...
         while(_loc6_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,var_453);
            if(_loc8_ != null)
            {
               ...
               if(var_634 == AvatarType.PET)
               {
                  ...
                  _loc14_ = var_75.getParts(_loc7_,var_531,_loc12_,"pet",_loc11_.getDirection());
                  ...
                  {
                     _loc17_ = _loc14_[0];
                     _loc18_ = _loc17_.getFrameIndex(var_453);
                     _loc19_ = var_96;
                     _loc20_ = 1;
                     switch(var_96)
                     {
                     ...
                     _loc21_ = var_75.getPartActionOffset(getSubType(),var_193,_loc7_,_loc13_,_loc18_,_loc19_);
                     if(_loc21_ != null)
                     {
         ...
         if(var_452 != null)
         {
            if(false)
            {
               ...
               _image.paletteMap(_image,_image.rect,new Point(0,0),var_452.reds,[],[]);
            }
            else
            {
      ...
      private function resetActions() : Boolean
      {
         ...
         var_169 = new ActiveActionData(AvatarAction.const_873);
         var_169.definition = var_75.getActionDefinition(const_1049);
      ...
      {
         return var_75.getBodyPartData(param1.animation.id,var_453,param1.id);
      }
