package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow
   {
      ...
      protected var var_494:Boolean = false;
      
      protected var var_2243:Number = 0;
      
      protected var var_495:Number;
      
      protected var var_1039:Boolean = false;
      ...
      public function ItemListController(param1:String, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:IWindow, param9:Function = null, param10:Array = null, param11:Array = null, param12:uint = 0)
      {
         ...
         var_72 = 0;
         param5 |= 0;
         _horizontal = param3 == WindowType.const_298;
         super(param1,param2,param3,param4,param5,param6,param7,param8,param9,param10,param11,param12);
         var _loc13_:Rectangle = new Rectangle(0,0,width,height);
         _container = _context.create("_CONTAINER","",WindowType.const_326,WindowStyle.const_263,0 | 0 | 0 | 0,_loc13_,null,this,0,null,[WindowController.INTERNAL_CHILD_TAG,WindowController.EXCLUDE_CHILD_TAG]) as IWindowContainer;
         ...
         _container.addEventListener(WindowEvent.const_313,containerEventHandler);
         _container.addEventListener(WindowEvent.const_467,containerEventHandler);
         resizeOnItemUpdate = var_1039;
      }
      ...
      {
         return new Rectangle(var_495 * maxScrollH,var_496 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         ...
         _container.removeEventListener(WindowEvent.const_313,containerEventHandler);
         _container.removeEventListener(WindowEvent.const_467,containerEventHandler);
         super.dispose();
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         {
            var_495 = param1;
            _container.x = -var_495 * maxScrollH;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("auto_arrange_items",var_702,PropertyStruct.const_57,var_702 != true));
         _loc1_.push(new PropertyStruct("scale_to_fit_items",var_494,PropertyStruct.const_57,var_494 != false));
         _loc1_.push(new PropertyStruct("resize_on_item_update",var_1039,PropertyStruct.const_57,var_1039 != false));
         return _loc1_;
      }
      ...
      public function set scrollV(param1:Number) : void
      {
         ...
         {
            var_496 = param1;
            _container.y = -var_496 * maxScrollV;
            _context.invalidate(_container,visibleRegion,WindowRedrawFlag.const_71);
         }
      }
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            switch(_loc3_.key)
            {
               ...
               case "auto_arrange_items":
                  var_702 = _loc3_.value as Boolean;
                  break;
            }
            _loc4_++;
         }
      ...
      public function set resizeOnItemUpdate(param1:Boolean) : void
      {
         ...
         if(_container)
         {
            ...
            {
               _container.setParamFlag(WindowParam.const_463,param1);
            }
         }
      }
