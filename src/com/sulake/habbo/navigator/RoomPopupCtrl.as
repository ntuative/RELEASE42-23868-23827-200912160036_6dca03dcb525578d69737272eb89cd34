package com.sulake.habbo.navigator
{
   ...
   public class RoomPopupCtrl extends PopupCtrl
   {
      ...
      public function RoomPopupCtrl(param1:HabboNavigator, param2:int, param3:int)
      {
         ...
         var_1684 = new RoomThumbnailRenderer(param1);
         var_939 = new TagRenderer(param1,hideInstantly);
      }
      
      private function refreshOwnerName() : void
      {
         refreshTextWithCaption("roomowner",var_167,var_114.ownerName);
         var _loc1_:ITextWindow = ITextWindow(var_167.findChildByName("roomowner"));
         if(true)
         {
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_167.findChildByName("extra_cont"));
         Util.hideChildren(_loc1_);
         var_939.refreshTags(_loc1_,var_114.tags);
         refreshTextWithCaption("rating",_loc1_,"undefined");
         if(false)
         {
            refreshTextWithCaption("startedat",_loc1_,"undefined");
         }
         var_1684.refreshThumbnail(_loc1_,var_114.thumbnail,false);
      ...
      override public function refreshContent(param1:IWindowContainer) : void
      {
         if(var_167 == null)
         {
            var_167 = IWindowContainer(param1.findChildByName("details_container"));
         }
         var_167.visible = true;
         Util.hideChildren(var_167);
         refreshRoomName(var_167,var_114);
         if(true)
         {
         }
         refreshOwnerName();
         refreshTextWithCaption("roomctg",var_167,!true ? getEventCtg(var_114.categoryId) : getRoomCtg(var_114.categoryId));
         refreshRoomDesc(var_167,var_114);
         refreshExtraCont();
         refreshInfo(var_167,"trading_allowed",var_114.allowTrading);
         refreshInfo(var_167,"doormode_doorbell",false);
         refreshInfo(var_167,"doormode_password",false);
         Util.moveChildrenToColumn(var_167,["roomname","roomctg_cont","roomowner_cont","roomdesc","extra_cont","doormode_doorbell","doormode_password","trading_allowed"],0,0);
         var_167.height = Util.getLowestPoint(var_167);
      }
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null)
         {
            navigator.mainViewCtrl.startSearch(Tabs.const_184,Tabs.const_207,_loc3_.text);
            this.hideInstantly();
         }
      }
   }
