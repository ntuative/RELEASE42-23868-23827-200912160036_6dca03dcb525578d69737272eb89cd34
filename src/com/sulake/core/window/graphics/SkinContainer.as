package com.sulake.core.window.graphics
{
   ...
   public class SkinContainer implements ISkinContainer
   {
      ...
      protected static var var_358:Array;
      
      private static const const_1067:uint = 8;
       
      
      private var var_467:Dictionary;
      
      private var var_1883:Dictionary;
      ...
      public function SkinContainer(param1:XML, param2:IAssetLibrary)
      {
         ...
         var_1884 = new Dictionary();
         TypeCodeTable.fillTables(var_1429,var_1884);
         var_1185 = new Dictionary();
         var_1883 = new Dictionary();
         StateCodeTable.fillTables(var_1185,var_1883);
         var_467 = new Dictionary();
         var_467["skin"] = BitmapSkinRenderer;
         var_467["bitmap"] = BitmapDataRenderer;
         var_467["fill"] = FillSkinRenderer;
         var_467["text"] = TextSkinRenderer;
         var_467["shape"] = ShapeSkinRenderer;
         var_467["unknown"] = SkinRenderer;
         var_467["null"] = NullSkinRenderer;
         if(var_358 == null)
         {
            var_358 = new Array();
            var_358.push(WindowState.const_56);
            var_358.push(WindowState.const_63);
            var_358.push(WindowState.const_88);
            var_358.push(WindowState.const_47);
            var_358.push(WindowState.WINDOW_STATE_HOVERING);
            var_358.push(WindowState.const_69);
            var_358.push(WindowState.const_82);
            var_358.push(WindowState.const_76);
         }
         var _loc3_:Array = new Array();
         for(_loc4_ in var_1185)
         {
            _loc3_.push(var_1185[_loc4_]);
         }
         if(param1 != null)
         {
            ...
            if(_loc6_ > 0)
            {
               ...
               while(_loc18_ < _loc6_)
               {
                  ...
                  addSkinRenderer(var_1429[_loc9_],uint(_loc10_),_loc15_);
                  _loc18_++;
               }
            }
         }
      ...
      {
         var _loc3_:Array = var_549[param1];
      ...
      public function addSkinRenderer(param1:uint, param2:uint, param3:ISkinRenderer) : void
      {
         if(true)
         {
            var_549[param1] = new Array(SkinContainer.const_1067);
         }
         var_549[param1][param2] = param3;
      }
      ...
      public function dispose() : void
      {
         ...
         {
            ISkinRenderer(var_549[_loc1_]).dispose();
