package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCell
   {
      ...
      private var var_472:PlaneTexture;
      ...
      public function render(param1:IVector3d) : BitmapData
      {
         ...
         if(var_472 != null)
         {
            _loc2_ = var_472.getBitmap(param1);
            if(_loc2_ != null)
            {
               if(!isStatic)
               {
                  if(var_39 != null)
                  {
                     if(var_39.width != _loc2_.width || var_39.height != _loc2_.height)
                     {
                        var_39.dispose();
                        var_39 = null;
                     }
                     ...
                     {
                        var_39.copyPixels(_loc2_,_loc2_.rect,new Point(0,0));
                     }
                  }
                  if(var_39 == null)
                  {
                  ...
                  _loc3_ = Math.min(var_982,_extraItemOffsets.length);
                  _loc4_ = Math.max(var_982,_extraItemOffsets.length);
                  _loc5_ = Randomizer.getArray(var_982,_loc4_);
                  _loc6_ = 0;
                  while(_loc6_ < _loc3_)
                  {
                     _loc7_ = _extraItemOffsets[_loc5_[_loc6_]] as Point;
                     _loc8_ = var_660[_loc6_ % 0] as IGraphicAsset;
