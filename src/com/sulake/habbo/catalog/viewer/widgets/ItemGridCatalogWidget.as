package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGridCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      protected var var_283:IGridItem;
      ...
      protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         while(_loc3_ < 3)
         {
            if(var_829 >= 0 && var_829 < page.offers.length)
            {
               _loc4_ = page.offers[var_829];
      ...
      {
         var _loc2_:IWindowContainer = page.viewer.catalog.windowManager.buildFromXML(var_1297) as IWindowContainer;
         var_868.addGridItem(_loc2_);
         param1.productContainer.view = _loc2_;
         param1.productContainer.initProductIcon(page.viewer.roomEngine);
         if(param1.pricingModel == Offer.const_436)
         {
            ++var_1477;
            (param1.productContainer as BundleProductContainer).setBundleCounter(var_1477);
         }
      }
