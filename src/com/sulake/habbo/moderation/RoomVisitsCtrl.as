package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      public function onRoomVisits(param1:RoomVisitsData) : void
      {
         ...
         onResizeTimer(null);
         var_58.visible = true;
         var_56.messageHandler.removeRoomVisitsListener(this);
      }
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_1658.clone());
         ...
         new OpenRoomTool(var_58,var_56,_loc5_,param1.isPublic,param1.roomId);
         _loc5_.color = _loc4_;
         ...
         new OpenRoomInSpectatorMode(var_56,_loc7_,param1.isPublic,param1.roomId);
         _loc7_.color = _loc4_;
      ...
      {
         var_1658 = IWindowContainer(var_56.getXmlWindow("roomvisits_row"));
         var_430 = new Timer(300,1);
         var_430.addEventListener(TimerEvent.TIMER,onResizeTimer);
         var_56.messageHandler.addRoomVisitsListener(this);
         var_56.connection.send(new GetRoomVisitsMessageComposer(_userId));
         var_58 = IFrameWindow(var_56.getXmlWindow("roomvisits_frame"));
