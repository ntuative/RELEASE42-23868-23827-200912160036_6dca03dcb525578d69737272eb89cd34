package com.sulake.core.window
{
   ...
   public class WindowContext implements IWindowContext, IDisposable, ICoreUpdateReceiver
   {
      ...
      private static var var_968:Factory;
      ...
      protected var var_2175:IWindowParser;
      
      protected var var_866:Error;
      
      protected var var_2176:IInternalWindowServices;
      
      protected var var_100:WindowController;
      
      protected var var_1295:int = -1;
      ...
      protected var var_1041:SubstituteParentController;
      
      private var var_2205:Point;
      
      protected var var_305:DisplayObjectContainer;
      ...
      public function WindowContext(param1:String, param2:IWindowRenderer, param3:IWindowFactory, param4:ICoreLocalizationManager, param5:DisplayObjectContainer, param6:Rectangle, param7:IWindowContextStateListener)
      {
         ...
         var_305 = param5;
         var_2176 = new InternalWindowServices(this,param5);
         var_2177 = param3;
         var_2175 = new WindowParser(this);
         var_690 = new Date();
         if(var_968 == null)
         {
            var_968 = new Factory();
         ...
         var_94 = new DesktopController("_CONTEXT_DESKTOP_" + _name,"Desktop " + _name,WindowType.const_344,WindowStyle.const_263,WindowParam.const_93,this,param6,null,null);
         var_305.addChild(var_94.getDisplayObject());
         var_305.doubleClickEnabled = true;
         var_305.addEventListener(Event.RESIZE,stageResizedHandler);
         var_100 = WindowController(var_94);
         var_1041 = new SubstituteParentController("WindowContext::SubstituteParent","",0,0,0,this,new Rectangle(0,0,0,0),null,null,null,null,0);
         var_328 = param7;
      }
      ...
      public function destroy(param1:IWindow) : Boolean
      {
         ...
         if(param1.state != WindowState.const_390)
         {
            param1.destroy();
         }
      ...
      {
         var _loc12_:Class = var_968.getWindowClassByType(param3);
         if(_loc12_ == null)
         {
            handleError(WindowContext.const_1292,new Error("Failed to solve implementation for window \"" + param1 + "\"!"));
            return null;
         }
         if(param8 == null)
         {
      ...
      {
         _disposed = true;
         var_305.removeEventListener(Event.RESIZE,stageResizedHandler);
         var_305.removeChild(IGraphicContextHost(var_94).getGraphicContext(true) as DisplayObject);
         var_94.destroy();
         var_94 = null;
         var_1041.destroy();
         var_1041 = null;
      ...
      private function stageResizedHandler(param1:Event) : void
      {
         if(var_94 != null && true)
         {
            if(var_305 is Stage)
            {
               var_94.width = Stage(var_305).stageWidth;
               var_94.height = Stage(var_305).stageHeight;
            }
            else
            {
               var_94.width = var_305.width;
               var_94.height = var_305.height;
            }
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         while(true)
         {
            ...
            if(_loc2_.stageX != var_548.x || _loc2_.stageY != var_548.y)
            {
               ...
               _loc5_ = new Array();
               var_94.groupChildrenUnderPoint(var_548,_loc5_);
            }
               ...
               if(_loc4_ != null && _loc4_.visible)
               {
                  ...
                  else if(_loc2_.type == MouseEvent.MOUSE_UP || _loc2_.type == MouseEvent.CLICK)
                  {
                     if(var_100 && true)
                     {
                        if(var_328 != null)
                        {
                           var_328.mouseEventReceived(_loc2_.type,var_100);
                        }
                     }
                  }
                  if(_loc2_.altKey)
      ...
      public function getMouseCursor() : IMouseCursor
      {
         if(var_1517 == null)
         {
            var_1517 = new MouseCursorControl(var_305 as Stage);
         }
         return var_1517;
      }
