package com.sulake.habbo.widget.doorbell
{
   ...
   public class DoorbellWidget extends RoomWidgetBase
   {
      ...
      private static const const_1005:int = 50;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDoorbellEvent.const_659,onDoorbellRinging);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_105,onDoorbellHandled);
         param1.addEventListener(RoomWidgetDoorbellEvent.const_127,onDoorbellHandled);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_659,onDoorbellRinging);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_105,onDoorbellHandled);
         param1.removeEventListener(RoomWidgetDoorbellEvent.const_127,onDoorbellHandled);
      }
