package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ItemGroupCatalogWidget extends ItemGridCatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc3_:Array = var_545[var_959] as Array;
      ...
      {
         var _loc2_:Offer = var_545[var_959][var_1845];
      ...
      private function createOfferGroups() : void
      {
         ...
         {
            if(_loc1_.pricingModel == Offer.const_393 || _loc1_.pricingModel == Offer.const_441)
            {
               _loc3_ = _loc1_.productContainer.firstProduct;
               if(_loc3_ != null)
               {
                  _loc4_ = _loc3_.productClassId;
                  if(_loc3_.productType == ProductTypeEnum.const_75 || _loc3_.productType == ProductTypeEnum.const_84)
                  {
                     if(_loc3_.furnitureData != null)
                     {
                        _loc5_ = _loc3_.furnitureData.name;
                        if(var_960.indexOf(_loc5_) == -1)
                        {
                           var_960.push(_loc5_);
                           var_545.push(new Array());
                        }
                        _loc6_ = var_960.indexOf(_loc5_);
                        (var_545[_loc6_] as Array).push(_loc1_);
                     }
                  }
               }
            }
      ...
      override protected function populateItemGrid(param1:TimerEvent = null) : void
      {
         ...
         for each(_loc2_ in var_545)
         {
            if(var_1845 < _loc2_.length)
            {
               _loc3_ = _loc2_[var_1845] as Offer;
      ...
      override public function select(param1:IGridItem) : void
      {
         ...
         super.select(param1);
         var_959 = var_868.getGridItemIndex(param1.view);
