package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1547:int = "F".charCodeAt(0);
      
      public static const const_1422:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         var_595 = param1.online;
         var_1212 = param1.followingAllowed && param1.online;
         var_531 = param1.figure;
         var_1237 = param1.motto;
         var_1239 = param1.lastAccess;
         var_1160 = param1.categoryId;
         var_1238 = param1.realName;
