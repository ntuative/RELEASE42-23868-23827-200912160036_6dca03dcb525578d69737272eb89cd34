package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1352:int = 1500;
      
      private var var_1353:int = 255;
      
      private var var_1354:int = 255;
      
      private var var_1106:uint = 16777215;
      
      private var var_910:uint = 16777215;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_542:
                  _loc2_.setString(RoomObjectVariableEnum.const_564,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_686:
                  _loc2_.setString(RoomObjectVariableEnum.const_566,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_573:
                  _loc2_.setString(RoomObjectVariableEnum.const_531,_loc3_.value);
            }
            return;
         }
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_374:
                  _loc8_ = "null";
                  ...
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_543:
            ...
            if(_loc7_)
            {
               ...
               _loc2_.setString(RoomObjectVariableEnum.const_949,_loc10_);
            }
            return;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_883,int(_loc5_.bgOnly));
            var_1106 = _color;
            var_1353 = var_1154;
            var_910 = _loc11_;
            var_1354 = _loc12_;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_986,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_588,16777215);
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > var_85.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_98,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1302,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1294,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1353,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_98,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_139 || _loc13_ == RoomPlaneData.const_221)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor() : void
      {
         ...
         if(var_742)
         {
            ...
            {
               _loc6_ = var_1106 >> 16 & 255;
               _loc7_ = var_1106 >> 8 & 255;
               _loc8_ = var_1106 & 255;
               _loc9_ = var_910 >> 16 & 255;
               _loc10_ = var_910 >> 8 & 255;
               _loc11_ = var_910 & 255;
               _loc12_ = (_loc1_ - var_742) / var_1352;
               _loc6_ += (_loc9_ - _loc6_) * _loc12_;
               _loc7_ += (_loc10_ - _loc7_) * _loc12_;
               _loc8_ += (_loc11_ - _loc8_) * _loc12_;
               _loc2_ = (_loc6_ << 16) + (_loc7_ << 8) + _loc8_;
               _loc3_ = var_1353 + (var_1354 - var_1353) * _loc12_;
               _color = _loc2_;
               var_1154 = _loc3_;
            }
            ...
            _loc5_.setNumber(RoomObjectVariableEnum.const_588,_loc2_);
         }
      }
   }
}
