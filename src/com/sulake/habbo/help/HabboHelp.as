package com.sulake.habbo.help
{
   ...
   public class HabboHelp extends Component implements IHabboHelp
   {
      ...
      private var var_2011:UserRegistry;
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_144:TutorialUI;
      
      private var var_1467:IHabboLocalizationManager;
      
      private var _windowManager:IHabboWindowManager;
      
      private var var_64:HelpUI;
      
      private var var_1468:IHabboConfigurationManager;
      
      private var var_205:IHabboToolbar;
      
      private var var_592:IHabboCommunicationManager;
      
      private var var_826:FaqIndex;
      
      private var var_1812:String = "";
      
      private var var_1402:IncomingMessages;
      
      private var var_1230:CallForHelpData;
      
      public function HabboHelp(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         var_1230 = new CallForHelpData();
         var_2011 = new UserRegistry();
         super(param1,param2,param3);
         _assetLibrary = param3;
         var_826 = new FaqIndex();
      ...
      {
         var_1230.reportedUserId = param1;
         var_1230.reportedUserName = param2;
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_205 != null)
         {
            var_205.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_125,HabboToolbarIconEnum.HELP));
         }
      }
      ...
      private function createHelpUI() : Boolean
      {
         ...
         {
            var_64 = new HelpUI(this,_assetLibrary,_windowManager,var_1467,var_205);
         }
         return var_64 != null;
      }
      ...
      {
         var_1467 = IHabboLocalizationManager(param2);
      ...
      {
         var_592 = IHabboCommunicationManager(param2);
         var_1402 = new IncomingMessages(this,var_592);
      ...
      {
         if(var_592 != null && param1 != null)
         {
            var_592.getHabboMainConnection(null).send(param1);
         }
      }
      ...
      {
         var_205 = IHabboToolbar(param2);
         queueInterface(new IIDHabboLocalizationManager(),onLocalizationManagerReady);
      }
      
      private function onConfigurationManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_1468 = IHabboConfigurationManager(param2);
      ...
      public function getConfigurationKey(param1:String, param2:String = null, param3:Dictionary = null) : String
      {
         ...
         return var_1468.getKey(param1,param2,param3);
      }
   }
}
