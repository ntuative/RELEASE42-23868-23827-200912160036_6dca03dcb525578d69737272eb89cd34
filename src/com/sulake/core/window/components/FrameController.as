package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1011:String = "_TITLE";
      
      private static const const_1013:String = "_CONTENT";
      
      private static const const_1014:String = "_HEADER";
      
      private static const const_1012:String = "_SCALER";
       
      
      private var _title:ITextWindow;
      
      private var var_73:IMargins;
      
      private var var_1303:Boolean = false;
      
      private var var_1092:IHeaderWindow;
      ...
      public function get margins() : IMargins
      {
         ...
         if(!var_73)
         {
            ...
            var_73 = new TextMargins(_loc1_.left,_loc1_.top,_loc1_.right,_loc1_.bottom,marginsCallback);
         }
         return var_73;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_224);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_208);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_211);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
            ...
            if(_loc4_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_211,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_211,false);
            }
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1092 == null)
         {
            var_1092 = findChildByTag(const_1014) as IHeaderWindow;
            if(!var_1092)
            {
      ...
      public function get title() : ITextWindow
      {
         if(_title == null)
         {
            _title = findChildByTag(const_1011) as ITextWindow;
            if(!_title)
            {
      ...
      {
         return findChildByTag(const_1012) as IScalerWindow;
      }
      ...
      {
         return content != null && var_1303 ? content.iterator : new Iterator(this);
      }
      ...
      public function get content() : IWindowContainer
      {
         if(var_34 == null)
         {
            var_34 = findChildByTag(const_1013) as IWindowContainer;
            if(!var_34)
            {
