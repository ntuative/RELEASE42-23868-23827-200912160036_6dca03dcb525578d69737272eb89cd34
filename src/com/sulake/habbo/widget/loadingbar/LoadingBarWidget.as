package com.sulake.habbo.widget.loadingbar
{
   ...
   public class LoadingBarWidget extends RoomWidgetBase
   {
      ...
      private var var_364:Sprite = null;
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetInterstitialUpdateEvent.const_89,onShowInterstitial);
         param1.addEventListener(RoomWidgetLoadingBarUpdateEvent.const_89,onShowLoadingBar);
      ...
      private function onShowInterstitial(param1:RoomWidgetInterstitialUpdateEvent) : void
      {
         ...
         {
            var_364 = new Sprite();
            var_364.addChild(new Bitmap(_image));
            var_364.addEventListener(MouseEvent.CLICK,clickHandler);
         }
         else
         {
            _loc5_ = var_364.getChildAt(0) as Bitmap;
            if(_loc5_ != null)
            {
               _loc5_.bitmapData = _image;
            }
         }
         _loc2_.setDisplayObject(var_364);
         _window.visible = true;
         _window.center();
      }
      ...
      private function clickHandler(param1:Event) : void
      {
         if(var_1322 != "")
         {
            HabboWebTools.openWebPage(var_1322);
         }
      }
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetInterstitialUpdateEvent.const_89,onShowInterstitial);
         param1.removeEventListener(RoomWidgetLoadingBarUpdateEvent.const_89,onShowLoadingBar);
      ...
      {
         if(param1 == null || param1.type != RoomWidgetLoadingBarUpdateEvent.const_89)
         {
            return;
         }
         if(!createWindow())
      ...
      override public function dispose() : void
      {
         if(var_364 != null)
         {
            var_364.removeEventListener(MouseEvent.CLICK,clickHandler);
            var_364 = null;
         }
         if(_image != null)
         {
