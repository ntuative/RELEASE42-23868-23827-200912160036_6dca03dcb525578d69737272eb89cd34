package com.sulake.habbo.navigator.inroom
{
   ...
   public class RoomEventViewCtrl
   {
      ...
      private var var_1819:IButtonWindow;
      ...
      private var var_642:TextFieldManager;
      ...
      private function onEditButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc5_:String = var_642.getText();
         var _loc6_:Array = new Array();
         addTag(_loc6_,var_785.getText());
         addTag(_loc6_,var_783.getText());
      ...
      private function editEvent(param1:RoomEventData) : void
      {
         ...
         var_1408.visible = true;
         var_1820.text = _navigator.getText("roomevent_type_" + param1.eventType);
         _eventNameInput.setText(param1.eventName);
         var_642.setText(param1.eventDescription);
         var_785.setText(getTagFromEvent(param1,1));
         var_783.setText(getTagFromEvent(param1,2));
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         if(_window == null)
         {
            ...
            var_1408 = IWindowContainer(find("event_type_disabled_cont"));
            var_1820 = ITextWindow(find("event_type_disabled_text"));
            var_1409 = ITextWindow(find("create_caption"));
            var_1410 = ITextWindow(find("edit_caption"));
            var_1165 = IButtonWindow(find("create_button"));
            var_1164 = IButtonWindow(find("edit_button"));
            var_1819 = IButtonWindow(find("cancel_button"));
            var_1163 = IButtonWindow(find("end_button"));
            var_784 = IDropMenuWindow(find("event_type"));
            prepareEventTypes();
            Util.setProcDirectly(var_1165,onCreateButtonClick);
            Util.setProcDirectly(var_1164,onEditButtonClick);
            Util.setProcDirectly(var_1163,onEndButtonClick);
            Util.setProcDirectly(var_1819,onCancelButtonClick);
            _eventNameInput = new TextFieldManager(_navigator,getInput("event_name"),25);
            var_642 = new TextFieldManager(_navigator,getInput("event_desc"),100);
            var_785 = new TextFieldManager(_navigator,getInput("event_tag_1"),25);
            var_783 = new TextFieldManager(_navigator,getInput("event_tag_2"),25);
      ...
      private function isMandatoryFieldsFilled() : Boolean
      {
         ...
         if(!var_642.checkMandatory(_navigator.getText("navigator.eventsettings.descerr")))
         {
            return false;
         }
         return true;
