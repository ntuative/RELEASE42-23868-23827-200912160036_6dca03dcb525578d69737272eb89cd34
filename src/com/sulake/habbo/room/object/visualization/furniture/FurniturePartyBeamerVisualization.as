package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_334:int = 2;
      ...
      private function getNewPoint(param1:int, param2:Number) : Point
      {
         ...
         var_1015[param1] = _loc3_;
         if(int(_loc9_) == 0)
         {
            var_1014[param1] = getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         var_1015 = new Array();
         var_1015.push(Math.random() * _loc2_ * 1.5);
         var_1015.push(Math.random() * _loc2_ * 1.5);
         var_1016 = new Array();
         var_1016.push(1);
         var_1016.push(-1);
         var_1013 = new Array();
         var_1013.push(const_1086);
         var_1013.push(const_1087);
         var_1014 = new Array();
         var_1014.push(getRandomAmplitudeFactor());
         var_1014.push(getRandomAmplitudeFactor());
      }
