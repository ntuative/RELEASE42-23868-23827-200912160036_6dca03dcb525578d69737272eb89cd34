   ...
   public class EffectView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         else
         {
            ...
            var_858 = _window.findChildByName("effect_hilite");
            var_858.visible = false;
         }
         var_857 = _window.findChildByName("time_left") as ITextWindow;
         setTimeLeft();
         var_859 = _window.findChildByName("loader_bar");
         if(var_859 != null)
         {
            var_394 = var_859.width;
            var_165.start();
            onUpdate();
         }
         if(false)
      ...
      private function setTimeLeft() : void
      {
         ...
         if(var_857 != null)
         {
            var_857.caption = "${widgets.memenu.effects.active.timeleft}";
            _loc1_ = "null";
            if(false)
            {
               _loc2_ = 0;
            ...
            {
               var_857.caption = "${widgets.memenu.effects.activate}";
            }
         }
      }
