package com.sulake.habbo.window
{
   ...
   public class HabboWindowManagerComponent extends Component implements IHabboWindowManager, ICoreWindowManager, IWindowFactory, ICoreUpdateReceiver, IWindowContextStateListener
   {
      ...
      private static const const_1077:uint = 1;
      ...
      private var var_2281:uint = 0;
      
      private var var_1217:ProfilerAgentTask;
      
      private var var_1216:ProfilerOutput;
      
      private var var_665:IWindowRenderer;
      ...
      public function HabboWindowManagerComponent(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         {
            var_195 = CoreComponent(param1).root.stage;
            _instance = this;
            var_1219 = Component(param1).events;
            var_817 = new Array();
      ...
      {
         return var_293[param2].getDesktopWindow().getChildByName(param1);
      }
      ...
      {
         return var_293[param9].create(param1,param2,param3,param4,param5,param6,param7,null,param8,null,null);
      }
      ...
      private function initialize(param1:IID, param2:IUnknown) : void
      {
         ...
         var_665 = new WindowRenderer(_loc4_);
         var_293 = new Array(const_337);
         var _loc6_:int = 0;
         while(_loc6_ < const_337)
         {
            _loc5_ = new WindowContext("layer_" + _loc6_,var_665,this,_localization,var_195,new Rectangle(0,0,var_195.stageWidth,var_195.stageHeight),this);
            var_293[_loc6_] = _loc5_;
            _loc6_++;
         }
         var_370 = var_293[const_1077];
         registerUpdateReceiver(this,0);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_link_png").content as BitmapData);
         var_370.getMouseCursor().defineCustomCursorType(MouseCursorType.const_296,_loc7_);
         _loc7_ = new Bitmap(assets.getAssetByName("habbo_cursor_drag_png").content as BitmapData);
         var_370.getMouseCursor().defineCustomCursorType(MouseCursorType.const_1231,_loc7_);
      }
      
      public function removeWindow(param1:String, param2:uint = 1) : void
      {
         var _loc3_:IDesktopWindow = var_293[param2].getDesktopWindow();
      ...
      override public function dispose() : void
      {
         if(!_isDisposed)
         {
            ...
            while(false)
            {
               IDisposable(var_293.pop()).dispose();
            }
            if(var_1216 != null)
            {
               var_1216.dispose();
      ...
      {
         return var_293[param1].getDesktopWindow().getChildAt(var_370.getDesktopWindow().numChildren - 1);
      }
      ...
      private function receiveProfilerInterface(param1:IID, param2:IUnknown) : void
      {
         ...
         if(var_1216 == null)
         {
            ...
            if(_loc3_ != null)
            {
               var_1216 = new ProfilerOutput(_loc3_,this,var_665);
               var_1218 = new ProfilerAgentTask("Update","Event processing");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1218);
               var_1217 = new ProfilerAgentTask("Redraw","Window rasterizer");
               _loc3_.getProfilerAgentForReceiver(this).addSubTask(var_1217);
               var_988 = true;
            }
         }
      }
      ...
      {
         return var_370.getWindowParser().windowToXMLString(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            var_1219.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_INPUT));
            _loc2_ = const_337 - 1;
            while(_loc2_ >= 0)
            {
               var_293[_loc2_].update(param1);
               _loc2_--;
            }
         }
         if(var_988)
         ...
         var_1219.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_RENDER));
         _loc2_ = 0;
         while(_loc2_ < const_337)
         {
            var_293[_loc2_].render(param1);
            _loc2_++;
         }
         if(var_988)
         {
         ...
         var_1219.dispatchEvent(new Event(HabboWindowTrackingEvent.HABBO_WINDOW_TRACKING_EVENT_SLEEP));
      }
      
      public function getLayoutByType(param1:uint, param2:uint) : XML
      {
         var _loc3_:Dictionary = var_817[param2] as Dictionary;
         if(_loc3_ == null)
         {
            return null;
         }
         var _loc4_:XML = _loc3_[param1] as XML;
         return _loc4_ == null ? var_817[0][param1] as XML : _loc4_;
      }
      ...
      {
         return var_370.create(param1,param7,param2,param3,param4,param5,param6,param10,param8,param11,param9);
      }
      ...
      public function mouseEventReceived(param1:String, param2:IWindow) : void
      {
         if(param2 != null)
         {
            if(param1 == MouseEvent.CLICK)
            {
               ...
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1141,param2.name + ": " + param2.toString());
            }
            else if(param1 == MouseEvent.MOUSE_UP)
            {
               ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1341,new Date().getTime().toString());
