package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1518:IWindowContainer;
      
      public static var var_1290:IWindowContainer;
      
      public static var var_1037:int = 6710886;
      ...
      private var var_1348:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager)
      {
         ...
         if(var_1518 == null)
         {
            ...
            var_1518 = _controller.windowManager.buildFromXML(_loc4_.content as XML) as IWindowContainer;
         }
      ...
      private function createWindow() : void
      {
         ...
         var_1348 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         attachImages();
         updateAvatar();
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_675 = param1;
         var_1348.setSelected(var_1348.getSelectableByName(param1));
         _window.invalidate();
      }
