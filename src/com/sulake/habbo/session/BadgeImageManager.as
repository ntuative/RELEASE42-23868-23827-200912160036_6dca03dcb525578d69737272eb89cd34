package com.sulake.habbo.session
{
   ...
   public class BadgeImageManager
   {
      ...
      public static const const_1255:String = "normal_badge";
      
      public static var loading_icon_png:Class = BadgeImageManager_loading_icon_png;
      
      public static const const_932:String = "group_badge";
       
      
      private const const_1366:String = "badge_";
      ...
      private function onBadgeImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            if(_loc2_.assetLoader != null && _loc2_.assetLoader.content != null)
            {
               ...
               _loc4_ = _loc2_.assetName.replace(const_1366,"");
      ...
      public function getBadgeImage(param1:String, param2:String = "normal_badge") : BitmapData
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         var _loc3_:String = const_1366 + param1;
         ...
         switch(param2)
         {
            case const_1255:
               if(var_173 != null)
               {
                  _loc5_ = var_173.getKey("image.library.url","http://images.habbohotel.com/c_images/");
            ...
            case const_932:
               if(var_173 != null)
               {
                  if(var_173 != null)
                  {
                     _loc5_ = var_173.getKey("group.badge.url");
