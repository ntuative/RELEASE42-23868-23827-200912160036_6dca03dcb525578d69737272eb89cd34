package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      private const const_1583:int = 5;
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:IHabboLocalizationManager, param6:ISessionDataManager)
      {
         ...
         var_560 = param6;
         var_560.events.addEventListener(BadgeImageReadyEvent.const_102,onBadgeImageReady);
      ...
      {
         var _loc2_:int = 0;
         while(_loc2_ < var_813.length)
         {
            if(var_813[_loc2_] == param1)
            {
               var_813.splice(_loc2_,1);
      ...
      public function setBadgeSelected(param1:String) : void
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         while(_loc3_ < var_265.length)
         {
            _loc2_ = var_265[_loc3_] as Badge;
            if(_loc2_ != null)
            {
      ...
      public function getBadges(param1:int = -1) : Array
      {
         ...
         switch(param1)
         {
            ...
            case 0:
               ...
               while(_loc3_ < var_265.length)
               {
                  if((var_265[_loc3_] as Badge).isInUse == false)
                  {
                     _loc2_.push(var_265[_loc3_]);
                  }
                  _loc3_++;
               }
               return _loc2_;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_560 != null)
            {
               var_560.events.removeEventListener(BadgeImageReadyEvent.const_102,onBadgeImageReady);
               var_560 = null;
            }
            _disposed = true;
         }
      ...
      {
         if(param1 == InventoryCategory.const_269 && false)
         {
      ...
      public function updateBadge(param1:String, param2:Boolean) : void
      {
         ...
         else
         {
            ...
            _loc8_.iconImage = var_560.getBadgeImage(param1);
            var_265.push(_loc8_);
            if(param2)
            {
