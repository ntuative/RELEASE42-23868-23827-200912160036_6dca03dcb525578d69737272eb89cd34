package com.sulake.habbo.avatar.geometry
{
   public class Vector3D
   {
      ...
      public function cross(param1:Vector3D) : Vector3D
      {
         ...
         _loc2_.y = var_90 * param1.x - var_89 * param1.z;
         _loc2_.z = var_89 * param1.y - _y * param1.x;
         return _loc2_;
      }
      ...
      {
         return Math.sqrt(var_89 * var_89 + _y * _y + var_90 * var_90);
      }
      ...
      {
         return var_89 * param1.x + _y * param1.y + var_90 * param1.z;
      }
      ...
      {
         return "Vector3D: (" + var_89 + "," + _y + "," + var_90 + "," + var_974 + ")";
      }
