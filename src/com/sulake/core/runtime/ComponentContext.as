   ...
   public class ComponentContext extends Component implements IContext
   {
      ...
      protected final function announceInterfaceAvailability(param1:IID, param2:Component) : void
      {
         ...
         while(_loc6_ < _loc5_)
         {
            ...
            if(_loc4_ == null)
            {
               error("Interface " + param1 + " still unavailabe!",true,CoreComponent.const_1299);
            }
      ...
      public final function loadFromFile(param1:URLRequest, param2:LoaderContext) : LibraryLoader
      {
         ...
         {
            if(var_239[_loc3_].url == param1.url)
            {
               return var_239[_loc3_].loadFromFile(param1);
            }
            _loc3_++;
         }
         var _loc4_:LibraryLoader = new LibraryLoader(var_867);
      ...
      override public function toXMLString(param1:uint = 0) : String
      {
         ...
         var _loc11_:int = 0;
         while(_loc11_ < var_278.length)
         {
            _loc10_ = var_278[_loc11_] as Component;
            if(_loc10_ != this)
            {
      ...
      override public function dispose() : void
      {
         ...
         if(!disposed)
         {
            ...
            if(var_353 != null)
            {
               ...
               while(_loc1_-- > 0)
               {
                  IDisposable(var_353.pop()).dispose();
               }
               var_353 = null;
            }
            if(var_239 != null)
      ...
      protected final function hasQueueForInterface(param1:IID) : Boolean
      {
         ...
         while(_loc4_ < _loc3_)
         {
            if(getQualifiedClassName(var_353[_loc4_].identifier) == _loc2_)
            {
               return true;
            }
            _loc4_++;
      ...
      protected function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         removeLibraryLoader(_loc2_);
         error("Failed to download component resource \"" + _loc2_.url + "\"!" + "\r" + _loc3_,true,CoreComponent.const_1175);
      }
      ...
      public final function detachComponent(param1:Component) : void
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < var_278.length)
         {
            if(var_278[_loc4_] == param1)
            {
               var_278.splice(_loc4_,1);
               return;
            }
            _loc4_++;
         }
         ...
         while(_loc18_ < _loc5_.length())
         {
            ...
            if(_loc24_ > 0)
            {
               ...
               while(_loc26_ < _loc24_)
               {
                  ...
                  {
                     error("Manifest for component " + _loc7_ + " contains broken asset \"" + _loc21_ + "\"!",true,CoreComponent.const_552);
                  }
                  _loc26_++;
               }
            }
            ...
            if(_loc6_ == null)
            {
               error("Invalid component class " + _loc7_ + "!",true,CoreComponent.const_552);
               return false;
            }
            ...
            if(_loc4_ != null)
            {
               if(_loc25_ != null)
               {
                  ...
                  {
                     _loc25_.dispose();
                     error("Component \"" + _loc7_ + "\" did not save provided asset library!",true,CoreComponent.const_552);
                  }
               }
