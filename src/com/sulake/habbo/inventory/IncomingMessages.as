package com.sulake.habbo.inventory
{
   ...
   public class IncomingMessages
   {
      ...
      {
         var _loc2_:EffectsModel = var_25.method_2;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function onAvatarEffects(param1:IMessageEvent) : void
      {
         ...
         var_25.setInventoryCategoryInit(InventoryCategory.const_544);
         _loc2_.refreshViews();
         var_25.notifyChangedEffects();
      }
      ...
      private function onPets(param1:PetInventoryEvent) : void
      {
         ...
         var_25.setInventoryCategoryInit(InventoryCategory.const_166);
      }
      ...
      public function onAchievements(param1:IMessageEvent) : void
      {
         ...
         _loc4_.refreshViews();
         var_25.setInventoryCategoryInit(InventoryCategory.const_279);
      }
      ...
      private function onTradingOpen(param1:IMessageEvent) : void
      {
         ...
         var_25.toggleInventorySubPage(InventorySubCategory.const_234);
      ...
      public function onBadges(param1:IMessageEvent) : void
      {
         ...
         _loc3_.updateView();
         var_25.setInventoryCategoryInit(InventoryCategory.const_269);
      }
      ...
      private function onMarketplaceConfiguration(param1:MarketplaceConfigurationEvent) : void
      {
         ...
         var_25.setInventoryCategoryInit(InventoryCategory.const_444);
         var _loc4_:FurniModel = var_25.furniModel;
         if(_loc4_ != null)
         {
            _loc4_.updateView();
