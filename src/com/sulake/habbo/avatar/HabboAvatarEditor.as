package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_920.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_919)
         {
            var_619 = new Dictionary();
            var_619["null"] = new FigureData(this);
            var_619["null"] = new FigureData(this);
            _loc1_ = var_619["null"];
            _loc2_ = var_619["null"];
            ...
            _loc2_.loadAvatarData("hr-681-41.hd-620-9.ch-879-90.lg-700-85.sh-735-68",FigureData.const_79);
            var_321 = new Map();
            var_321.add(AvatarEditorCategory.const_849,new GenericModel(this));
            var_321.add(AvatarEditorCategory.const_45,new HeadModel(this));
            var_321.add(AvatarEditorCategory.const_322,new TorsoModel(this));
            var_321.add(AvatarEditorCategory.const_1203,new LegsModel(this));
            var_321.add(AvatarEditorCategory.const_561,new WardrobeModel(this));
            var_919 = true;
         }
      }
      ...
      private function requestSavedOutfits() : void
      {
         ...
         var _loc1_:WardrobeModel = var_321.getValue(AvatarEditorCategory.const_561);
         if(_loc1_ != null)
         {
         }
      }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_321.getValue(AvatarEditorCategory.const_561);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_920.getPalette(param1);
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc7_ != null)
         {
            ...
            for each(_loc13_ in _loc10_.colors)
            {
               ...
               {
                  _loc16_ = new AvatarEditorColorItem(AvatarEditorView.var_1518.clone() as IWindowContainer,param1,_loc13_);
                  _loc4_.push(_loc16_);
            ...
            for each(_loc5_ in _loc7_.partSets)
            {
               _loc19_ = false;
               _loc20_ = true;
               if(_loc5_.gender == FigureData.const_1244)
               {
                  _loc19_ = true;
               }
      ...
      {
         var _loc2_:IAvatarEditorCategoryModel = var_321.getValue(param1) as IAvatarEditorCategoryModel;
         if(_loc2_ != null)
         {
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(var_370 == null)
            {
               var_370 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_53,HabboWindowStyle.const_39,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
         ...
         _view.show();
         toggleAvatarEditorPage(AvatarEditorCategory.const_849);
         if(var_173 != null)
         {
            urlString = var_173.getKey("avatar.editor.url");
            try
            {
            }
            catch(e:Error)
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_1118 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      private function onInventoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_25 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_505,onHabboClubChanged);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         var_920 = var_1118.getFigureData(AvatarType.HUMAN);
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:Boolean = false) : void
      {
         ...
         var_921 = param3;
         var _loc4_:FigureData = var_619[param2];
         if(_loc4_ == null)
         {
            return;
         }
