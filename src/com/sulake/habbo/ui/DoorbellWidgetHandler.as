package com.sulake.habbo.ui
{
   ...
   public class DoorbellWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionDoorbellEvent.const_100:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_659,_loc2_.userName));
               break;
            case RoomSessionDoorbellEvent.const_105:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_105,_loc2_.userName));
               break;
            case RoomSessionDoorbellEvent.const_127:
               ...
               _container.events.dispatchEvent(new RoomWidgetDoorbellEvent(RoomWidgetDoorbellEvent.const_127,_loc2_.userName));
               break;
         }
      }
      ...
      {
         return [RoomSessionDoorbellEvent.const_100,RoomSessionDoorbellEvent.const_105,RoomSessionDoorbellEvent.const_127];
      }
