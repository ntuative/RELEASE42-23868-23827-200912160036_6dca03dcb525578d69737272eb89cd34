package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class PetVisualization extends RoomObjectSpriteVisualization
   {
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         var _loc9_:* = 0;
         var _loc11_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_929);
         if(_loc11_ > 0)
         {
            _loc16_ = getTimer() - _loc11_;
            if(_loc16_ < AvatarAction.const_810)
            {
               _loc9_ = uint(int(Math.sin(Number(_loc16_) / 0 * 0) * 255));
               _loc10_ = _loc3_.getNumber(RoomObjectVariableEnum.const_952);
               var_461 = const_1060;
            }
         }
         var _loc12_:Boolean = false;
         var _loc13_:String = _loc3_.getString(RoomObjectVariableEnum.const_256);
         switch(_loc13_)
         {
         ...
         var _loc14_:Boolean = var_277 != _loc2_.getUpdateID() || var_206 != param1.scale || var_184 != _loc3_.getUpdateID();
         var _loc15_:Boolean = _isAnimating || var_461 > 0 || _loc12_;
         if(_loc14_ || _loc15_)
         {
            _loc17_ = getTimer();
            --var_461;
            if(var_531 != _loc6_)
            {
               for each(_loc35_ in var_387.getKeys())
               {
                  var_387.remove(_loc35_);
               }
               _loc5_ = null;
            }
            if(_loc5_ == null)
            ...
            _loc19_ = _loc3_.getNumber(RoomObjectVariableEnum.const_305);
            if(isNaN(_loc19_))
            {
               _loc19_ = _loc18_;
            }
            ...
            _loc20_ = _loc3_.getString(RoomObjectVariableEnum.const_256);
            _loc21_ = _loc3_.getString(RoomObjectVariableEnum.const_550);
            _loc5_.appendAction(AvatarAction.const_608,_loc20_,_loc21_);
            _loc22_ = false;
            if(_loc20_ == "lay")
            {
            ...
            _loc23_ = _loc3_.getString(RoomObjectVariableEnum.const_353);
            if(_loc23_ != null && _loc23_ != "")
            {
               _loc37_ = _loc3_.getNumber(RoomObjectVariableEnum.const_363);
               _loc38_ = 3;
               _loc39_ = _loc7_ - _loc37_;
               if(_loc39_ < _loc38_ * 1000)
               {
                  _loc5_.appendAction(AvatarAction.const_318,_loc23_);
               }
            }
            _loc24_ = _loc3_.getNumber(RoomObjectVariableEnum.const_426) > 0;
            if(_loc24_)
            {
            ...
            _loc29_ = _loc5_.getSprites().length + const_1059;
            ...
            var_788.push(getTimer() - _loc17_);
            if(false)
            {
               _loc55_ = 0;
               _loc56_ = "[";
               for each(_loc57_ in var_788)
               {
                  _loc55_ += _loc57_;
                  _loc56_ += "," + _loc57_;
               }
