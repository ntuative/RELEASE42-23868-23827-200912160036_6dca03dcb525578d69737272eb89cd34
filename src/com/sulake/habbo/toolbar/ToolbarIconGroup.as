package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      private var var_389:ToolbarBarMenuAnimator;
      ...
      {
         return var_1193.indexOf(param1) > -1;
      }
      ...
      {
         return var_655.indexOf(param1) > -1;
      }
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < var_1194.length)
         {
            _loc2_ = var_655.indexOf(var_1194[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = var_290[_loc2_];
               if(_loc1_.exists)
               {
                  _loc1_.changePosition(var_850 + _loc3_);
                  _loc3_ += var_1192;
               }
            }
            _loc4_++;
      ...
      private function createIconObject(param1:String) : ToolbarIcon
      {
         ...
         _loc2_ = new ToolbarIcon(this,_windowManager,_assetLibrary,param1,_events,var_389);
      ...
      {
         var _loc3_:* = null;
         var _loc2_:int = var_655.indexOf(param1);
         if(_loc2_ > -1)
         {
            _loc3_ = getIconById(param1);
            if(_loc3_ != null)
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return var_290[var_655.indexOf(param1)];
      }
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = var_1902.elements("menu");
         var _loc5_:int = 0;
