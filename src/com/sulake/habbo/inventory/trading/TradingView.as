package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_733:uint = 4284532064;
      
      private static const const_734:uint = 2577770;
      ...
      private var var_323:ItemPopupCtrl;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         var_323 = new ItemPopupCtrl(_loc8_,_assetLibrary);
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "button_accept":
                  switch(var_36.state)
                  {
                     case TradingModel.const_168:
                        if(var_36.otherUserItems.length == 0 && true)
                        {
                           alertPopup(const_780);
                        }
                        if(false)
                        {
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_972)
            {
            ...
            var_323.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_383);
            var_323.show();
         }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         if(var_1339 == null)
         {
            var_1339 = createMinimizedWindow();
         }
         if(!var_1634)
         {
            return var_66;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(var_66)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !true ? uint(const_733) : uint(const_734);
            }
