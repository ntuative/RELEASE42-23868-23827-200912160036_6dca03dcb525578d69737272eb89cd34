package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_448:String = "g";
      
      private var var_192:int = 0;
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:Map = var_374.getWithIndex(var_192);
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getValue(var_448);
            if(_loc3_ == null)
            {
      ...
      override public function init() : void
      {
         ...
         for each(_loc3_ in page.offers)
         {
            ...
            if(var_374.getValue(_loc6_) == null)
            {
               var_374.add(_loc6_,new Map());
            }
            _loc8_ = var_374.getValue(_loc6_) as Map;
            _loc8_.add(_loc7_,_loc3_);
         }
         _loc4_ = var_374.getWithIndex(var_192);
         if(_loc4_ != null)
         {
            _loc3_ = _loc4_.getValue(var_448);
            if(_loc3_ == null)
            {
