package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_613:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_56.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),var_56,WindowTracker.const_681,_data.flatId),var_58,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = determineAction(param1,var_613.isSelected);
         var_56.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1339,_loc2_,var_369.text,"",""));
         if(false)
         {
            var_56.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_913.isSelected,var_912.isSelected,var_613.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         if(param2)
         {
            return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1208);
         }
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1337);
      }
      ...
      public function populate() : void
      {
         ...
         var_613 = ICheckBoxWindow(var_58.findChildByName("kick_check"));
         var_913 = ICheckBoxWindow(var_58.findChildByName("lock_check"));
         var_912 = ICheckBoxWindow(var_58.findChildByName("changename_check"));
      ...
      public function show() : void
      {
         ...
         var_56.connection.send(new GetModeratorRoomInfoMessageComposer(var_401));
