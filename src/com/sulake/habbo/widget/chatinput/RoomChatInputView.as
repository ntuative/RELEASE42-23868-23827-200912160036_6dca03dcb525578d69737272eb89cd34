package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_482:int = 16;
      
      private static const const_1065:int = 20;
      
      private static const const_333:int = 10;
      
      private static const const_1066:int = 40;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_961 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_1850 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1852 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_644 = new Timer(1000,1);
         var_644.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_792 = new Timer(5000,1);
         var_792.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _windowManager.createWindow("chatinput_widget_window","",HabboWindowType.const_53,HabboWindowStyle.const_40,0 | 0,new Rectangle(300,400,400,30),null) as IWindowContainer;
         ...
         _loc4_.addEventListener(WindowEvent.const_205,onInputChanged);
         _window.addEventListener(WindowEvent.const_433,onWindowMoved);
         var_1177 = true;
         var_137 = "";
      }
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1851 = _loc2_.width + const_482 + _loc6_.width + const_1065;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1066,_loc8_.width) + const_482);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_961 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_137 = "";
               }
      ...
      private function addEventListenerToChild(param1:IWindow) : void
      {
         if(param1 != null)
         {
            ...
            param1.addEventListener(WindowMouseEvent.const_54,windowMouseEventProcessor);
         }
      }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(var_463);
