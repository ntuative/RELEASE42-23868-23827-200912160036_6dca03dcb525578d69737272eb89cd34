package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_678[var_1010] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_299)
         {
            ...
            var_299 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_299.center();
            var_299.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_1010;
         if(var_1010 < var_678.length)
         {
            _loc1_ = var_678[var_1010] as Dictionary;
            if(!_loc1_)
            {
            ...
            if(_window)
            {
               ...
               if(_loc2_)
               {
                  ...
                  _loc6_ = _loc6_.replace("%count%",var_678.length);
                  _loc2_.text = _loc6_;
               }
