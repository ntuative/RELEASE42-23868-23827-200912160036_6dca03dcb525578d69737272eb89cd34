package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_644,RoomWidgetEcotronBoxOpenMessage.const_627,RoomWidgetEcotronBoxOpenedMessage.const_1220];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_644:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_627:
