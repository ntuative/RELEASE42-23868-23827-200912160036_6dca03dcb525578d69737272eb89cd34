package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_996:String = "issue_bundle_open";
      
      public static const const_688:String = "issue_bundle_my";
      
      public static const const_877:String = "issue_bundle_picked";
      ...
      private var var_505:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_128 = new Map();
         var_732 = new Map();
         var_505 = new IssueBrowser(this,var_61.windowManager,var_61.assets);
         var_605 = [];
         var_733 = [];
         var_898 = new Map();
      }
      ...
      {
         var _loc2_:IssueHandler = var_898.getValue(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.update();
         }
      ...
      public function pickBundle(param1:int) : void
      {
         ...
         var_605 = var_605.concat(_loc2_.getIssueIds());
      }
      ...
      public function method_5(param1:IssueMessageData) : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc5_:* = null;
         ...
         var _loc2_:int = int(var_732.getValue(param1.issueId));
         if(_loc2_ != 0)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               else
               {
                  ...
                  var_732.remove(param1.issueId);
                  _loc3_ = null;
               }
            }
         }
         if(param1.state == IssueMessageData.const_1335)
         {
            var_159.remove(param1.issueId);
            return;
         }
         if(_loc3_ == null)
         {
            for each(_loc4_ in var_128)
            {
               if(validateBundle(_loc4_,param1))
               {
                  _loc3_ = _loc4_;
                  _loc3_.method_5(param1);
                  var_732.add(param1.issueId,_loc3_.id);
                  break;
               }
            }
         }
         if(_loc3_ == null)
         {
            ...
            var_732.add(param1.issueId,_loc2_);
         ...
         if(var_605.indexOf(param1.issueId) != -1)
         {
         ...
         if(param1.state == IssueMessageData.const_140)
         {
            ...
            _loc8_ = var_733.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      {
         var _loc2_:* = var_898.remove(param1) as IssueHandler;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            _loc2_ = null;
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(var_505 == null || !var_505.isOpen())
         {
            var_61.soundManager.playSound(HabboSoundTypesEnum.const_855);
         }
      }
      ...
      public function removeIssue(param1:int) : void
      {
         ...
         var _loc2_:int = var_732.getValue(param1);
         if(_loc2_ != 0)
         {
            _loc3_ = var_128.getValue(_loc2_) as IssueBundle;
            if(_loc3_ != null)
