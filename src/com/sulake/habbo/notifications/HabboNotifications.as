package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, ICoreUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1039:String = "badges";
      
      private static const const_1041:String = "pixelbalance";
      
      private static const const_1042:String = "credits";
      
      private static const const_1044:String = "inventory";
      
      private static const const_1043:String = "friendlist";
      
      private static const const_1040:String = "selectfurni";
      ...
      private var var_1129:IHabboToolbar;
      ...
      private var var_191:HabboAlertDialogManager;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),var_759);
         }
         var _loc6_:Map = var_759["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            addItem(_loc3_.value,NotificationType.const_1130);
         }
      }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_856)
         {
            return;
         }
      ...
      private function onUserBannedMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || var_191 == null)
         {
            return;
         }
         var_191.handleUserBannedMessage(_loc2_.message);
      }
      ...
      private function onModMessageEvent(param1:IMessageEvent) : void
      {
         ...
         var_191.handleModMessage(_loc2_.message,_loc2_.url);
      }
      ...
      private function onLoginFailedHotelClosed(param1:IMessageEvent) : void
      {
         ...
         var_191.handleLoginFailedHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute);
      }
      ...
      function onActivityPointNotication(param1:IMessageEvent) : void
      {
         ...
         {
            addItem(_loc3_.value,NotificationType.const_1347);
         }
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!var_1750)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_973);
            var_1750 = true;
      ...
      {
         if(var_372.isSpaceAvailable() && false)
         {
            var_372.showItem(getNextItemFromQueue());
         }
      }
      ...
      {
         var _loc1_:Array = var_930.splice(0,1);
      ...
      function onAchievementNotication(param1:IMessageEvent) : void
      {
         ...
         new AchievementNotification(_loc2_.badgeID,_loc2_.level,_assets,_windowManager,_localization,_config,var_560);
      }
      
      public function onBroadcastAlert(param1:IAlertDialog, param2:WindowEvent) : void
      {
         if(param2.type == WindowEvent.const_170 || param2.type == WindowEvent.const_590)
         {
            param1.dispose();
         }
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(_loc4_.products.length > 0)
            {
               ...
               {
                  _loc16_ = var_560.getFloorItemData(_loc15_.furniClassId);
               }
               else if(_loc15_.productType == CatalogPageMessageProductData.const_75)
               {
                  _loc16_ = var_560.getWallItemData(_loc15_.furniClassId);
               }
               _loc7_ = var_560.getProductData(_loc4_.localizationId);
               switch(_loc15_.productType)
               {
                  ...
                  case CatalogPageMessageProductData.const_75:
                     ...
                     break;
                  case CatalogPageMessageProductData.const_237:
         ...
         if(_loc9_)
         {
            addItem(_loc9_.value,NotificationType.const_973,_loc5_);
         }
      ...
      private function onHotelClosing(param1:IMessageEvent) : void
      {
         ...
         var_191.handleHotelClosingMessage(_loc2_.minutesUntilClosing);
      }
      ...
      {
         var_1129 = IHabboToolbar(param2);
         var_1129.events.addEventListener(HabboToolbarEvent.const_81,onHabboToolbarEvent);
      }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         if(_loc5_)
         {
            addItem(_loc5_.value,NotificationType.const_204);
         }
      }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_191 = new HabboAlertDialogManager(_windowManager,_localization);
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_560.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               addItem(_loc3_.value,NotificationType.const_993);
            }
            if(_loc4_)
            {
               addItem(_loc4_.value,NotificationType.const_993);
            }
         }
      }
      ...
      private function onHotelClosed(param1:IMessageEvent) : void
      {
         ...
         var_191.handleHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute,_loc2_.userThrownOutAtClose);
      }
      ...
      public function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         if(param1.type == HabboToolbarEvent.const_81)
         {
            ...
            var_372 = new HabboNotificationViewManager(_assetLibrary,_windowManager,var_759["styles"],var_759["view"],var_1129);
            ...
            registerUpdateReceiver(var_372,1);
            registerUpdateReceiver(this,2);
            var_560.events.addEventListener(BadgeImageReadyEvent.const_102,onBadgeImage);
            var_1129.events.addEventListener(HabboToolbarEvent.TOOLBAR_ORIENTATION,onToolbarRepositionEvent);
            return;
         }
      }
   }
