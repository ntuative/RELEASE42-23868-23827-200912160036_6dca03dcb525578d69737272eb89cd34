package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_377:PartSetsData;
      
      private var var_1778:PartOffsetData;
      
      private var var_769:AvatarActionManager;
      
      private var var_155:IAssetLibrary;
      
      private var var_2199:IAssetLibrary;
      
      private var var_1303:Boolean = false;
      
      private var var_1779:AvatarRenderManager;
      
      private var var_455:FigureData;
      ...
      private var var_1398:AvatarStructureDownloadSet;
      
      private var var_635:AnimationManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_155 = param2;
         var_2199 = param3;
         var_455 = new FigureData();
         var_377 = new PartSetsData();
         _animationData = new AnimationData();
         var_1398 = new AvatarStructureDownloadSet();
         var_635 = new AnimationManager();
         var_634 = param4;
         var_1778 = PartOffsetData.getInstance(param3);
         init();
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_635.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_377.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_377.getActiveParts(param1.definition);
      ...
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1209[param3];
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int) : Array
      {
         ...
         var _loc7_:Array = var_377.getActiveParts(param3.definition);
         if(param3.definition.isAnimation)
         {
            _loc17_ = param3.definition.state + "." + param3.actionParameter;
            _loc8_ = var_635.getAnimation(_loc17_);
            if(_loc8_ != null)
            {
         ...
         for each(_loc14_ in param2.getPartTypeIds())
         {
            ...
            _loc23_ = var_455.getSetType(_loc14_);
            if(_loc23_ != null)
            {
               _loc24_ = var_455.getPalette(_loc23_.paletteID).getColor(_loc22_);
               ...
               if(_loc25_ != null)
               {
                  ...
                  for each(_loc26_ in _loc25_.parts)
                  {
                     if(_loc9_.indexOf(_loc26_.type) > -1)
                     {
                        ...
                        _loc13_ = var_377.getPartDefinition(_loc26_.type);
         ...
         for each(_loc11_ in _loc9_)
         {
            ...
            if(!_loc33_)
            {
               if(_loc7_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_377.getPartDefinition(_loc11_);
                     _loc35_ = false;
                     _loc36_ = 1;
      ...
      {
         Logger.log("[AvatarStructure] Structure " + var_634 + " ready to go!");
         if(var_634 == AvatarType.HUMAN)
         {
            var_377.getPartDefinition("ri").appendToFigure = true;
            var_377.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      public function initConfiguration(param1:IHabboConfigurationManager) : void
      {
         ...
         {
            case AvatarType.HUMAN:
               var_1398.add(new AvatarStructureDownload(var_155,_loc5_,var_455));
               break;
            case AvatarType.PET:
         }
         var_1398.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,onStructureReady);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_635.getAnimation(param1);
      }
      ...
      {
         var_769 = new AvatarActionManager(var_155,var_634);
      }
      ...
      private function registerAnimations() : void
      {
         ...
         while(var_155.hasAsset("dance" + _loc1_))
         {
            ...
            var_635.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String) : IPartColor
      {
         ...
         var _loc4_:ISetType = var_455.getSetType(param2);
         if(_loc4_ == null)
         {
            return null;
         }
         return var_455.getPalette(_loc4_.paletteID).getColor(_loc3_);
      }
