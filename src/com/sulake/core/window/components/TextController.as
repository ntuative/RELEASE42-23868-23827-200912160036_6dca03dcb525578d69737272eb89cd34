package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected var var_73:TextMargins;
      
      protected var var_497:String = "none";
      ...
      protected var var_704:Boolean = false;
      ...
      {
         var_73 = new TextMargins(0,0,0,0,setTextMargins);
         var_207 = false;
         var_580 = 0;
         var_352 = 0;
         if(_field == null)
      ...
      {
         param1.var_73.dispose();
         param1.var_73 = new TextMargins(int(param2["left"]),int(param2["top"]),int(param2["right"]),int(param2["bottom"]),param1.setTextMargins);
         param1.refreshTextImage();
      }
      ...
      {
         return new Rectangle(var_580 * maxScrollH,var_352 * maxScrollV,width,height);
      }
      ...
      override public function dispose() : void
      {
         if(var_704)
         {
            context.removeLocalizationListener(var_240,this);
         }
         if(var_73 != null)
         {
            var_73.dispose();
      ...
      {
         var_580 = param1;
         _field.scrollH = var_580 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      public function set text(param1:String) : void
      {
         ...
         var_240 = param1;
         if(var_240.charAt(0) == "$" && var_240.charAt(1) == "{")
         {
            context.registerLocalizationListener(var_240.slice(2,var_240.indexOf("}")),this);
            var_704 = true;
         }
         else if(_field != null)
         {
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         if(!var_207)
         {
            if(param2.type == WindowNotifyEvent.const_260)
            {
               refreshTextImage();
            }
         }
      ...
      public function setTextMargins(param1:IMargins) : void
      {
         ...
         {
            var_73.dispose();
            var_73 = new TextMargins(param1.left,param1.top,param1.right,param1.bottom,setTextMargins);
         }
         refreshTextImage();
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_face",defaultTextFormat.font,PropertyStruct.const_191,true));
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_1210,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_408,true));
         _loc1_.push(new PropertyStruct("antialias_type",_field.antiAliasType,PropertyStruct.const_191,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_408,true));
         ...
         _loc1_.push(new PropertyStruct("grid_fit_type",_field.gridFitType,PropertyStruct.const_191,true));
         ...
         _loc1_.push(new PropertyStruct("restrict",_field.restrict,PropertyStruct.const_191,false));
         _loc1_.push(new PropertyStruct("sharpness",_field.sharpness,PropertyStruct.const_514,true));
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.const_191,false));
         _loc1_.push(new PropertyStruct("thickness",_field.thickness,PropertyStruct.const_514,true));
         _loc1_.push(new PropertyStruct("word_wrap",_field.wordWrap,PropertyStruct.const_57,true));
         _loc1_.push(new PropertyStruct("margin_left",var_73.left,PropertyStruct.const_85,true));
         _loc1_.push(new PropertyStruct("margin_top",var_73.top,PropertyStruct.const_85,true));
         _loc1_.push(new PropertyStruct("margin_right",var_73.right,PropertyStruct.const_85,true));
         _loc1_.push(new PropertyStruct("margin_bottom",var_73.bottom,PropertyStruct.const_85,true));
         _loc1_.push(new PropertyStruct("auto_size",var_497,PropertyStruct.const_191,var_497 != TextFieldAutoSize.NONE));
         ...
         _loc1_.push(new PropertyStruct("spacing",_field.defaultTextFormat.letterSpacing,PropertyStruct.const_514,_field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
      ...
      override public function clone() : IWindow
      {
         ...
         _loc1_.var_580 = var_580;
         _loc1_.var_352 = var_352;
         _loc1_.var_73 = var_73.clone(_loc1_.setTextMargins);
         _loc1_.var_497 = var_497;
         _loc1_.var_704 = var_704;
         return _loc1_;
      }
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_497 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_497 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_497 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_497 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
