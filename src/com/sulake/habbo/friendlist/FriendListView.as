package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1362:String = "noconvinfo";
      
      private static const const_1363:String = "messageinput";
      ...
      private function prepare() : void
      {
         ...
         var_736 = IWindowContainer(var_28.content.findChildByName("main_content"));
         var_267 = IWindowContainer(var_28.content.findChildByName("footer"));
         var_1080.prepare(var_736);
         var_28.procedure = onWindow;
         var_28.content.setParamFlag(HabboWindowParam.const_975,false);
         var_28.content.setParamFlag(HabboWindowParam.const_1152,true);
         var_28.header.setParamFlag(HabboWindowParam.const_697,false);
         var_28.header.setParamFlag(HabboWindowParam.const_823,true);
         var_28.content.setParamFlag(HabboWindowParam.const_697,false);
         var_28.content.setParamFlag(HabboWindowParam.const_823,true);
         var_28.findChildByName("open_edit_ctgs_but").procedure = onEditCategoriesButtonClick;
         var_1081 = ITextWindow(var_28.findChildByName("info_text"));
         var_1081.text = "";
      ...
      private function refreshWindowSize() : void
      {
         ...
         var_267.y = Util.getLowestPoint(var_28.content);
         ...
         var_28.scaler.setParamFlag(HabboWindowParam.const_905,this._friendList.tabs.findSelectedTab() != null);
         var_28.scaler.setParamFlag(HabboWindowParam.const_697,false);
         var_28.scaler.setParamFlag(HabboWindowParam.const_975,false);
         var_28.scaler.x = 0 - var_28.scaler.width;
         var_28.scaler.y = 0 - var_28.scaler.height;
         var_1330 = var_28.height;
         var_1331 = var_28.width;
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = var_1330 == -1 ? 0 : int(0 - var_1330);
         var _loc4_:int = var_1331 == -1 ? 0 : int(0 - var_1331);
