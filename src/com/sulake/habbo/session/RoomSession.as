package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_1006:UserDataManager;
      ...
      {
         if(_state == RoomSessionEvent.const_274 && _connection != null)
         {
            _state = RoomSessionEvent.const_83;
            if(isPrivateRoom)
            {
      ...
      {
         return var_1006 as IUserDataManager;
      }
