package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorColorItem
   {
      ...
      private const const_1573:int = 8947848;
      
      private const const_1574:int = 13421772;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.bitmap = new BitmapData(var_656.width,var_656.height,true,0);
            _loc1_.bitmap.copyPixels(var_656,var_656.rect,new Point(0,0));
         }
         var _loc2_:IBitmapWrapperWindow = _window.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
         if(_loc2_ != null)
         {
            _loc2_.bitmap = new BitmapData(var_1114.width,var_1114.height,true,0);
            _loc4_ = var_1114.clone();
            _loc4_.colorTransform(_loc4_.rect,var_749.colorTransform);
         ...
         if(_loc3_ != null)
         {
            _loc3_.bitmap = new BitmapData(var_917.width,var_917.height,true,16777215);
            _loc3_.bitmap.copyPixels(var_917,var_917.rect,new Point(0,0),null,null,true);
            if(!_isSelected)
            {
